...
Public Class GL0008WorkLorryList
    ...
    Private Sub getWorkLorryAllList(ByVal SQLcon As SqlConnection)
        ...
        Try
            ...
            sb.Append("FROM ")
            sb.Append("  OIL.MA006_SHABANORG as A ")
            If Not String.IsNullOrEmpty(OILTYPE) Then
                sb.Append("  INNER JOIN OIL.MA002_SHARYOA as B ")
            ...
            End If
            sb.Append("  LEFT JOIN OIL.MA004_SHARYOC as C ")
            ...
            sb.Append("  LEFT JOIN OIL.MA004_SHARYOC as D ")
