...
#Region "帳票ポップアップ"
    ...
    Protected Sub WF_TyohyoDownloadClick()
        ...
        '◯ 帳票(未選択)チェック
        If Me.rbShipBtn.Checked = False AndAlso Me.rbLoadBtn.Checked = False AndAlso Me.rbLineBtn.Checked = False AndAlso Me.rbKinoeneLoadBtn.Checked = False Then
