...
Public Class GRMA0002SELECT
    ...
    Public Sub initialize()
        '○初期値設定
        Master.MAPID = GRMA0002WRKINC.MAPIDS
        WF_STYMD.Focus()
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        '○ SQL異常対応
        work.WF_SEL_CAMPCODE.Text = If(WF_CAMPCODE.Text, "")                '会社コード
        work.WF_SEL_STYMD.Text = If(WF_STYMD.Text, "")                      '有効年月日
        If WF_ENDYMD.Text = "" Then
            work.WF_SEL_ENDYMD.Text = If(WF_STYMD.Text, "")
        Else
            work.WF_SEL_ENDYMD.Text = If(WF_ENDYMD.Text, "")
        End If
        work.WF_SEL_MORG.Text = If(WF_MORG.Text, "")                        '管理部署
        work.WF_SEL_SORG.Text = If(WF_SORG.Text, "")                        '設置部署
        work.WF_SEL_OILTYPE1.Text = If(WF_OILTYPE1.Text, "")                '油種(1)
        work.WF_SEL_OILTYPE2.Text = If(WF_OILTYPE2.Text, "")                '油種(2)
        work.WF_SEL_OWNCODE1.Text = If(WF_OWNCODEF.Text, "")                '荷主
        If WF_OWNCODET.Text = "" Then
            work.WF_SEL_OWNCODE2.Text = If(WF_OWNCODEF.Text, "")
        Else
            work.WF_SEL_OWNCODE2.Text = If(WF_OWNCODET.Text, "")
        End If
        work.WF_SEL_SHARYOTYPE1.Text = If(WF_SHARYOTYPE1.Text, "")          '車両タイプ(1)
        work.WF_SEL_SHARYOTYPE2.Text = If(WF_SHARYOTYPE2.Text, "")          '車両タイプ(2)
        work.WF_SEL_SHARYOTYPE3.Text = If(WF_SHARYOTYPE3.Text, "")          '車両タイプ(3)
        work.WF_SEL_SHARYOTYPE4.Text = If(WF_SHARYOTYPE4.Text, "")          '車両タイプ(4)
        work.WF_SEL_SHARYOTYPE5.Text = If(WF_SHARYOTYPE5.Text, "")          '車両タイプ(5)
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MENU Then               'メニューからの画面遷移
            ...
            '○RightBox情報設定
            rightview.MAPID = GRMA0002WRKINC.MAPID
            rightview.MAPIDS = GRMA0002WRKINC.MAPIDS
        ...
        ElseIf Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MA0002 Then         '実行画面からの画面遷移
            '○画面項目設定処理
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        '関連チェック(開始＞終了)
        If WF_OWNCODET.Text <> "" And WF_OWNCODEF.Text <> "" AndAlso _
