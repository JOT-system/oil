<%@ Page  Title="MA0004S" Language="vb" AutoEventWireup="false" CodeBehind="GRMA0004SELECT.aspx.vb" Inherits="OFFICE.GRMA0004SELECT" %>
...
<asp:Content ID="MA0004SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MA0004S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MA0004S.js")%>"></script>
</asp:Content>

<asp:Content ID="MA0004S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　searchbox -->
        <div  class="searchbox" id="searchbox" >
            ...
            <!-- 　年度　 -->
            <a style="position:fixed;top:9.9em;left:4em;font-weight:bold;">年度</a>
            <a style="position:fixed;top:9.9em;left:11.5em;">範囲指定</a>
            <a style="position:fixed;top:9.9em;left:42.5em;">～</a>

            <a style="position:fixed;top:9.9em;left:18em;" onchange="TextBox_change('WF_YYF')">
                <asp:TextBox ID="WF_YYF" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
            </a>
            <a style="position:fixed;top:9.9em;left:44em;" onchange="TextBox_change('WF_YYT')">
                <asp:TextBox ID="WF_YYT" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
            </a>
