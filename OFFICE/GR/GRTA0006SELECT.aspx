<%@ Page Title="TA0006" Language="vb" AutoEventWireup="false" CodeBehind="GRTA0006SELECT.aspx.vb" Inherits="OFFICE.GRTA0006SELECT" %>
...
<asp:Content ID="TA0009SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0006S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0006S.js")%>"></script>
</asp:Content>
<asp:Content ID="TA0006S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　headerbox -->
            ...
            <div id="searchkeybox">
                ...
                <p class="LINE_3"> 
                    ...
                    <a style="position:fixed;top:12.1em;left:27em;">
                        <asp:Label ID="WF_HORG_Text" runat="server" Text="" Width="17em" Height="1.2em" CssClass="WF_TEXT"></asp:Label>
                    </a>
                </p>
                <p class="LINE_4"> 
                    <!-- 　職務区分　 -->
                    ...
                    <a style="position:fixed;top:14.3em;left:27em;">
                        <asp:Label ID="WF_STAFFKBN_Text" runat="server" Text="" Width="17em" Height="1.2em" CssClass="WF_TEXT"></asp:Label>
                    </a>
                </p>
                 <p class="LINE_5"> 
                    <!-- 　従業員コード　 -->
