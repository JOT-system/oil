<%@ Page Title="OIM0005C" Language="vb" AutoEventWireup="false" CodeBehind="OIM0005TankCreate.aspx.vb" Inherits="OFFICE.OIM0005TankCreate" %>
...
<asp:Content ID="OIM0005CH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/OIM0005C.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/OIM0005C.js")%>'></script>
