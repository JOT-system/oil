...
Public Class GRMA0003SELECT
    ...
    Public Sub initialize()
        '○初期値設定
        Master.MAPID = GRMA0003WRKINC.MAPIDS
        WF_STYMD.Focus()
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MENU Then               'メニューからの画面遷移
            ...
            '○RightBox情報設定
            rightview.MAPID = GRMA0003WRKINC.MAPID
            rightview.MAPIDS = GRMA0003WRKINC.MAPIDS
            ...
            If Not isNormal(WW_ERR_SW) Then
                Exit Sub
            End If
        ElseIf Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MA0003 Then         '実行画面からの画面遷移
            '○画面項目設定処理
