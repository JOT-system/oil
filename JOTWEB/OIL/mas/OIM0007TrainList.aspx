<%@ Page Title="OIM0007L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0007TrainList.aspx.vb" Inherits="JOTWEB.OIM0007TrainList" %>
...
<asp:Content ID="OIM0007LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0007L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0007L.js")%>'></script>
...
<asp:Content ID="OIM0007L" ContentPlaceHolderID="contents1" runat="server">
