<%@ Page Title="T00011" Language="vb" AutoEventWireup="false" CodeBehind="GRT00011ACTUALQTY.aspx.vb" Inherits="OFFICE.GRT00011ACTUALQTY" %>
...
<%@ register src="inc/GRT00011WRKINC.ascx" tagname="work" tagprefix="LSINC" %>

<asp:Content ID="T00011H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/T00011.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/T00011.js")%>"></script>
</asp:Content> 
<asp:Content ID="T00011" ContentPlaceHolderID="contents1" runat="server">
        ...
        <div  class="headerboxOnly" id="headerbox">
            <div class="Operation">
                ...
                <a style="position:fixed;top:2.9em;left:3em;">
                    <asp:Label ID="WF_YMD_LABEL" runat="server" Text="出庫年月日" Height="1.3em" Font-Bold="True" Font-Underline="True"></asp:Label>
                </a>
                <a style="position:fixed;top:2.8em;left:10em;" ondblclick="Field_DBclick('WF_YMD' ,  <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR  %>)">
                    <asp:TextBox ID="WF_YMD" runat="server" Height="1.1em" Width="7em" CssClass="WF_TEXTBOX_CSS"></asp:TextBox>
                </a>
                <a style="position:fixed;top:2.8em;left:15.5em;">
                   <asp:Label ID="WF_YMD_TEXT" runat="server" Height="1.1em" Width="10em" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                </a>

                <a style="position:fixed;top:2.9em;left:20em;">
