...
<div hidden="hidden">
    ...
    <asp:TextBox ID="WF_SEL_TANKNUMBER2" runat="server"></asp:TextBox>              <!-- JOT車番(登録(新規追加用)) -->
    ...
    <asp:TextBox ID="WF_SEL_IDSSTAGCODE" runat="server"></asp:TextBox>              <!-- 出光昭和タグコード -->
    <asp:TextBox ID="WF_SEL_IDSSTAGNAME" runat="server"></asp:TextBox>              <!-- 出光昭和タグ名 -->
    ...
    <asp:TextBox ID="WF_SEL_ALLINSPECTIONDATE" runat="server"></asp:TextBox>        <!-- 次回全件年月日 -->
    <asp:TextBox ID="WF_SEL_PREINSPECTIONDATE" runat="server"></asp:TextBox>        <!-- 前回全件年月日 -->
    ...
    <asp:TextBox ID="WF_SEL_MODEL2" runat="server"></asp:TextBox>                   <!-- 形式(登録(新規追加用)) -->
    ...
    <asp:TextBox ID="WF_SEL_SAPSHELLTANKNUMBER" runat="server"></asp:TextBox>          <!-- SAP出光昭シ車番 -->
    <asp:TextBox ID="WF_SEL_RESERVE3" runat="server"></asp:TextBox>                 <!-- 予備 -->
    <asp:TextBox ID="WF_SEL_USEDFLG" runat="server"></asp:TextBox>                  <!-- 利用フラグ -->
    <asp:TextBox ID="WF_SEL_USEDFLG2" runat="server"></asp:TextBox>                 <!-- 利用フラグ(登録(新規追加用)) -->
