<%@ Page Title="MC0006S_JC" Language="vb" AutoEventWireup="false" CodeBehind="GRMC0006SELECT_JC.aspx.vb" Inherits="OFFICE.GRMC0006SELECT_JC" %>
...
<asp:Content ID="MC0006S" ContentPlaceHolderID="contents1" runat="server">
    ...
    <div  class="searchbox" id="searchbox" >
        ...
        <a style="position:fixed;top:12.1em;left:18em;" >
            <asp:RadioButtonList ID="rblToriCode" runat="server" RepeatLayout="Table" Width="12em"  RepeatDirection="Horizontal" >
                <asp:ListItem Text="JX" Value="JX"></asp:ListItem>
        ...
        <!-- 　都道府県１　 -->
        <a style="position:fixed;top:31.9em;left:4em;font-weight:bold;text-decoration:underline">都道府県</a>

        <a style="position:fixed;top:31.9em;left:18em;" ondblclick="Field_DBclick('WF_PREFECTURES1' ,   <%= LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_PREFECTURES1')">
            <asp:TextBox ID="WF_PREFECTURES1" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
        <a style="position:fixed;top:31.9em;left:27em;">
            <asp:Label ID="WF_PREFECTURES1_Text" runat="server" Text="" Width="17em" CssClass="WF_TEXT"></asp:Label>
        </a>

        <!-- 　都道府県２　 -->
        <a style="position:fixed;top:31.9em;left:44em;" ondblclick="Field_DBclick('WF_PREFECTURES2' ,   <%= LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_PREFECTURES2')">
            <asp:TextBox ID="WF_PREFECTURES2" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
        <a style="position:fixed;top:31.9em;left:53em;">
            <asp:Label ID="WF_PREFECTURES2_Text" runat="server" Text="" Width="17em" CssClass="WF_TEXT"></asp:Label>
        </a>

        <!-- 　都道府県３　 -->
        <a style="position:fixed;top:34.1em;left:18em;" ondblclick="Field_DBclick('WF_PREFECTURES3' ,   <%= LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_PREFECTURES3')">
            <asp:TextBox ID="WF_PREFECTURES3" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
        <a style="position:fixed;top:34.1em;left:27em;">
            <asp:Label ID="WF_PREFECTURES3_Text" runat="server" Text="" Width="17em" CssClass="WF_TEXT"></asp:Label>
        </a>

        <!-- 　都道府県４　 -->
        <a style="position:fixed;top:34.1em;left:44em;" ondblclick="Field_DBclick('WF_PREFECTURES4' ,   <%= LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_PREFECTURES4')">
            <asp:TextBox ID="WF_PREFECTURES4" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
        <a style="position:fixed;top:34.1em;left:53em;">
            <asp:Label ID="WF_PREFECTURES4_Text" runat="server" Text="" Width="17em" CssClass="WF_TEXT"></asp:Label>
        </a>

        <!-- 　都道府県５　 -->
        <a style="position:fixed;top:36.3em;left:18em;" ondblclick="Field_DBclick('WF_PREFECTURES5' ,   <%= LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_PREFECTURES5')">
            <asp:TextBox ID="WF_PREFECTURES5" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
        <a style="position:fixed;top:36.3em;left:27em;">
            <asp:Label ID="WF_PREFECTURES5_Text" runat="server" Text="" Width="17em" CssClass="WF_TEXT"></asp:Label>
        </a>
