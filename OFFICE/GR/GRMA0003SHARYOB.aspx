<%@ Page Title="MA0003" Language="vb" AutoEventWireup="false" CodeBehind="GRMA0003SHARYOB.aspx.vb" Inherits="OFFICE.GRMA0003SHARYOB" %>
...
<asp:Content ID="GRMA0003H" ContentPlaceHolderID="head" runat="server">

    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MA0003.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
        <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MA0003.js")%>"></script>
</asp:Content> 
<asp:Content ID="GRMA0003" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　headerbox -->
        ...
        <div  class="detailbox" id="detailbox">
            ...
            <div id="detailkeybox">
                ...
                <p id="KEY_LINE_2">
                    ...
                    <!-- ■　統一車番　■ -->
                    <a>
                        <asp:Label ID="WF_TSHABAN_L" runat="server" Text="統一車番" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="true" Font-Underline="true"></asp:Label>
                        <b ondblclick="Field_DBclick('WF_SHARYOTYPE' ,  910)" onchange="TabDisplayCTRL()">
