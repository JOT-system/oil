<%@ Page Title="MB0004" Language="vb" AutoEventWireup="false" CodeBehind="GRMB0004WORKINGH.aspx.vb" Inherits="OFFICE.GRMB0004WORKINGH" %>
...
<%@ Register Src="~/GR/inc/GRMB0004WRKINC.ascx" TagName="wrklist" TagPrefix="MSINC" %>

<asp:Content ID="MB0004H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MB0004.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MB0004.js")%>'></script>
...
<asp:Content ID="MB0004" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　headerbox -->
    <div class="headerbox" id="headerbox">
        <div class="Operation">
            <!-- 配属部署 -->
            <a>
                <asp:Label ID="WF_SELHORG_L" runat="server" Text="配属部署" Height="1.5em" Font-Bold="true" Font-Underline="true"></asp:Label>
            </a>
            <a ondblclick="Field_DBclick('WF_SELHORG', <%=LIST_BOX_CLASSIFICATION.LC_ORG%>)">
                <asp:TextBox ID="WF_SELHORG" runat="server" Height="1.1em" Width="7em" CssClass="WF_TEXTBOX_CSS" BorderStyle="NotSet"></asp:TextBox>
            </a>
            <a>
                <asp:Label ID="WF_SELHORG_TEXT" runat="server" Width="12em" CssClass="WF_TEXT"></asp:Label>
            </a>

            <!-- 職務区分 -->
            <a>
                <asp:Label ID="WF_SELSTAFFKBN_L" runat="server" Text="職務区分" Height="1.5em" Font-Bold="true" Font-Underline="true"></asp:Label>
            </a>
            <a ondblclick="Field_DBclick('WF_SELSTAFFKBN', <%=LIST_BOX_CLASSIFICATION.LC_STAFFKBN%>)">
                <asp:TextBox ID="WF_SELSTAFFKBN" runat="server" Height="1.1em" Width="7em" CssClass="WF_TEXTBOX_CSS" BorderStyle="NotSet"></asp:TextBox>
            </a>
            <a>
                <asp:Label ID="WF_SELSTAFFKBN_TEXT" runat="server" Width="12em" CssClass="WF_TEXT"></asp:Label>
            </a>
    ...
    <div class="detailbox" id="detailbox">
        ...
        <div id="detailkeybox">
            ...
            <p id="KEY_LINE_3">
                <!-- 配属部署 -->
                <a ondblclick="Field_DBclick('WF_HORG', <%=LIST_BOX_CLASSIFICATION.LC_ORG%>)">
                    <asp:Label ID="WF_HORG_L" runat="server" Text="配属部署" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="true" Font-Underline="true"></asp:Label>
                    <asp:TextBox ID="WF_HORG" runat="server" Height="1.1em" Width="15em" CssClass="WF_TEXTBOX_CSS"></asp:TextBox>
                    <asp:Label ID="WF_HORG_TEXT" runat="server" Width="17em" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                </a>
                
                <!-- 職務区分 -->
                <a ondblclick="Field_DBclick('WF_STAFFKBN', <%=LIST_BOX_CLASSIFICATION.LC_STAFFKBN%>)">
                    <asp:Label ID="WF_STAFFKBN_L" runat="server" Text="職務区分" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="true" Font-Underline="true"></asp:Label>
                    <asp:TextBox ID="WF_STAFFKBN" runat="server" Height="1.1em" Width="15em" CssClass="WF_TEXTBOX_CSS"></asp:TextBox>
                    <asp:Label ID="WF_STAFFKBN_TEXT" runat="server" Width="17em" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                </a>
            </p>
            <p id="KEY_LINE_4">
                <!-- 有効年月日 -->
                <a>
                    ...
                    <asp:Label ID="Label1" runat="server" Text=" ～ " CssClass="WF_TEXT_LABEL"></asp:Label>
