...
''' </summary>
''' <remarks></remarks>
Public Class GRT00007KINTAI_NJS
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC.MAPIDNJS
        ...
        '○ 右ボックスへの値設定
        rightview.MAPID = GRT00007WRKINC.MAPIDNJS
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC.MAPIDNJS
    ...
    Private Sub NIPPO_Screen()
        ...
        If T0005tbl.Rows.Count > 0 Then
            ...
            '呼出元MAPID　
            work.WF_T5_FROMMAPID.Text = GRT00007WRKINC.MAPIDNJS
            '画面一覧保存パス
            ...
            '呼出元VARIANT
            work.WF_T5_FROMMAPVARIANT.Text = Master.MAPvariant & GRT00007WRKINC.MAPVRNJS
    ...
    Protected Sub MAPrefelence(ByRef O_MSG As String, ByRef O_RTN As String)
        ...
        '■■■ 選択画面の入力初期値設定 ■■■
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007INJS Then       '条件画面からの画面遷移
