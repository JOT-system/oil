...
Public Class OIM0001OrgSearch
    ...
    Protected Sub Initialize()
        ...
        Master.MAPID = OIM0001WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.OIM0001L Then   '実行画面からの遷移
            '〇画面項目設定処理
            '会社コード
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = OIM0001WRKINC.MAPIDS
        rightview.MAPID = OIM0001WRKINC.MAPIDL
