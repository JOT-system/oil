...
''' 社外連携 - 取込 検索画面
''' </summary>
Public Class OIT0007FileInputSearch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If work.WF_SEL_CAN_BYPASS_SERACH.Text = "1" Then
                If Page.PreviousPage.Title = "OIT0007L" Then
    ...
    Protected Sub Initialize()
        ...
        Master.MAPID = OIT0007WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = OIT0007WRKINC.MAPIDS
        rightview.MAPID = OIT0007WRKINC.MAPIDL
