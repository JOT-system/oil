...
Public Class GRMC0003SELECT
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRMC0003WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MC0003 Then       '実行画面からの遷移
            '画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = GRMC0003WRKINC.MAPIDS
        rightview.MAPID = GRMC0003WRKINC.MAPID
