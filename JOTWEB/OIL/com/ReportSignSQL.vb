Public Class ReportSignSQL
    ...
    Public Function EmptyTurnDairyOTCompare(ByVal dt As DataTable, ByRef O_inOrder As String)
        ...
        '######################################################
        '# 受注TBLの前積のデータ取得(比較はなし)
        '######################################################
        Dim SQLPREPRODUCTStr As String =
              " SELECT " _
            & "   OIT0002.ORDERNO AS KEYCODE1" _
            & " , OIT0003.DETAILNO AS KEYCODE2 " _
            & " , OIT0002.OFFICECODE AS KEYCODE3 " _
            ...
            & " , '' AS OT_TRAINNO " _
            & " , '' AS OT_TRAINNAME " _
            & " , NULL AS OT_ORDERYMD " _
            & " , '' AS OT_OFFICECODE " _
            & " , '' AS OT_OFFICENAME " _
            & " , '' AS OT_SHIPPERSCODE " _
            & " , '' AS OT_SHIPPERSNAME " _
            & " , '' AS OT_BASECODE " _
            & " , '' AS OT_BASENAME " _
            & " , '' AS OT_CONSIGNEECODE " _
            & " , '' AS OT_CONSIGNEENAME " _
            & " , '' AS OT_DEPSTATION " _
            & " , '' AS OT_DEPSTATIONNAME " _
            & " , '' AS OT_ARRSTATION " _
            & " , '' AS OT_ARRSTATIONNAME " _
            & " , '' AS OT_SHIPORDER" _
            & " , '' AS OT_LINEORDER " _
            & " , '' AS OT_TANKNO " _
            ...
            & " , '' AS OT_ORDERINGOILNAME " _
            & " , '1' AS OT_CARSNUMBER " _
            & " , '0' AS OT_CARSAMOUNT " _
            & " , '' OT_RETURNDATETRAIN " _
            & " , '' AS OT_JOINTCODE " _
            & " , '' AS OT_JOINT " _
            & " , '' AS OT_REMARK " _
            & " , '' AS OT_SECONDCONSIGNEECODE " _
            & " , '' AS OT_SECONDCONSIGNEENAME " _
            & " , NULL AS OT_LODDATE " _
            & " , NULL AS OT_DEPDATE " _
            & " , NULL AS OT_ARRDATE " _
            & " , NULL AS OT_ACCDATE " _
            & " , NULL AS OT_EMPARRDATE " _
            & " , '' AS OT_BTRAINNO " _
            & " , '0' AS DELFLG " _
            & " , @INITYMD AS INITYMD " _
            & " , @INITUSER AS INITUSER " _
    ...
    Public Function EmptyTurnDairyOTComparePrint(ByVal mapID As String, Optional ByVal blnChoiceFlg As Boolean = False)
        ...
        SQLStr &=
            ...
            & "   AND OIM0003.OILCODE = OIT0020.OT_OILCODE " _
            & "   AND OIM0003.SEGMENTOILCODE = OIT0020.OT_ORDERINGTYPE " _
