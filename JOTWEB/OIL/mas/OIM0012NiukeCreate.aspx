<%@ Page Title="OIM0012C" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0012NiukeCreate.aspx.vb" Inherits="JOTWEB.OIM0012NiukeCreate" %>
...
<%@ Register Src="~/OIL/inc/OIM0012WRKINC.ascx" TagName="wrklist" TagPrefix="MSINC" %>

<asp:Content ID="OIM0012CH" ContentPlaceHolderID="head" runat="server">
<%--    <link href='<%=ResolveUrl("~/OIL/css/OIM0012C.css")%>' rel="stylesheet" type="text/css" />--%>
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0012C.js")%>'></script>
    <script type="text/javascript">
        var IsPostBack = '<%=If(IsPostBack = True, "1", "0")%>';
    </script>
</asp:Content>
 
<asp:Content ID="OIM0012C" ContentPlaceHolderID="contents1" runat="server">
            ...
            <div id="detailkeybox">
                ...
                <p id="KEY_LINE_2">
                    ...
                    <span class="ef">
                        ...
                        <asp:TextBox ID="WF_CONSIGNEECODE" runat="server" CssClass="WF_TEXTBOX_CSS" MaxLength="10"></asp:TextBox>
                ...
                <p id="KEY_LINE_4">
                    <!-- 荷受人名称 -->
                    <span class="ef">
                        <asp:Label ID="WF_CONSIGNEENAME_L" runat="server" Text="荷受人名称" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                        <asp:TextBox ID="WF_CONSIGNEENAME" runat="server" CssClass="WF_TEXTBOX_CSS" MaxLength="100"></asp:TextBox>
                        <asp:Label ID="WF_CONSIGNEENAME_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
