...
Partial Public Class OIT0004OilStockSearch
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents WF_CONSIGNEE_CODE As Global.System.Web.UI.WebControls.TextBox
    
    '''<summary>
    '''WF_CONSIGNEE_NAME コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents WF_CONSIGNEE_NAME As Global.System.Web.UI.WebControls.Label
