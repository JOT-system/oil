<%@ Page Title="OIT0007S" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIT0007FileInputSearch.aspx.vb" Inherits="JOTWEB.OIT0007FileInputSearch" %>
...
<asp:Content ID="OIT0007SH" ContentPlaceHolderID="head" runat="server">
    <!-- <link href='<%=ResolveUrl("~/OIL/css/OIT0007S.css")%>' rel="stylesheet" type="text/css" /> -->
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIT0007S.js")%>'></script>
</asp:Content>
<asp:Content ID="OIT0007S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
