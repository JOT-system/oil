<%@ Page Title="MB0001" Language="vb" AutoEventWireup="false" CodeBehind="GRMB0001STAFF.aspx.vb" Inherits="OFFICE.GRMB0001STAFF" %>
...
<%@ Register Src="~/GR/inc/GRMB0001WRKINC.ascx" TagName="wrklist" TagPrefix="MSINC" %>

<asp:Content ID="MB0001H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MB0001.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MB0001.js")%>'></script>
...
<asp:Content ID="MB0001" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　headerbox -->
    ...
    <div class="detailbox" id="detailbox">
        ...
        <div id="detailkeybox">
            ...
            <p id="KEY_LINE_2">
                ...
                <!-- 従業員コード -->
                <a ondblclick="Field_DBclick('WF_STAFFCODE', <%=LIST_BOX_CLASSIFICATION.LC_STAFFCODE%>)">
                    <asp:Label ID="WF_STAFFCODE_L" runat="server" Text="従業員コード" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="true" Font-Underline="true"></asp:Label>
                    <asp:TextBox ID="WF_STAFFCODE" runat="server" Height="1.1em" Width="15em" CssClass="WF_TEXTBOX_CSS"></asp:TextBox>
                    <asp:Label ID="WF_STAFFCODE_TEXT" runat="server" Width="17em" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                </a>
            </p>
            <p id="KEY_LINE_3">
                <!-- 有効年月日 -->
