            ...
            Using SQLcmd As New SqlCommand(SQLStr, SQLcon)
                For Each OIT0001OTrow As DataRow In OIT0001OTOrdertbl.Rows
                    With SQLcmd.Parameters
                        ...
                        .Add("@TRAINNO", SqlDbType.NVarChar).Value = OIT0001OTrow("TRAINNO")           '
                        .Add("@TRAINNAME", SqlDbType.NVarChar).Value = OIT0001OTrow("TRAINNAME")         '
                        .Add("@ORDERYMD", SqlDbType.NVarChar).Value = OIT0001OTrow("ORDERYMD")          '
                        .Add("@OFFICECODE", SqlDbType.NVarChar).Value = OIT0001OTrow("OFFICECODE")        '
                        .Add("@OFFICENAME", SqlDbType.NVarChar).Value = OIT0001OTrow("OFFICENAME")        '
                        .Add("@ORDERTYPE", SqlDbType.NVarChar).Value = OIT0001OTrow("ORDERTYPE")         '
                        .Add("@SHIPPERSCODE", SqlDbType.NVarChar).Value = OIT0001OTrow("SHIPPERSCODE")      '
                        .Add("@SHIPPERSNAME", SqlDbType.NVarChar).Value = OIT0001OTrow("SHIPPERSNAME")      '
                        .Add("@BASECODE", SqlDbType.NVarChar).Value = OIT0001OTrow("BASECODE")          '
                        .Add("@BASENAME", SqlDbType.NVarChar).Value = OIT0001OTrow("BASENAME")          '
                        .Add("@CONSIGNEECODE", SqlDbType.NVarChar).Value = OIT0001OTrow("CONSIGNEECODE")               '
                        .Add("@CONSIGNEENAME", SqlDbType.NVarChar).Value = OIT0001OTrow("CONSIGNEENAME")               '
