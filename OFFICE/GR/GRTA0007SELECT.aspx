<%@ Page Title="TA0007" Language="vb" AutoEventWireup="false" CodeBehind="GRTA0007SELECT.aspx.vb" Inherits="OFFICE.GRTA0007SELECT" %>
...
<asp:Content ID="TA0007SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0007S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0007S.js")%>"></script>
</asp:Content>
<asp:Content ID="TA0007S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　headerbox -->
            ...
            <div id="searchkeybox">
                ...
                <p class="LINE_3"> 
                    ...
                    <a style="position:fixed;top:12.1em;left:27em;">
                        <asp:Label ID="WF_HORG_Text" runat="server" Text="" Width="17em" Height="1.3em" CssClass="WF_TEXT"></asp:Label>
                    </a>
                </p>        
            </div>
            <a hidden="hidden">
