...
function InitDisplay() {
    ...
    //document.all('GridView').scrollTop = Number(document.getElementById("WF_SaveY").value);
    //document.all('GridView').scrollLeft = Number(document.getElementById("WF_SaveX").value);
    ...
    //EMSボタン表示／非表示
    if (document.getElementById('WF_EMS').value == "TRUE") {
        //表示
        document.getElementById("WF_ButtonEMS").hidden = false;
    } else {
        //非表示
        document.getElementById("WF_ButtonEMS").hidden = true;
    };
};
...
function SELECTOR_Click(tabNo, NAME) {
 ...
 //       document.getElementById("WF_SaveX").value = document.all('GridView').scrollLeft;
 //       document.getElementById("WF_SaveY").value = document.all('GridView').scrollTop;
        if (tabNo == '0') {
