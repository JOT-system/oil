...
Partial Public Class GRT00006EXPORT
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents WF_ZipName As Global.System.Web.UI.HtmlControls.HtmlInputText
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents WF_ZipURL As Global.System.Web.UI.HtmlControls.HtmlInputText
