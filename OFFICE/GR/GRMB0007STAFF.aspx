<%@ Page Title="MB0007" Language="vb" AutoEventWireup="false" CodeBehind="GRMB0007STAFF.aspx.vb" Inherits="OFFICE.GRMB0007STAFF" %>
...
<asp:Content ID="MB0007H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MB0007.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MB0007.js")%>'></script>
...
<asp:Content ID="MB0007" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　headerbox -->
