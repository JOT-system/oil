<%@ Page Title="MC0006_JC" Language="vb" AutoEventWireup="false" CodeBehind="GRMC0006TODOKESAKI_JC.aspx.vb" Inherits="OFFICE.GRMC0006TODOKESAKI_JC" %>
...
<asp:Content ID="GRMC0006H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MC0006_JC.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MC0006_JC.js")%>"></script>
</asp:Content> 
