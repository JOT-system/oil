<%@ Page Title="OIM0024L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0024PriorityList.aspx.vb" Inherits="JOTWEB.OIM0024PriorityList" %>
...
<asp:Content ID="OIM0024LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0024L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0024L.js")%>'></script>
...
<asp:Content ID="OIM0024L" ContentPlaceHolderID="contents1" runat="server">
