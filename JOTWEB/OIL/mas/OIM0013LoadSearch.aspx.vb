...
Public Class OIM0013LoadSearch
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = OIM0013WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.SUBMENU Then         'メニューからの画面遷移
            ...
            Master.GetFirstValue(work.WF_SEL_LOADINGPOINT.Text, "LOADINGPOINT", WF_LOADINGPOINT.Text)               '積込ポイント
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.OIM0013L Then   '実行画面からの遷移
            '画面項目設定処理
            WF_PLANTCODE.Text = work.WF_SEL_PLANTCODE.Text                                                          '基地コード
            WF_LOADINGPOINT.Text = work.WF_SEL_LOADINGPOINT.Text                                                    '積込ポイント
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = OIM0013WRKINC.MAPIDS
        rightview.MAPID = OIM0013WRKINC.MAPIDL
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        Master.EraseCharToIgnore(WF_LOADINGPOINT.Text)              '積込ポイント
        ...
        work.WF_SEL_LOADINGPOINT.Text = WF_LOADINGPOINT.Text        '積込ポイント
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        '積込ポイント
        WW_TEXT = WF_LOADINGPOINT.Text
        Master.CheckField(Master.USERCAMP, "LOADINGPOINT", WF_LOADINGPOINT.Text, WW_CS0024FCHECKERR, WW_CS0024FCHECKREPORT)
        If isNormal(WW_CS0024FCHECKERR) Then
            If String.IsNullOrEmpty(WW_TEXT) Then
                WF_LOADINGPOINT.Text = ""
            End If
        Else
            Master.Output(WW_CS0024FCHECKERR, C_MESSAGE_TYPE.ERR, "積込ポイント", needsPopUp:=True)
            WF_LOADINGPOINT.Focus()
            O_RTN = "ERR"
            Exit Sub
        End If
    ...
    Protected Sub WF_FIELD_Change()
        ...
        '○ 変更した項目の名称をセット
        Select Case WF_FIELD.Value
            Case WF_PLANTCODE.ID, WF_OILCODE.ID, WF_SEGMENTOILCODE.ID
                '※関連項目も併せて処理している
                '基地コード
                CODENAME_get("PLANTCODE", WF_PLANTCODE.Text, WF_PLANTCODE_TEXT.Text, WW_RTN_SW)
                '油種コード
    ...
    Protected Sub WF_ButtonSel_Click()
        ...
        Select Case WF_FIELD.Value
            ...
            Case WF_OILCODE.ID
                ...
                '関連項目処理
                CODENAME_get("PLANTCODE", WF_PLANTCODE.Text, WF_PLANTCODE_TEXT.Text, WW_RTN_SW)                 '基地コード
                CODENAME_get("SEGMENTOILCODE", WF_SEGMENTOILCODE.Text, WF_SEGMENTOILCODE_TEXT.Text, WW_RTN_SW)  '油種細分コード
