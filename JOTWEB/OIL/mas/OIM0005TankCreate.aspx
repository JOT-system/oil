            ...
            <div id="detailkeybox">
                ...
                <p id="KEY_LINE_2">
                    ...
                    <a  class="ef" ondblclick="Field_DBclick('WF_TANKNUMBER', <%=LIST_BOX_CLASSIFICATION.LC_TANKNUMBER%>);" onchange="TextBox_change('WF_TANKNUMBER');">
                        <asp:Label ID="WF_TANKNUMBER_L" runat="server" Text="JOT車番" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                ...
                <p id="KEY_LINE_5">
                    ...
                    <a class="ef" ondblclick="Field_DBclick('WF_LEASESTYMD', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        <asp:Label ID="WF_LEASESTYMD_L" runat="server" Text="リース開始年月日" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                ...
                <p id="KEY_LINE_6">
                    ...
                    <a class="ef" ondblclick="Field_DBclick('WF_LEASEENDYMD', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        <asp:Label ID="WF_LEASEENDYMD_L" runat="server" Text="リース満了年月日" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                ...
                <p id="KEY_LINE_8">
                    ...
                    <a class="ef" ondblclick="Field_DBclick('WF_USERLIMIT', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        <asp:Label ID="WF_USERLIMIT_L" runat="server" Text="第三者使用期限" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                    ...
                    <a class="ef" ondblclick="Field_DBclick('WF_LIMITTEXTRADIARYSTATION', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        <asp:Label ID="WF_LIMITTEXTRADIARYSTATION_L" runat="server" Text="臨時常備駅期限" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                ...
                <p id="KEY_LINE_10">
                    ...
                    <a class="ef" ondblclick="Field_DBclick('WF_EXTRADINARYLIMIT', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        <asp:Label ID="WF_EXTRADINARYLIMIT_L" runat="server" Text="臨時専用期限" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                ...
                <p id="KEY_LINE_12">
                    ...
                    <a class="ef" ondblclick="Field_DBclick('WF_ALLINSPECTIONDATE', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        <asp:Label ID="WF_ALLINSPECTIONDATE_L" runat="server" Text="取得年月日" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                ...
                <p id="KEY_LINE_13">
                    ...
                    <a class="ef" ondblclick="Field_DBclick('WF_TRANSFERDATE', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        <asp:Label ID="WF_TRANSFERDATE_L" runat="server" Text="車籍編入年月日" Width="10.0em" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
