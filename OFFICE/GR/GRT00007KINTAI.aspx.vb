...
Public Class GRT00007KINTAI
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC.MAPID
        ...
        '○ 右ボックスへの値設定
        rightview.MAPID = GRT00007WRKINC.MAPID
    ...
    Protected Sub WF_FIELD_Change()
        ...
        If WW_RESULT = "変更1" Then
            ...
            Dim hydFlg As Boolean = False
            If WF_FIELD.Value = "WF_HAYADETIME" Then
                hydFlg = True
            End If
        ...
        Select Case WF_FIELD.Value
            ...
            Case "WF_KOATUTIME"
                WF_HAYADETIME.Focus()
            Case "WF_HAYADETIME"
                WF_TOKSAAKAISU.Focus()
            Case "WF_TOKSAAKAISU"
                WF_TOKSABKAISU.Focus()
            Case "WF_TOKSABKAISU"
                WF_TOKSACKAISU.Focus()
            Case "WF_TOKSACKAISU"
                WF_TENKOKAISU.Focus()
            Case "WF_TENKOKAISU"
                WF_PAYKBN.Focus()
    ...
    Protected Sub ItemChangeCheck(ByRef oRtn As String)
        ...
        For Each T0007INProw As DataRow In T0007INPtbl.Rows
            ...
            If T0007INProw("HDKBN") = "H" And T0007INProw("RECODEKBN") = "0" Then
                ...
                T0007INProw("HOANTIME") = WF_HOANTIME.Text
                T0007INProw("HOANTIMETTL") = WF_HOANTIME.Text
                T0007INProw("KOATUTIME") = WF_KOATUTIME.Text
                T0007INProw("KOATUTIMETTL") = WF_KOATUTIME.Text
                T0007INProw("HAYADETIME") = WF_HAYADETIME.Text
                T0007INProw("HAYADETIMETTL") = WF_HAYADETIME.Text
                T0007INProw("TOKSAAKAISU") = WF_TOKSAAKAISU.Text
                T0007INProw("TOKSABKAISU") = WF_TOKSABKAISU.Text
                T0007INProw("TOKSACKAISU") = WF_TOKSACKAISU.Text
                T0007INProw("TENKOKAISU") = WF_TENKOKAISU.Text
                T0007INProw("TOKSAAKAISUTTL") = WF_TOKSAAKAISU.Text
                T0007INProw("TOKSABKAISUTTL") = WF_TOKSABKAISU.Text
                T0007INProw("TOKSACKAISUTTL") = WF_TOKSACKAISU.Text
        ...
        If WW_UPD_ST = "ON" Or WW_UPD_END = "ON" Or WW_UPD_BREAK = "ON" Then
            ...
            'その他作業部署取得
            Dim otherOrg As ListBox = T0007COM.getList(work.WF_T7SEL_CAMPCODE.Text, GRT00007WRKINC.CONST_OTHER)
            ...
            For Each WW_HEADrow As DataRow In WW_HEADtbl.Rows
                ...
                For i As Integer = 0 To T0005tbl.Rows.Count - 1
                    ...
                    '出荷部署が袖２（袖２で仕事をした）の場合（その他作業20分）とする
                    If Not IsNothing(otherOrg.Items.FindByValue(WW_NIPPOrow("SHIPORG"))) Then
                        WW_SODE20 += 1
                    End If
                ...
                If T0005tbl.Rows.Count > 0 Then
                    ...
                    WW_date = CDate(WW_T0007row("STDATE") & " " & WW_T0007row("STTIME"))
                    If WW_SODE20 > 0 Then
                        WW_T0007row("ENDDATE") = WW_date.AddMinutes(20).ToString("yyyy/MM/dd")
                        WW_T0007row("ENDTIME") = WW_date.AddMinutes(20).ToString("HH:mm")
                    Else
        ...
        For Each T0007INProw As DataRow In T0007INPtbl.Rows
            ...
            If T0007INProw("HDKBN") = "H" And T0007INProw("RECODEKBN") = "2" Then
                ...
                T0007INProw("WEEKNISSUCHO") = Val(WF_WEEKNISSUTTL.Text) - T0007INProw("WEEKNISSU")
                ...
                T0007INProw("TOKSAAKAISUCHO") = Val(WF_TOKSAAKAISUTTL.Text) - T0007INProw("TOKSAAKAISU")
                T0007INProw("TOKSAAKAISUTTL") = Val(T0007INProw("TOKSAAKAISU")) + Val(T0007INProw("TOKSAAKAISUCHO"))
                T0007INProw("TOKSABKAISUCHO") = Val(WF_TOKSABKAISUTTL.Text) - T0007INProw("TOKSABKAISU")
                T0007INProw("TOKSABKAISUTTL") = Val(T0007INProw("TOKSABKAISU")) + Val(T0007INProw("TOKSABKAISUCHO"))
                T0007INProw("TOKSACKAISUCHO") = Val(WF_TOKSACKAISUTTL.Text) - T0007INProw("TOKSACKAISU")
                ...
                T0007INProw("HOANTIMECHO") = T0007COM.HHMMtoMinutes(WF_HOANTIMETTL.Text) - T0007COM.HHMMtoMinutes(T0007INProw("HOANTIME"))
                T0007INProw("HOANTIMETTL") = T0007COM.HHMMtoMinutes(T0007INProw("HOANTIME")) + T0007INProw("HOANTIMECHO")
                T0007INProw("KOATUTIMECHO") = T0007COM.HHMMtoMinutes(WF_KOATUTIMETTL.Text) - T0007COM.HHMMtoMinutes(T0007INProw("KOATUTIME"))
                ...
                T0007INProw("HAYADETIMECHO") = T0007COM.HHMMtoMinutes(WF_HAYADETIMETTL.Text) - T0007COM.HHMMtoMinutes(T0007INProw("HAYADETIME"))
                T0007INProw("HAYADETIMETTL") = T0007COM.HHMMtoMinutes(T0007INProw("HAYADETIME")) + T0007INProw("HAYADETIMECHO")
                T0007INProw("PONPNISSUCHO") = Val(WF_PONPNISSUTTL.Text) - Val(T0007INProw("PONPNISSU"))
                T0007INProw("PONPNISSUTTL") = Val(T0007INProw("PONPNISSU")) + Val(T0007INProw("PONPNISSUCHO"))
                T0007INProw("BULKNISSUCHO") = Val(WF_BULKNISSUTTL.Text) - T0007INProw("BULKNISSU")
                T0007INProw("BULKNISSUTTL") = Val(T0007INProw("BULKNISSU")) + Val(T0007INProw("BULKNISSUCHO"))
                T0007INProw("TRAILERNISSUCHO") = Val(WF_TRAILERNISSUTTL.Text) - T0007INProw("TRAILERNISSU")
                T0007INProw("TRAILERNISSUTTL") = Val(T0007INProw("TRAILERNISSU")) + Val(T0007INProw("TRAILERNISSUCHO"))
                T0007INProw("BKINMUKAISUCHO") = Val(WF_BKINMUKAISUTTL.Text) - T0007INProw("BKINMUKAISU")
                ...
                T0007INProw("HAYADETIMECHO") = T0007COM.formatHHMM(T0007INProw("HAYADETIMECHO"))
                T0007INProw("HAYADETIMETTL") = T0007COM.formatHHMM(T0007INProw("HAYADETIMETTL"))
            ...
            If T0007INProw("HDKBN") = "D" And T0007INProw("RECODEKBN") = "2" Then
                ...
                Select Case T0007INProw("OILPAYKBN")
                    ...
                    Case "04" 'ＬＮＧ
                        Select Case T0007INProw("SHARYOKBN")
                            Case "1" '単車
                                If WF_UNLOADCNT_LNG1.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_LNG1.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_LNG1.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_LNG1.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                            Case "2" 'トレーラ
                                If WF_UNLOADCNT_LNG2.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_LNG2.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_LNG2.Text) - T0007INProw("UNLOADCNT")
                    ...
                    Case "06" '酸素
                        Select Case T0007INProw("SHARYOKBN")
                            Case "1" '単車
                                If WF_UNLOADCNT_SANS1.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_SANS1.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_SANS1.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_SANS1.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                            Case "2" 'トレーラ
                                If WF_UNLOADCNT_SANS2.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_SANS2.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_SANS2.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_SANS2.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                        End Select
                    Case "07" '窒素
                        Select Case T0007INProw("SHARYOKBN")
                            Case "1" '単車
                                If WF_UNLOADCNT_CHIS1.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_CHIS1.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_CHIS1.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_CHIS1.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                            Case "2" 'トレーラ
                                If WF_UNLOADCNT_CHIS2.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_CHIS2.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_CHIS2.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_CHIS2.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                        End Select
                    Case "08" 'ﾒﾀｰﾉｰﾙ
                        Select Case T0007INProw("SHARYOKBN")
                            Case "1" '単車
                                If WF_UNLOADCNT_META1.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_META1.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_META1.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_META1.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                            Case "2" 'トレーラ
                                If WF_UNLOADCNT_META2.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_META2.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_META2.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_META2.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                        End Select
                    Case "09" 'ﾗﾃｯｸｽ
                        Select Case T0007INProw("SHARYOKBN")
                            Case "1" '単車
                                If WF_UNLOADCNT_RATE1.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_RATE1.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_RATE1.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_RATE1.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                            Case "2" 'トレーラ
                                If WF_UNLOADCNT_RATE2.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_RATE2.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_RATE2.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_RATE2.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                        End Select
                    Case "10" '水素
                        Select Case T0007INProw("SHARYOKBN")
                            Case "1" '単車
                                If WF_UNLOADCNT_SUIS1.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_SUIS1.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_SUIS1.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_SUIS1.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                            Case "2" 'トレーラ
                                If WF_UNLOADCNT_SUIS2.Text <> T0007INProw("UNLOADCNTTTL") Or
                                   WF_HAIDISTANCE_SUIS2.Text <> T0007INProw("HAIDISTANCETTL") Then
                                    T0007INProw("UNLOADCNTCHO") = Val(WF_UNLOADCNT_SUIS2.Text) - T0007INProw("UNLOADCNT")
                                    T0007INProw("HAIDISTANCECHO") = Val(WF_HAIDISTANCE_SUIS2.Text) - T0007INProw("HAIDISTANCE")
                                    WW_UPD_FLG2 = "ON"
                                End If
                        End Select
                End Select
    ...
    Protected Sub InpCHARstr()
        ...
        WF_HOANTIME.Text = charStr(WF_HOANTIME.Text)
        WF_KOATUTIME.Text = charStr(WF_KOATUTIME.Text)
        WF_HAYADETIME.Text = charStr(WF_HAYADETIME.Text)
        WF_TOKSAAKAISU.Text = charStr(WF_TOKSAAKAISU.Text)
        WF_TOKSABKAISU.Text = charStr(WF_TOKSABKAISU.Text)
        WF_TOKSACKAISU.Text = charStr(WF_TOKSACKAISU.Text)
        WF_TENKOKAISU.Text = charStr(WF_TENKOKAISU.Text)
        ...
        WF_WEEKNISSUTTL.Text = charStr(WF_WEEKNISSUTTL.Text)
        ...
        WF_TOKSAAKAISUTTL.Text = charStr(WF_TOKSAAKAISUTTL.Text)
        WF_TOKSABKAISUTTL.Text = charStr(WF_TOKSABKAISUTTL.Text)
        WF_TOKSACKAISUTTL.Text = charStr(WF_TOKSACKAISUTTL.Text)
        ...
        WF_NIGHTTIMETTL.Text = charStr(WF_NIGHTTIMETTL.Text)
        WF_HOANTIMETTL.Text = charStr(WF_HOANTIMETTL.Text)
        WF_KOATUTIMETTL.Text = charStr(WF_KOATUTIMETTL.Text)
        WF_HAYADETIMETTL.Text = charStr(WF_HAYADETIMETTL.Text)
        WF_TOKUSA1TIMETTL.Text = charStr(WF_TOKUSA1TIMETTL.Text)
        WF_PONPNISSUTTL.Text = charStr(WF_PONPNISSUTTL.Text)
        WF_BULKNISSUTTL.Text = charStr(WF_BULKNISSUTTL.Text)
        WF_TRAILERNISSUTTL.Text = charStr(WF_TRAILERNISSUTTL.Text)
        WF_BKINMUKAISUTTL.Text = charStr(WF_BKINMUKAISUTTL.Text)
    End Sub
    ...
    Private Sub GRID_INITset()
        ...
        Try
            ...
            '早出補填を入力する部署取得
            Dim hayadeOrg As ListBox = T0007COM.getList(work.WF_T7SEL_CAMPCODE.Text, GRT00007WRKINC.CONST_HAYA)

            If Not IsNothing(hayadeOrg.Items.FindByValue(WF_HORG.Text)) Then
                '対象の場合、早出補填を入力可能にする
                WF_HAYADETIME.Enabled = True
            End If
    ...
    Public Sub T00005ALLget(ByVal iKBN As String,
        ...
        Try
            ...
            T0007COM.ConvORGCODE(work.WF_T7SEL_CAMPCODE.Text, work.WF_T7SEL_HORG.Text, orgCode, retCode)
        ...
        For Each T0007INProw As DataRow In iTbl.Rows
            ...
            If T0007INProw("RECODEKBN") = "0" Then
                If T0007INProw("HDKBN") = "H" Then
                    ...
                    WF_TOKSAAKAISU.Text = T0007INProw("TOKSAAKAISUTTL")
                    WF_TOKSABKAISU.Text = T0007INProw("TOKSABKAISUTTL")
                    WF_TOKSACKAISU.Text = T0007INProw("TOKSACKAISUTTL")
                    WF_TENKOKAISU.Text = Val(T0007INProw("TENKOKAISUTTL")).ToString("0.0")
                    ...
                    WF_HOANTIME.Text = T0007INProw("HOANTIMETTL")
                    WF_SNIGHTTIME.Text = T0007INProw("SNIGHTTIMETTL")
                    WF_KOATUTIME.Text = T0007INProw("KOATUTIMETTL")
                    WF_HAYADETIME.Text = T0007INProw("HAYADETIMETTL")
                    '休憩時間
                    WF_NIPPOBREAKTIME.Text = T0007INProw("NIPPOBREAKTIME")
                    WF_BREAKTIME.Text = T0007INProw("BREAKTIME")
                End If
            ...
            If T0007INProw("RECODEKBN") = "2" Then
                If T0007INProw("HDKBN") = "H" Then
                    ...
                    WF_WEEKNISSUTTL.Text = T0007INProw("WEEKNISSUTTL") '週休
                    ...
                    WF_PONPNISSUTTL.Text = T0007INProw("PONPNISSUTTL") 'ポンプ日数
                    WF_BULKNISSUTTL.Text = T0007INProw("BULKNISSUTTL") 'バルク日数
                    WF_TRAILERNISSUTTL.Text = T0007INProw("TRAILERNISSUTTL") 'トレーラ日数
                    WF_BKINMUKAISUTTL.Text = T0007INProw("BKINMUKAISUTTL") 'Ｂ勤務回数
                    WF_TOKSAAKAISUTTL.Text = T0007INProw("TOKSAAKAISUTTL") '特作A
                    WF_TOKSABKAISUTTL.Text = T0007INProw("TOKSABKAISUTTL") '特作B
                    WF_TOKSACKAISUTTL.Text = T0007INProw("TOKSACKAISUTTL") '特作C
                    WF_TENKOKAISUTTL.Text = Val(T0007INProw("TENKOKAISUTTL")).ToString("0.0") '点呼回数
                    ...
                    WF_HOANTIMETTL.Text = T0007INProw("HOANTIMETTL") '保安検査
                    WF_SWORKTIMETTL.Text = T0007INProw("SWORKTIMETTL") '日曜出勤
                    WF_SNIGHTTIMETTL.Text = T0007INProw("SNIGHTTIMETTL") '日曜深夜
                    WF_KOATUTIMETTL.Text = T0007INProw("KOATUTIMETTL") '高圧作業
                    WF_HAYADETIMETTL.Text = T0007INProw("HAYADETIMETTL") '時差出勤手当
                ...
                If T0007INProw("HDKBN") = "D" Then
                    Select Case T0007INProw("OILPAYKBN")
                        ...
                        Case "04"  'ＬＮＧ
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_LNG1.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_LNG1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_LNG2.Text = T0007INProw("UNLOADCNTTTL")
                        ...
                        Case "06"  '酸素
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_SANS1.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_SANS1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_SANS2.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_SANS2.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                        Case "07"  '窒素・ｱﾙｺﾞﾝ
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_CHIS1.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_CHIS1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_CHIS2.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_CHIS2.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                        Case "08"  'メタノール
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_META1.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_META1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_META2.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_META2.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                        Case "09"  'ラテックス
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_RATE1.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_RATE1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_RATE2.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_RATE2.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                        Case "10" '水素
                            If T0007INProw("SHARYOKBN") = "1" Then
                                WF_UNLOADCNT_SUIS1.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_SUIS1.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                            If T0007INProw("SHARYOKBN") = "2" Then
                                WF_UNLOADCNT_SUIS2.Text = T0007INProw("UNLOADCNTTTL")
                                WF_HAIDISTANCE_SUIS2.Text = Val(T0007INProw("HAIDISTANCETTL")).ToString("0")
                            End If
                    End Select
                End If
            End If
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC.MAPID
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "0" Then
            ...
            If WF_STTIME.Text <> "" Then
                ...
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    ...
                    If Right(WF_STTIME.Text, 1) = "0" Or Right(WF_STTIME.Text, 1) = "5" Then
                    Else
                        Dim WW_ERR_MES As String = ""
            ...
            If WF_TOKUSA1TIME.Text <> "" Then
                ...
                CS0036FCHECK.VALUE = WF_KOATUTIME.Text
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    WF_KOATUTIME.Text = CDate(CS0036FCHECK.VALUEOUT).ToString("HH:mm")
                Else
                    'エラーレポート編集
                    Dim WW_ERR_MES As String = ""
                    WW_ERR_MES = "・更新できないレコード(高圧作業エラー)です。"
                    WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                    ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
                End If
            Else
            ...
            If WF_HAYADETIME.Enabled Then
                '・キー項目(早出補填手当：HAYADETIME)
                '①必須・項目属性チェック
                If WF_HAYADETIME.Text <> "" Then
                    CS0036FCHECK.FIELD = "HAYADETIME"
                    CS0036FCHECK.VALUE = WF_HAYADETIME.Text
                    CS0036FCHECK.CS0036FCHECK()
                    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                        WF_HAYADETIME.Text = CDate(CS0036FCHECK.VALUEOUT).ToString("HH:mm")
                    Else
                        'エラーレポート編集
                        Dim WW_ERR_MES As String = ""
                        WW_ERR_MES = "・更新できないレコード(早出補填手当エラー)です。"
                        WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                        ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
                    End If
                Else
                    WF_HAYADETIME.Text = "00:00"
                End If
            ...
            If WF_TOKUSA1TIME.Text <> "" Then
                ...
                CS0036FCHECK.VALUE = WF_HOANTIME.Text
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    WF_HOANTIME.Text = CDate(CS0036FCHECK.VALUEOUT).ToString("HH:mm")
                Else
                    'エラーレポート編集
                    Dim WW_ERR_MES As String = ""
                    WW_ERR_MES = "・更新できないレコード(保安検査エラー)です。"
                    WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                    ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
                End If
            Else
            ...
            '・キー項目(特作Ａ：TOKSAAKAISU)
            '①必須・項目属性チェック
            If WF_TOKUSA1TIME.Text <> "" Then
                CS0036FCHECK.FIELD = "TOKSAAKAISU"
                CS0036FCHECK.VALUE = WF_TOKSAAKAISU.Text
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    WF_TOKSAAKAISU.Text = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
                    Dim WW_ERR_MES As String = ""
                    WW_ERR_MES = "・更新できないレコード(特作Ａエラー)です。"
                    WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                    ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
                End If
            End If

            '・キー項目(特作Ｂ：TOKSABKAISU)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "TOKSABKAISU"
            CS0036FCHECK.VALUE = WF_TOKSABKAISU.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_TOKSABKAISU.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(特作Ｂエラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(特作Ｂ：TOKSACKAISU)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "TOKSACKAISU"
            CS0036FCHECK.VALUE = WF_TOKSACKAISU.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_TOKSACKAISU.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(特作Ｃエラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
            ...
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                If Val(CS0036FCHECK.VALUEOUT) = 1 Or Val(CS0036FCHECK.VALUEOUT) = 0.5 Or Val(CS0036FCHECK.VALUEOUT) = 0 Then
                    WF_TENKOKAISU.Text = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
                    Dim WW_ERR_MES As String = ""
                    WW_ERR_MES = "・更新できないレコード(点呼回数エラー)です。"
                    WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & "０回、０．５回、１回のいずれかです" & " , "
                    ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
                End If
            Else
                'エラーレポート編集
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "2" Then
            ...
            '・キー項目(週休：WEEKNISSUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "WEEKNISSUTTL"
            CS0036FCHECK.VALUE = WF_WEEKNISSUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_WEEKNISSUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(週休日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
            ...
            '・キー項目(特作Ａ：TOKSAAKAISUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "TOKSAAKAISUTTL"
            CS0036FCHECK.VALUE = WF_TOKSAAKAISUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_TOKSAAKAISUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(特作Ａ日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(特作Ｂ：TOKSABKAISUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "TOKSABKAISUTTL"
            CS0036FCHECK.VALUE = WF_TOKSABKAISUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_TOKSABKAISUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(特作Ｂ日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(特作Ｃ：TOKSACKAISUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "TOKSACKAISUTTL"
            CS0036FCHECK.VALUE = WF_TOKSACKAISUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_TOKSACKAISUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(特作Ｃ日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
            ...
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                ...
                Else
                    ...
                    Dim WW_ERR_MES As String = ""
                    WW_ERR_MES = "・更新できないレコード(点呼回数エラー)です。"
                    WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & "０．５回単位で入力" & " , "
                    ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
                End If
            Else
                'エラーレポート編集
            ...
            '・キー項目(ポンプ：PONPNISSUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "PONPNISSUTTL"
            CS0036FCHECK.VALUE = WF_PONPNISSUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_PONPNISSUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(ポンプ日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(バルク：BULKNISSUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "BULKNISSUTTL"
            CS0036FCHECK.VALUE = WF_BULKNISSUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_BULKNISSUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(バルク日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラ：TRAILERNISSUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "TRAILERNISSUTTL"
            CS0036FCHECK.VALUE = WF_TRAILERNISSUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_TRAILERNISSUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラ日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(Ｂ勤務：BKINMUKAISUTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "BKINMUKAISUTTL"
            CS0036FCHECK.VALUE = WF_BKINMUKAISUTTL.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_BKINMUKAISUTTL.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(Ｂ勤務日数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
            ...
            '・キー項目(高圧作業：KOATUTIMETTL)
            '①必須・項目属性チェック
            WW_TIMEstr = WF_KOATUTIMETTL.Text.Split(":")
            If WW_TIMEstr.Length = 2 Then
            ...
            Else
                ...
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(高圧作業エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & WF_KOATUTIMETTL.Text & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(保安検査：HOANTIMETTL)
            '①必須・項目属性チェック
            WW_TIMEstr = WF_HOANTIMETTL.Text.Split(":")
            If WW_TIMEstr.Length = 2 Then
                ...
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    ...
                    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                        ...
                        Else
                            ...
                            Dim WW_ERR_MES As String = ""
                            WW_ERR_MES = "・更新できないレコード(保安検査エラー)です。"
                            WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & WF_HOANTIMETTL.Text & " , "
                            ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
                        End If
                    Else
                        'エラーレポート編集
            ...
            '・キー項目(単車ＬＮＧ荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_LNG1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_LNG1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
            ...
            '・キー項目(トレーラＬＮＧ荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_LNG2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_LNG2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
            ...
            '・キー項目(単車酸素荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_SANS1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_SANS1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車酸素荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(単車酸素配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_SANS1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_SANS1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車酸素配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラ酸素荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_SANS2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_SANS2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラ酸素荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラ酸素配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_SANS2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_SANS2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラ酸素配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(単車窒素荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_CHIS1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_CHIS1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車窒素荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(単車窒素配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_CHIS1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_CHIS1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車窒素配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラ窒素荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_CHIS2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_CHIS2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラ窒素荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラ窒素配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_CHIS2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_CHIS2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラ窒素配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If


            '・キー項目(単車水素荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_SUIS1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_SUIS1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車水素荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(単車水素配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_SUIS1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_SUIS1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車水素配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラ水素荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_SUIS2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_SUIS2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラ水素荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラ水素配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_SUIS2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_SUIS2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラ水素配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
            ...
            '・キー項目(単車メタノール荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_META1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_META1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車メタノール荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(単車メタノール配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_META1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_META1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車メタノール配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラメタノール荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_META2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_META2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラメタノール荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーラメタノール配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_META2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_META2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーラメタノール配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
            ...
            '・キー項目(単車ラテックス荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_RATE1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_RATE1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車ラテックス荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(単車ラテックス配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_RATE1.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_RATE1.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(単車ラテックス配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーララテックス荷卸回数：UNLOADCNTTTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "UNLOADCNTTTL"
            CS0036FCHECK.VALUE = WF_UNLOADCNT_RATE2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_UNLOADCNT_RATE2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーララテックス荷卸回数エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If

            '・キー項目(トレーララテックス配送距離：HAIDISTANCETTL)
            '①必須・項目属性チェック
            CS0036FCHECK.FIELD = "HAIDISTANCETTL"
            CS0036FCHECK.VALUE = WF_HAIDISTANCE_RATE2.Text
            CS0036FCHECK.CS0036FCHECK()
            If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                WF_HAIDISTANCE_RATE2.Text = Val(CS0036FCHECK.VALUEOUT)
            Else
                'エラーレポート編集
                Dim WW_ERR_MES As String = ""
                WW_ERR_MES = "・更新できないレコード(トレーララテックス配送距離エラー)です。"
                WW_ERR_MES = WW_ERR_MES & ControlChars.NewLine & "  --> " & CS0036FCHECK.CHECKREPORT & " , "
                ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.INVALID_REGIST_RECORD_ERROR)
            End If
        ...
        If work.WF_T7KIN_RECODEKBN.Text = "0" Then
            ...
            If T0007COM.CheckHOLIDAY("0", WF_PAYKBN.Text) Then
                ...
                If WF_TOKUSA1TIME.Text <> "00:00" Then
                    ...
                    WW_ERR = "ON"
                End If
                If WF_HOANTIME.Text <> "00:00" Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 保安検査 =" & WF_HOANTIME.Text & " , "
                    WW_ERR = "ON"
                End If
                If WF_KOATUTIME.Text <> "00:00" Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 高圧作業 =" & WF_KOATUTIME.Text & " , "
                    WW_ERR = "ON"
                End If
                If Val(WF_TOKSAAKAISU.Text) > 0 Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 業務手当A=" & WF_TOKSAAKAISU.Text & " , "
                    WW_ERR = "ON"
                End If
                If Val(WF_TOKSABKAISU.Text) > 0 Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 業務手当B=" & WF_TOKSABKAISU.Text & " , "
                    WW_ERR = "ON"
                End If
                If Val(WF_TOKSACKAISU.Text) > 0 Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 業務手当C=" & WF_TOKSACKAISU.Text & " , "
                    WW_ERR = "ON"
                End If
                If Val(WF_TENKOKAISU.Text) > 0 Then
                    WW_ERR_MES1 = WW_ERR_MES1 & ControlChars.NewLine & "  --> 点呼回数 =" & WF_TENKOKAISU.Text & " , "
                    WW_ERR = "ON"
                End If
            ...
            Else
                If IsDate(WF_STDATE.Text) And IsDate(WF_STTIME.Text) And
                    ...
                    If WW_STDATE > WW_ENDDATE Then
                        ...
                        ERRMSG_write(WW_ERR_MES, WW_LINEerr, C_MESSAGE_NO.BOX_ERROR_EXIST)
                    End If
                End If
            End If
    ...
    Private Sub NIPPO_Screen()
        ...
        If T0005tbl.Rows.Count > 0 Then
            ...
            '呼出元MAPID　
            work.WF_T5_FROMMAPID.Text = GRT00007WRKINC.MAPID
            '画面一覧保存パス
            ...
            '呼出元VARIANT
            work.WF_T5_FROMMAPVARIANT.Text = Master.MAPvariant & GRT00007WRKINC.MAPVR
    ...
    Protected Sub MAPrefelence(ByRef O_MSG As String, ByRef O_RTN As String)
        ...
        '■■■ 選択画面の入力初期値設定 ■■■
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007I Then       '条件画面からの画面遷移
        ...
        work.WF_T5I_XMLsaveF.Text = CS0050SESSION.UPLOAD_PATH & "\XML_TMP\" & Date.Now.ToString("yyyyMMdd") & "-" &
            CS0050SESSION.USERID & "-T00007-T5-" & Master.MAPvariant & "-" & Date.Now.ToString("HHmmss") & ".txt"
        work.WF_T5I_XMLsaveF9.Text = CS0050SESSION.UPLOAD_PATH & "\XML_TMP\" & Date.Now.ToString("yyyyMMdd") & "-" &
            CS0050SESSION.USERID & "-T00007-T59-" & Master.MAPvariant & "-" & Date.Now.ToString("HHmmss") & ".txt"
    End Sub
    ...
    Protected Sub SetInitCnt()
        ...
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_LNG1.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_CONT1.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_SANS1.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_CHIS1.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_SUIS1.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_META1.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_RATE1.Text)
        ...
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_LNG2.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_CONT2.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_SANS2.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_CHIS2.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_SUIS2.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_META2.Text)
        unlCnt = unlCnt - Convert.ToInt32(Me.WF_UNLOADCNT_RATE2.Text)
        ...
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_SANS1.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_CHIS1.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_SUIS1.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_META1.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_RATE1.Text)
        ...
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_SANS2.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_CHIS2.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_SUIS2.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_META2.Text)
        haiCnt = haiCnt - Convert.ToInt32(Me.WF_HAIDISTANCE_RATE2.Text)
