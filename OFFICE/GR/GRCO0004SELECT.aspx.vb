...
Public Class GRCO0004SELECT
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRCO0004WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MENU Then             'メニューからの画面遷移
            ...
            Master.getFirstValue(work.WF_SEL_CAMPCODE.Text, "ORG", WF_ORG.Text)                 '所属部署
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.CO0004 Then       '実行画面からの遷移
            '画面項目設定処理
            ...
            WF_ORG.Text = work.WF_SEL_ORG.Text                  '所属部署
        End If

        '○ RightBox情報設定
        rightview.MAPIDS = GRCO0004WRKINC.MAPIDS
        rightview.MAPID = GRCO0004WRKINC.MAPID
        ...
        CODENAME_get("ORG", WF_ORG.Text, WF_ORG_TEXT.Text, WW_DUMMY)                        '所属部署
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        Master.eraseCharToIgnore(WF_ORG.Text)               '所属部署
        ...
        End If
        work.WF_SEL_ORG.Text = WF_ORG.Text                  '所属部署
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        If isNormal(WW_CS0024FCHECKERR) Then
            ...
            Else
                ...
                If Not isNormal(WW_RTN_SW) Then
                    Master.output(C_MESSAGE_NO.NO_DATA_EXISTS_ERROR, C_MESSAGE_TYPE.ERR, "所属部署 : " & WF_ORG.Text)
                    WF_ORG.Focus()
                    O_RTN = "ERR"
                    Exit Sub
                End If
