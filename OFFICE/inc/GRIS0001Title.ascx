<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="GRIS0001Title.ascx.vb" Inherits="OFFICE.GRIS0001Title" %>
        ...
        <div class="titlebox" id="titlebox" runat="server">
            ...
            <img class="WF_rightboxSW" src="<%=ResolveUrl("~/透明R.png")%>" style="z-index:30" ondblclick="r_boxDisplay();" alt=""/>
        </div>