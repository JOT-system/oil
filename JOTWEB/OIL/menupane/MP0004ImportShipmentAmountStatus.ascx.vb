...
Public Class MP0004ImportShipmentAmountStatus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Catch ex As Exception
                ...
                Me.ddlImportShipmentAmountOffice.Enabled = False
                CS0011LOGWRITE.INFSUBCLASS = "MP0004ImportShipmentAmountStatus"                         'SUBクラス名
        ...
        Else
            ...
            Try
                If Me.hdnRefreshCall.Value = "1" Then
                    ...
                    Me.ddlImportShipmentAmountOffice.Enabled = True
                    '最新化処理
                    SetDisplayValues()
                End If
                '処理フラグを落とす
    ...
    Protected Sub Initialize()
        Me.lblPaneTitle.Text = String.Format("{0:M月d日} 出荷実績取込状況", Now)
        'MP0000Baseの共通処理の営業所抽出を呼出し営業所ドロップダウン生成
        Dim retDdl As DropDownList = Me.GetOfficeList()
        If retDdl.Items.Count > 0 Then
            Me.ddlImportShipmentAmountOffice.Items.AddRange(retDdl.Items.Cast(Of ListItem).ToArray)
            Me.ddlImportShipmentAmountOffice.SelectedIndex = retDdl.SelectedIndex
        End If
        SetDisplayValues()
    End Sub
    ''' <summary>
    ...
    Private Function GetBaseTrainList(sqlCon As SqlConnection) As List(Of LinkImportItem)
        ...
        Using sqlCmd As New SqlCommand(sqlStat.ToString, sqlCon)
            With sqlCmd.Parameters
                .Add("@OFFICECODE", SqlDbType.NVarChar).Value = Me.ddlImportShipmentAmountOffice.SelectedValue
    ...
    Private Sub SetDisplayValues()
        ...
        With Me.repImportShipmentAmountStatusItems
            .DataSource = dispList
            .DataBind()
        End With
