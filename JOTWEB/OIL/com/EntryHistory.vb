...
Public Class EntryHistory
    ...
    Public Shared Sub InsertOrderHistory(sqlCon As SqlConnection, sqlTran As SqlTransaction, drOrder As DataRow)
        ...
        sqlOrderStat.AppendLine("    CHANGERETSTATION,CHANGERETSTATIONNAME,ORDERSTATUS,ORDERINFO,EMPTYTURNFLG,STACKINGFLG,USEPROPRIETYFLG,DELIVERYFLG,")
    ...
    Public Shared Sub InsertOrderDetailHistory(sqlCon As SqlConnection, sqlTran As SqlTransaction, drOrder As DataRow)
        ...
        sqlDetailStat.AppendLine("   (HISTORYNO,MAPID,ORDERNO,DETAILNO,SHIPORDER,LINEORDER,TANKNO,KAMOKU,ORDERINFO,")
        sqlDetailStat.AppendLine("    SHIPPERSCODE,SHIPPERSNAME,OILCODE,OILNAME,")
        sqlDetailStat.AppendLine("    ORDERINGTYPE,ORDERINGOILNAME,")
