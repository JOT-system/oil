...
Public Class GRMC0006SELECT_R
    ...
    Protected Sub Initialize()
        ...
        '画面ID設定
        Master.MAPID = GRMC0006WRKINC.MAPIDS_R
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        End If
        work.WF_SEL_TORICODEF.Text = WF_TORICODEF.Text          '取引先
        If WF_TORICODET.Text = "" Then
            work.WF_SEL_TORICODET.Text = WF_TORICODEF.Text
        Else
                ...
                If WF_LeftMViewChange.Value <> LIST_BOX_CLASSIFICATION.LC_CALENDAR Then
                    ...
                    Select Case WF_FIELD.Value
                        ...
                        Case "WF_TODOKECODE"                        '届先コード
                            prmData = work.createTODOKEParam(WF_CAMPCODE.Text, WF_TORICODEF.Text)
    ...
    Protected Sub WW_LeftBoxReSet()
        ...
        leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_DISTINATION, WF_TODOKECODE.Text, WF_TODOKECODE_Text.Text, WW_DUMMY, work.createTODOKEParam(WF_CAMPCODE.Text, WF_TORICODEF.Text))         '届先コード
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MC0006_R Then       '実行画面からの画面遷移
            '○画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPID = GRMC0006WRKINC.MAPID_R
        rightview.MAPIDS = GRMC0006WRKINC.MAPIDS_R
        rightview.COMPCODE = WF_CAMPCODE.Text
        rightview.MAPVARI = Master.MAPvariant
        rightview.PROFID = Master.PROF_VIEW
        rightview.Initialize("届先照会", WW_ERR_SW)
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        If isNormal(WW_CS0024FCHECKERR) Then
            ...
            If WW_TEXT = "" Then
                WF_TODOKECODE.Text = ""
            Else
                leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_DISTINATION, WF_TODOKECODE.Text, WF_TODOKECODE_Text.Text, WW_RTN_SW, work.createTODOKEParam(WF_CAMPCODE.Text, WF_TORICODEF.Text))
                If Not isNormal(WW_RTN_SW) Then
                    Master.output(C_MESSAGE_NO.INVALID_SELECTION_DATA, C_MESSAGE_TYPE.ERR)
                    WF_TODOKECODE.Focus()
                    O_RTN = "ERR"
