...
Public Class GRMB0007WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "MB0007S"       'MAPID(条件)
    Public Const MAPID As String = "MB0007"         'MAPID(実行)
    ...
    Public Function CreateStaffCodeParam(ByVal I_COMPCODE As String) As Hashtable
        ...
        Dim prmData As New Hashtable
        prmData.Item(C_PARAMETERS.LP_COMPANY) = I_COMPCODE
        prmData.Item(C_PARAMETERS.LP_TYPEMODE) = GL0005StaffList.LC_STAFF_TYPE.EMPLOY_ALL
