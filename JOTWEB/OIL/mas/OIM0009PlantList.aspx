<%@ Page Title="OIM0009L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0009PlantList.aspx.vb" Inherits="JOTWEB.OIM0009PlantList" %>
...
<asp:Content ID="OIM0009LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0009L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0009L.js")%>'></script>
...
<asp:Content ID="OIM0009L" ContentPlaceHolderID="contents1" runat="server">
