...
Public Class OIM0013WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "OIM0013S"       'MAPID(条件)
    Public Const MAPIDL As String = "OIM0013L"       'MAPID(実行)
    Public Const MAPIDC As String = "OIM0013C"       'MAPID(更新)
