<%@ Page Title="OIM0002L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0002OrgList.aspx.vb" Inherits="JOTWEB.OIM0002OrgList" %>
...
<asp:Content ID="OIM0002LH" ContentPlaceHolderID="head" runat="server">
    <%--<link href='<%=ResolveUrl("~/OIL/css/OIM0002L.css")%>' rel="stylesheet" type="text/css" />--%>
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0002L.js")%>'></script>
...
<asp:Content ID="OIM0002L" ContentPlaceHolderID="contents1" runat="server">
