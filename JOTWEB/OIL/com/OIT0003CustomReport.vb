...
Public Class OIT0003CustomReport : Implements IDisposable
    ...
    Public Sub New(mapId As String, excelFileName As String, printDataClass As DataTable)
        ...
        Me.ExcelWorkSheet = DirectCast(Me.ExcelWorkSheets("出荷予定"), Excel.Worksheet)
    ...
    Private Sub EditHeaderArea()
        ...
        Try
            For Each PrintDatarow As DataRow In PrintData.Rows
                '◯ 西暦(YYYY)
                rngTitleArea = Me.ExcelWorkSheet.Range("D3")
                'rngTitleArea.Value = PrintDatarow("XXXXX")
                '◯ 月(MM)
                rngTitleArea = Me.ExcelWorkSheet.Range("F3")
                'rngTitleArea.Value = PrintDatarow("XXXXX")
                '◯ 日(DD)
                rngTitleArea = Me.ExcelWorkSheet.Range("H3")
                'rngTitleArea.Value = PrintDatarow("XXXXX")
    ...
    Private Sub EditDetailArea()
        ...
        Try
            ...
            For Each PrintDatarow As DataRow In PrintData.Rows
                ...
                'rngDetailArea.Value = PrintDatarow("XXXXX")
                '◯ 着駅(名称)
                ...
                'rngDetailArea.Value = PrintDatarow("XXXXX")
                '◯ 油種(計)
                rngDetailArea = Me.ExcelWorkSheet.Range("X" + i.ToString())
                'rngDetailArea.Value = PrintDatarow("XXXXX")
