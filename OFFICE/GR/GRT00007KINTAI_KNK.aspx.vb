...
''' </summary>
''' <remarks></remarks>
Public Class GRT00007KINTAI_KNK
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC.MAPIDKNK
        ...
        '○ 右ボックスへの値設定
        rightview.MAPID = GRT00007WRKINC.MAPIDKNK
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC.MAPIDKNK
    ...
    Private Sub NIPPO_Screen()
        ...
        If T0005tbl.Rows.Count > 0 Then
            ...
            '呼出元MAPID　
            work.WF_T5_FROMMAPID.Text = GRT00007WRKINC.MAPIDKNK
            '画面一覧保存パス
            ...
            '呼出元VARIANT
            work.WF_T5_FROMMAPVARIANT.Text = Master.MAPvariant & GRT00007WRKINC.MAPVRKNK
