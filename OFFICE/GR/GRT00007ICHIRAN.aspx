<%@ Page Title="T00007I" Language="vb" AutoEventWireup="false" CodeBehind="GRT00007ICHIRAN.aspx.vb" Inherits="OFFICE.GRT00007ICHIRAN" %>
...
<asp:Content ID="T00007H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00007I.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00007I.js")%>'></script>
