...
Public Class OIM0019WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "OIM0019S"       'MAPID(条件)
    Public Const MAPIDL As String = "OIM0019L"       'MAPID(実行)
    Public Const MAPIDC As String = "OIM0019C"       'MAPID(更新)
