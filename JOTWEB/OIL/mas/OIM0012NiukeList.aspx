<%@ Page Title="OIM0012L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0012NiukeList.aspx.vb" Inherits="JOTWEB.OIM0012NiukeList" %>
...
<asp:Content ID="OIM0012LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0012L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0012L.js")%>'></script>
...
<asp:Content ID="OIM0012L" ContentPlaceHolderID="contents1" runat="server">
