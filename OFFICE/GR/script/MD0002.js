...
function ChangeOrgUse() {
    ...
    for (var i = 0; i < objTable.rows.length; i++) {
        ...
        if (document.getElementById("lrblORGUSEORGUSE" + (i + 1)).innerText == "01") {
            ...
            ChangeDisabled(document.getElementById("txtpnlListAreaHTANI" + (i + 1)), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaYPRODUCT" + (i + 1)), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaKPRODUCT" + (i + 1)), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaJSRPRODUCT" + (i + 1)), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaUNLOADADDTANKA" + (i + 1)), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaLOADINGTANKA" + (i + 1)), false);
            ...
            ChangeDisabled(document.getElementById("txtpnlListAreaHTANI" + (i + 1)), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaYPRODUCT" + (i + 1)), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaKPRODUCT" + (i + 1)), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaJSRPRODUCT" + (i + 1)), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaUNLOADADDTANKA" + (i + 1)), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaLOADINGTANKA" + (i + 1)), true);
...
function selectUse(obj, Line, fieldNM) {
    if (document.getElementById("MF_SUBMIT").value == "FALSE") {
        if (document.getElementById("rblORGUSEORGUSE" + Line + "_0").checked) {
            document.getElementById("lrblORGUSEORGUSE" + Line).innerText = "01";
            ChangeDisabled(document.getElementById("txtpnlListAreaHTANI" + Line), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaYPRODUCT" + Line), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaKPRODUCT" + Line), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaJSRPRODUCT" + Line), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaUNLOADADDTANKA" + Line), false);
            ChangeDisabled(document.getElementById("txtpnlListAreaLOADINGTANKA" + Line), false);
            ...
            document.getElementById("lrblORGUSEORGUSE" + Line).innerText = "02";
            ChangeDisabled(document.getElementById("txtpnlListAreaHTANI" + Line), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaYPRODUCT" + Line), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaKPRODUCT" + Line), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaJSRPRODUCT" + Line), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaUNLOADADDTANKA" + Line), true);
            ChangeDisabled(document.getElementById("txtpnlListAreaLOADINGTANKA" + Line), true);
...
function f_onchnage(obj, Line, fieldNM) {
    ...
    xhr.open("POST", "../GR/GRMD0002AJAX.ashx", true)
