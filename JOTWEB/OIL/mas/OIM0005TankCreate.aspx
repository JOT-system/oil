        ...
        <div class="detailboxOnly" id="detailbox">
            ...
            <div id="detailkeybox">
                ...
                <p id="KEY_LINE_2">
                    ...
                    <!-- 削除理由区分 -->
                    <span class="ef">
                        <asp:Label ID="WF_DELREASONKBN_L" runat="server" Text="削除理由区分" CssClass="WF_TEXT_LABEL requiredMark"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_DELREASONKBN', <%=LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_DELREASONKBN');">
                            <asp:TextBox ID="WF_DELREASONKBN" runat="server" ReadOnly="true" CssClass="WF_TEXTBOX_CSS boxIcon iconOnly" MaxLength="1"></asp:TextBox>
                        </span>
                        <asp:Label ID="WF_DELREASONKBN_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
                </p>
                ...
                <p id="KEY_LINE_10">
                    ...
                    <span class="ef">
                        ...
                        <span ondblclick="Field_DBclick('WF_OWNERCODE', <%=LIST_BOX_CLASSIFICATION.LC_ORIGINOWNERCODE%>);" onchange="TextBox_change('WF_OWNERCODE');">
                ...
                <p id="KEY_LINE_11">
                    ...
                    <span class="ef">
                        ...
                        <span class="ef" ondblclick="Field_DBclick('WF_LEASECODE', <%=LIST_BOX_CLASSIFICATION.LC_COMPANY%>);" onchange="TextBox_change('WF_LEASECODE');">
                    ...
                    <!-- 請負リース区分C -->
                    <span class="ef">
                        <asp:Label ID="WF_LEASECLASS_L" runat="server" Text="請負リース区分C" CssClass="WF_TEXT_LABEL"></asp:Label>
                ...
                <p id="KEY_LINE_19">
                    ...
                    <!-- 油種中分類コード -->
                    <span class="ef">
                        <asp:Label ID="WF_MIDDLEOILCODE_L" runat="server" Text="油種中分類コード" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_MIDDLEOILCODE', <%=LIST_BOX_CLASSIFICATION.LC_MIDDLEOILCODE%>);" onchange="TextBox_change('WF_MIDDLEOILCODE');">
                ...
                <p id="KEY_LINE_20">
                    ...
                    <!-- 運用基地C（サブ） -->
                    <span class="ef">
                        <asp:Label ID="WF_SUBOPERATIONBASECODE_L" runat="server" Text="運用基地C（サブ）"  CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_SUBOPERATIONBASECODE', <%=LIST_BOX_CLASSIFICATION.LC_BASE%>);" onchange="TextBox_change('WF_SUBOPERATIONBASECODE');">
                            <asp:TextBox ID="WF_SUBOPERATIONBASECODE" runat="server"  CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="20"></asp:TextBox>
                        </span>
                        <asp:Label ID="WF_SUBOPERATIONBASECODE_TEXT" runat="server"  CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
                </p>
                ...
                <p id="KEY_LINE_21.1">
                    <!-- 内部塗装 -->
                    <span class="ef">
                        <asp:Label ID="WF_INTERNALCOATING_L" runat="server" Text="内部塗装"  CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_INTERNALCOATING', <%=LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>);" onchange="TextBox_change('WF_INTERNALCOATING');">
                            <asp:TextBox ID="WF_INTERNALCOATING" runat="server"  CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="1"></asp:TextBox>
                        </span>
                        <asp:Label ID="WF_INTERNALCOATING_TEXT" runat="server"  CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
                </p>
                ...
                <p id="KEY_LINE_33">
                    ...
                    <span class="ef">
                        ...
                        <span ondblclick="Field_DBclick('WF_JRTANKTYPE', <%=LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>);" onchange="TextBox_change('WF_JRTANKTYPE');">
                            <asp:TextBox ID="WF_JRTANKTYPE" runat="server" CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="20"></asp:TextBox>
                        </span>
                ...
                <p id="KEY_LINE_40">
                    <!-- 中間点検年月 -->
                    <span class="ef">
                        <asp:Label ID="WF_INTERINSPECTYM_L" runat="server" Text="中間点検年月" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_INTERINSPECTYM', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                            <asp:TextBox ID="WF_INTERINSPECTYM" runat="server" CssClass="WF_TEXTBOX_CSS calendarIcon" MaxLength="0"></asp:TextBox>
                        </span>
                    </span>
                </p>
                ...
                <p id="KEY_LINE_41">
                    <!-- 中間点検場所 -->
                    <span class="ef">
                        <asp:Label ID="WF_INTERINSPECTSTATION_L" runat="server" Text="中間点検場所" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_INTERINSPECTSTATION', <%=LIST_BOX_CLASSIFICATION.LC_STATIONCODE_FOCUSON%>);" onchange="TextBox_change('WF_INTERINSPECTSTATION');">
                            <asp:TextBox ID="WF_INTERINSPECTSTATION" runat="server" CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="7"></asp:TextBox>
                        </span>
                        <asp:Label ID="WF_INTERINSPECTSTATION_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
                    
                    <!-- 中間点検実施者 -->
                    <span class="ef">
                        <asp:Label ID="WF_INTERINSPECTORGCODE_L" runat="server" Text="中間点検実施者" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_INTERINSPECTORGCODE', <%=LIST_BOX_CLASSIFICATION.LC_ORG%>);" onchange="TextBox_change('WF_INTERINSPECTORGCODE');">
                            <asp:TextBox ID="WF_INTERINSPECTORGCODE" runat="server" CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="6"></asp:TextBox>
                        </span>
                        <asp:Label ID="WF_INTERINSPECTORGCODE_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
                </p>
                ...
                <p id="KEY_LINE_42">
                    <!-- 自主点検年月 -->
                    <span class="ef">
                        <asp:Label ID="WF_SELFINSPECTYM_L" runat="server" Text="自主点検年月" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_SELFINSPECTYM', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                            <asp:TextBox ID="WF_SELFINSPECTYM" runat="server" CssClass="WF_TEXTBOX_CSS calendarIcon" MaxLength="0"></asp:TextBox>
                        </span>
                    </span>
                </p>
                ...
                <p id="KEY_LINE_43">
                    <!-- 自主点検場所 -->
                    <span class="ef">
                        <asp:Label ID="WF_SELFINSPECTSTATION_L" runat="server" Text="自主点検場所" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_SELFINSPECTSTATION', <%=LIST_BOX_CLASSIFICATION.LC_STATIONCODE_FOCUSON%>);" onchange="TextBox_change('WF_SELFINSPECTSTATION');">
                            <asp:TextBox ID="WF_SELFINSPECTSTATION" runat="server" CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="7"></asp:TextBox>
                        </span>
                        <asp:Label ID="WF_SELFINSPECTSTATION_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
                    
                    <!-- 自主点検実施者 -->
                    <span class="ef">
                        <asp:Label ID="WF_SELFINSPECTORGCODE_L" runat="server" Text="自主点検実施者" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_SELFINSPECTORGCODE', <%=LIST_BOX_CLASSIFICATION.LC_ORG%>);" onchange="TextBox_change('WF_SELFINSPECTORGCODE');">
                            <asp:TextBox ID="WF_SELFINSPECTORGCODE" runat="server" CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="6"></asp:TextBox>
                        </span>
                ...
                <p id="KEY_LINE_45">
                    <!-- 休車フラグ -->
                    <span class="ef">
                        <asp:Label ID="WF_SUSPENDFLG_L" runat="server" Text="休車フラグ" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_SUSPENDFLG', <%=LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>);" onchange="TextBox_change('WF_SUSPENDFLG');">
                            <asp:TextBox ID="WF_SUSPENDFLG" runat="server" CssClass="WF_TEXTBOX_CSS boxIcon" MaxLength="1"></asp:TextBox>
                        </span>
                        <asp:Label ID="WF_SUSPENDFLG_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>

                    <!-- 休車日 -->
                    <span class="ef">
                        <asp:Label ID="WF_SUSPENDDATE_L" runat="server" Text="休車日" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <span ondblclick="Field_DBclick('WF_SUSPENDDATE', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                            <asp:TextBox ID="WF_SUSPENDDATE" runat="server" CssClass="WF_TEXTBOX_CSS calendarIcon" MaxLength="0"></asp:TextBox>
                        </span>
                    </span>
                </p>
                ...
                <p id="KEY_LINE_46">
                    <!-- 安全弁 -->
                    <span class="ef">
                        <asp:Label ID="WF_SAFETYVALVE_L" runat="server" Text="安全弁" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <asp:TextBox ID="WF_SAFETYVALVE" runat="server" CssClass="WF_TEXTBOX_CSS" MaxLength="20"></asp:TextBox>
                        <asp:Label ID="WF_SAFETYVALVE_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>

                    <!-- センターバルブ情報 -->
                    <span class="ef">
                        <asp:Label ID="WF_CENTERVALVEINFO_L" runat="server" Text="センターバルブ情報" CssClass="WF_TEXT_LABEL"></asp:Label>
                        <asp:TextBox ID="WF_CENTERVALVEINFO" runat="server" CssClass="WF_TEXTBOX_CSS" MaxLength="20"></asp:TextBox>
                        <asp:Label ID="WF_CENTERVALVEINFO_TEXT" runat="server" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                    </span>
                </p>
            </div>
        </div>
