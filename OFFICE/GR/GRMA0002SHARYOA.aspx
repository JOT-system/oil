<%@ Page Title="MA0002" Language="vb" AutoEventWireup="false" CodeBehind="GRMA0002SHARYOA.aspx.vb" Inherits="OFFICE.GRMA0002SHARYOA" %>
...
<%@ register src="inc/GRMA0002WRKINC.ascx" tagname="work" tagprefix="LSINC" %>

<asp:Content ID="GRMA0002H" ContentPlaceHolderID="head" runat="server">
 
 
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MA0002.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
        <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MA0002.js")%>"></script>
</asp:Content> 
<asp:Content ID="GRMA0002" ContentPlaceHolderID="contents1" runat="server">
            ...
            <div id="detailkeybox">
                ...
                <p id="KEY_LINE_3">
                    ...
                    <a>
                        ...
                        <b  onchange="PDFselectChange()" ondblclick="Field_DBclick('WF_STYMD', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                        ...
                        <b  onchange="PDFselectChange()" ondblclick="Field_DBclick('WF_ENDYMD', <%=LIST_BOX_CLASSIFICATION.LC_CALENDAR%>)">
                ...
                <p id="KEY_LINE_4">
                    ...
                    <a  onclick="DtabChange('10')">
                        <asp:Label ID="WF_Dtab11" runat="server" Text="申請書類（PDF）" Height="1.3em" Width="7.8em" CssClass="WF_Dtab" Font-Size="small"></asp:Label>
                    </a>
                </p>
            </div>
                ...
                <asp:View ID="WF_DView11" runat="server">
                    ...
                    <span class="WF_DViewRep11_Area">
                        ...
                        <span style="position:relative;top:0.5em;left:0.5em;" onchange="PDFselectChange()">
                            <asp:ListBox ID="WF_Rep11_PDFselect" runat="server" Height="1.4em" Width="15em" rows="1" CssClass="WF_ListBoxPDF"></asp:ListBox>
                        </span>
                        <br />
        ...
        <div hidden="hidden">
                ...
                <asp:ListBox ID="WF_ListBoxMANGOILTYPEALL" runat="server" ></asp:ListBox> <!-- ListBox油種（全て） -->
