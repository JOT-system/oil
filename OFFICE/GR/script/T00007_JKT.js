...
function TTL_SUM() {
    ...
    if (document.getElementById('WF_UNLOADCNT_TAIYO1').value !== "" && isFinite(document.getElementById('WF_UNLOADCNT_TAIYO1').value)){
        unloadSum = unloadSum + eval(document.getElementById('WF_UNLOADCNT_TAIYO1').value);
    }
    if (document.getElementById('WF_UNLOADCNT_INF1').value !== "" && isFinite(document.getElementById('WF_UNLOADCNT_INF1').value)) {
        unloadSum = unloadSum + eval(document.getElementById('WF_UNLOADCNT_INF1').value);
    }
    ...
    if (document.getElementById('WF_UNLOADCNT_TAIYO2').value !== "" && isFinite(document.getElementById('WF_UNLOADCNT_TAIYO2').value)) {
        unloadSum = unloadSum + eval(document.getElementById('WF_UNLOADCNT_TAIYO2').value);
    }
    if (document.getElementById('WF_UNLOADCNT_INF2').value !== "" && isFinite(document.getElementById('WF_UNLOADCNT_INF2').value)) {
        unloadSum = unloadSum + eval(document.getElementById('WF_UNLOADCNT_INF2').value);
    }
    ...
    if (document.getElementById('WF_HAIDISTANCE_TAIYO1').value !== "" && isFinite(document.getElementById('WF_HAIDISTANCE_TAIYO1').value)) {
        haidisSum = haidisSum + eval(document.getElementById('WF_HAIDISTANCE_TAIYO1').value);
    }
    if (document.getElementById('WF_HAIDISTANCE_INF1').value !== "" && isFinite(document.getElementById('WF_HAIDISTANCE_INF1').value)) {
        haidisSum = haidisSum + eval(document.getElementById('WF_HAIDISTANCE_INF1').value);
    }
    ...
    if (document.getElementById('WF_HAIDISTANCE_TAIYO2').value !== "" && isFinite(document.getElementById('WF_HAIDISTANCE_TAIYO2').value)) {
        haidisSum = haidisSum + eval(document.getElementById('WF_HAIDISTANCE_TAIYO2').value);
    }
    if (document.getElementById('WF_HAIDISTANCE_INF2').value !== "" && isFinite(document.getElementById('WF_HAIDISTANCE_INF2').value)) {
        haidisSum = haidisSum + eval(document.getElementById('WF_HAIDISTANCE_INF2').value);
    }
