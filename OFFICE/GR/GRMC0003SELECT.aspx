<%@ Page Title="MC0003S" Language="vb" AutoEventWireup="false" CodeBehind="GRMC0003SELECT.aspx.vb" Inherits="OFFICE.GRMC0003SELECT" %>
...
<asp:Content ID="MC0003SH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MC0003S.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MC0003S.js")%>'></script>
</asp:Content>
<asp:Content ID="MC0003S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
