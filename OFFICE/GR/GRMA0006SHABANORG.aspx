<%@ Page Title="MA0006" Language="vb" AutoEventWireup="false" CodeBehind="GRMA0006SHABANORG.aspx.vb" Inherits="OFFICE.GRMA0006SHABANORG" %>
...
<%@ Register Src="~/GR/inc/GRMA0006WRKINC.ascx" TagName="wrklist" TagPrefix="MSINC" %>

<asp:Content ID="MA0006H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MA0006.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MA0006.js")%>'></script>
...
<asp:Content ID="MA0006" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　headerbox -->
    <div class="headerbox" id="headerbox">
        <div class="Operation">
            <!-- 運用部署 -->
            <a>
                <asp:Label ID="WF_UORG_L" runat="server" Text="運用部署" Height="1.5em" Width="5em" Font-Bold="true"></asp:Label>
            </a>
            <a>
                <asp:Label ID="WF_UORG" runat="server" Height="1.1em" Width="5em"></asp:Label>
            </a>
            <a>
