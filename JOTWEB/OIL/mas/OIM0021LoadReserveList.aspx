<%@ Page Title="OIM0021L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0021LoadReserveList.aspx.vb" Inherits="JOTWEB.OIM0021LoadReserveList" %>
...
<asp:Content ID="OIM0021LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0021L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0021L.js")%>'></script>
...
<asp:Content ID="OIM0021L" ContentPlaceHolderID="contents1" runat="server">
