<%@ Page Title="T00011S" Language="vb" AutoEventWireup="false" CodeBehind="GRT00011SELECT.aspx.vb" Inherits="OFFICE.GRT00011SELECT" %>
...
<asp:Content ID="T00011SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/T00011S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/T00011S.js")%>"></script>
</asp:Content>
<asp:Content ID="T00011S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　searchbox -->
