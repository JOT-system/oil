...
Public Class OIM0017WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "OIM0017S"       'MAPID(条件)
    Public Const MAPIDL As String = "OIM0017L"       'MAPID(実行)
    Public Const MAPIDC As String = "OIM0017C"       'MAPID(更新)
