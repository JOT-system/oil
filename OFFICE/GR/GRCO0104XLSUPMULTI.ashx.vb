...
''' </summary>
''' <remarks></remarks>
Public Class GRCO0104XLSUPMULTI
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            '　アップロードFILE格納フォルダ存在確認＆作成(C:\apple\files\UPLOAD_TMP\端末名)
        ...
        For i As Integer = 0 To context.Request.Files.Count - 1
            ...
            If WW_Extension = "XLS" OrElse _
               WW_Extension = "XLSX" OrElse _
               WW_Extension = "XLSM" OrElse _
