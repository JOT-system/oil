...
Public Class GRMC0007SELECT
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRMC0007WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MC0007 Then       '実行画面からの遷移
            '画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = GRMC0007WRKINC.MAPIDS
        rightview.MAPID = GRMC0007WRKINC.MAPID
        ...
        CODENAME_get("TORICODE", WF_TORICODE.Text, WF_TORICODE_TEXT.Text, WW_DUMMY)         '取引先
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        If isNormal(WW_CS0024FCHECKERR) Then
            ...
            If Not isNormal(WW_RTN_SW) Then
                Master.output(C_MESSAGE_NO.NO_DATA_EXISTS_ERROR, C_MESSAGE_TYPE.ERR, "取引先コード : " & WF_TORICODE.Text)
                WF_TORICODE.Focus()
                O_RTN = "ERR"
                Exit Sub
            End If
