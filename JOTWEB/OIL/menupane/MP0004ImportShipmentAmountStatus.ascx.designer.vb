...
Partial Public Class MP0004ImportShipmentAmountStatus
    ...
    '''<summary>
    '''ddlImportShipmentAmountOffice コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents ddlImportShipmentAmountOffice As Global.System.Web.UI.WebControls.DropDownList
    
    '''<summary>
    '''repImportShipmentAmountStatusItems コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
