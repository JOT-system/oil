<%@ Page Title="MD0002S" Language="vb" AutoEventWireup="false" CodeBehind="GRMD0002SELECT.aspx.vb" Inherits="OFFICE.GRMD0002SELECT" %>
...
<asp:Content ID="MD0002SH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MD0002S.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MD0002S.js")%>'></script>
</asp:Content>

<asp:Content ID="MD0002S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
