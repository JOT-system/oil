...
Public Class OIT0001EmptyTurnDairyDetail
    ...
    Protected Sub MAPDataGet(ByVal SQLcon As SqlConnection, ByVal O_INSCNT As Integer)
        ...
        Try
            Using SQLcmd As New SqlCommand(SQLStr, SQLcon), SQLcmdNum As New SqlCommand(SQLStrNum, SQLcon)
                ...
                Dim PARA1 As SqlParameter = SQLcmd.Parameters.Add("@P1", SqlDbType.NVarChar)     '受注№
    ...
    Protected Sub WF_CheckBoxSELECT_Click(ByVal chkFieldName As String)
        ...
        Select Case chkFieldName
            Case "WF_CheckBoxSELECTSTACKING"
                ...
                For i As Integer = 0 To OIT0001tbl.Rows.Count - 1
                    If Convert.ToString(OIT0001tbl.Rows(i)("LINECNT")) = WF_SelectedIndex.Value Then
                        If Convert.ToString(OIT0001tbl.Rows(i)("STACKINGFLG")) = "on" Then
            ...
            Case "WF_CheckBoxSELECTWHOLESALE"
                ...
                For i As Integer = 0 To OIT0001tbl.Rows.Count - 1
                    If Convert.ToString(OIT0001tbl.Rows(i)("LINECNT")) = WF_SelectedIndex.Value Then
                        If Convert.ToString(OIT0001tbl.Rows(i)("WHOLESALEFLG")) = "on" Then
            ...
            Case "WF_CheckBoxSELECTDETENTION"
                ...
                For i As Integer = 0 To OIT0001tbl.Rows.Count - 1
                    If Convert.ToString(OIT0001tbl.Rows(i)("LINECNT")) = WF_SelectedIndex.Value Then
                        If Convert.ToString(OIT0001tbl.Rows(i)("DETENTIONFLG")) = "on" Then
            ...
            Case "WF_CheckBoxSELECTUPGRADE"
                ...
                For Each OIT0001Drow As DataRow In OIT0001tbl.Rows
                    If Convert.ToString(OIT0001Drow("LINECNT")) = WF_SelectedIndex.Value Then
                        If Convert.ToString(OIT0001Drow("UPGRADEFLG")) = "on" Then
                    ...
                    Try
                        ...
                        Else
                            ...
                            Else
                                ...
                                Master.SaveTable(OIT0001tbl)
                                'タンク車マスタの交検日を更新
                                WW_UpdateTankMaster(Convert.ToString(updHeader.Item("TANKNO")), I_JRINSPECTIONDATE:=Convert.ToString(updHeader.Item(WF_FIELD.Value)))
                                'タンク車№に紐づく情報を取得・設定
        ...
        Try
            ...
            For Each OIT0001UPDrow As DataRow In OIT0001tbl.Rows
                If Convert.ToString(OIT0001UPDrow("OPERATION")) = "on" Then
                    ...
                    If CInt(OIT0001UPDrow("LINECNT")) < 9000 Then
                        SelectChk = True
                    End If
                    ...
                    If Convert.ToString(OIT0001UPDrow("TANKNO")) <> "" Then
                        '★タンク車所在の更新(タンク車№を再度選択できるようにするため)
                        '引数１：所在地コード　⇒　変更なし(空白)
                        '引数２：タンク車状態　⇒　変更あり("3"(到着))
                        '引数３：積車区分　　　⇒　変更なし(空白)
                        '引数４：タンク車状況　⇒　変更あり("1"(残車))
                        WW_UpdateTankShozai("", "3", "", I_TANKNO:=Convert.ToString(OIT0001UPDrow("TANKNO")), I_SITUATION:="1",
                                            I_ORDERNO:=Convert.ToString(OIT0001UPDrow("ORDERNO")), I_AEMPARRDATE:="", upActualEmparrDate:=True)
                    End If
    ...
    Protected Sub WF_ButtonLINE_ADD_Click()
        ...
        Try
            Using SQLcmd As New SqlCommand(SQLStr, SQLcon), SQLcmdNum As New SqlCommand(SQLStrNum, SQLcon)
                Dim PARANUM1 As SqlParameter = SQLcmdNum.Parameters.Add("@P01", SqlDbType.NVarChar) '受注№
                ...
                Dim PARA1 As SqlParameter = SQLcmd.Parameters.Add("@P01", SqlDbType.NVarChar)     '受注№
...
#Region "帳票処理"
    ...
    Protected Sub ExcelDataGet(ByVal SQLcon As SqlConnection, ByRef O_officeCode As String)
        ...
        '○ 取得SQL
        '　 説明　：　帳票表示用SQL
        Dim SQLStr As String = RSSQL.EmptyTurnDairy("OIT0001")
...
#End Region
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        For Each OIT0001row As DataRow In OIT0001tbl.Rows
            ...
            '(一覧)受注油種(空白チェック)
            If Convert.ToString(OIT0001row("ORDERINGOILNAME")) = "" And Convert.ToString(OIT0001row("DELFLG")) = "0" Then
            ...
            '### 20200925 START((全体)No152対応) #####################################
            '(一覧)タンク車交検日チェック
            If Convert.ToString(OIT0001row("JRINSPECTIONALERTSTR")) = C_INSPECTIONALERT.ALERT_RED _
                AndAlso Convert.ToString(OIT0001row("DELFLG")) = "0" Then
            ...
            If Convert.ToString(OIT0001row("ORDERINFO")) = BaseDllConst.CONST_ORDERINFO_ALERT_102 _
                ...
                Exit Sub
            End If
            '### 20200915 END  ((全体)No139対応) ######################################

            '### 20200831 START タンク車の所在地コード確認 ###########################
            '★指定したタンク車№が所在地以外の場合
            If Convert.ToString(OIT0001row("ORDERINFO")) = BaseDllConst.CONST_ORDERINFO_ALERT_101 _
                AndAlso Convert.ToString(OIT0001row("DELFLG")) = "0" Then
    ...
    Protected Sub WW_CheckValidityDate(ByRef O_RTN As String)
        ...
        '(一覧)積込日 と　(予定)発日を比較
        For Each OIT0001row As DataRow In OIT0001tbl.Rows
            If Convert.ToString(OIT0001row("ACTUALLODDATE")) = "" Then Continue For
    ...
    Protected Sub WW_CheckLastOilConsistency(ByRef O_RTN As String)
        ...
        For Each OIT0001row As DataRow In OIT0001tbl.Rows
            ...
            ElseIf WW_GetValue(2) = "2" AndAlso Convert.ToString(OIT0001row("DELFLG")) = "0" Then
                ...
                If O_RTN <> "ERR1" Then
                    If Convert.ToString(OIT0001row("UPGRADEFLG")) = "on" AndAlso O_RTN <> "ERR3" Then
                        O_RTN = "ERR2"
                    Else
                        O_RTN = "ERR3"
                        WW_ChkUpGrad = True
            ...
            ElseIf WW_GetValue(2) = "3" AndAlso Convert.ToString(OIT0001row("DELFLG")) = "0" Then
                ...
                End If
            Else
                If Convert.ToString(OIT0001row("ORDERINFO")) = BaseDllConst.CONST_ORDERINFO_ALERT_99 _
                    OrElse Convert.ToString(OIT0001row("ORDERINFO")) = BaseDllConst.CONST_ORDERINFO_ALERT_98 Then
                    OIT0001row("ORDERINFO") = ""
                    OIT0001row("ORDERINFONAME") = ""
                End If
            End If
    ...
    Protected Sub WW_CheckTankStatus(ByRef O_RTN As String)
        ...
        For Each OIT0001row As DataRow In OIT0001tbl.Rows
            ...
            If Convert.ToString(OIT0001row("TANKNO")) <> "" AndAlso Convert.ToString(OIT0001row("DELFLG")) = "0" AndAlso Convert.ToString(OIT0001row("TANKSTATUS")) = "" Then
                'タンク車情報を取得
                WW_FixvalueMasterSearch("01", "TANKNUMBER", Convert.ToString(OIT0001row("TANKNO")), WW_GetValue)
    ...
    Protected Sub WW_CheckTrainRepeat(ByRef O_RTN As String, ByVal SQLcon As SqlConnection)
        ...
        Try
            Using SQLcmd As New SqlCommand(SQLStr, SQLcon), SQLDiffTraincmd As New SqlCommand(SQLDiffTrainStr, SQLcon)
                ...
                '### 20200620 START((全体)No79対応) ######################################
                Dim PARADF1 As SqlParameter = SQLDiffTraincmd.Parameters.Add("@P01", SqlDbType.NVarChar)     '受注№
    ...
    Protected Sub WW_CheckTrainTankRepeat(ByRef O_RTN As String, ByVal SQLcon As SqlConnection)
        ...
        Try
            Using SQLcmd As New SqlCommand(SQLStr, SQLcon),
                ...
                '### 20200620 START((全体)No79対応)異なる列車で同一発日の場合#############
                Dim PARADF1 As SqlParameter = SQLDiffDEPTraincmd.Parameters.Add("@P01", SqlDbType.NVarChar)     '受注№
                ...
                '### 20200620 START((全体)No79対応)異なる列車で同一積込日の場合###########
                Dim PARALDF1 As SqlParameter = SQLDiffLODTraincmd.Parameters.Add("@P01", SqlDbType.NVarChar)     '受注№
                ...
                '### 20200805 START((全体)No117対応)異なる列車で同一積込日の場合###########
                Dim PARALSM1 As SqlParameter = SQLSameLODTraincmd.Parameters.Add("@P01", SqlDbType.NVarChar)     '受注№
    ...
    Protected Sub WW_CheckTankNoLodDateRepeat(ByRef O_RTN As String,
        ...
        Try
            Using SQLLODcmd As New SqlCommand(SQLLODStr, SQLcon),
                ...
                Dim PARALOD5 As SqlParameter = SQLLODcmd.Parameters.Add("@P05", SqlDbType.NVarChar)     '受注No
                ...
                Dim PARADEP5 As SqlParameter = SQLDEPcmd.Parameters.Add("@P05", SqlDbType.NVarChar)     '受注No
    ...
    Protected Sub WW_ScreenEnabledSet()
        ...
        If Me.TxtHeadOfficeTrainName.Text = "" OrElse work.WF_SEL_STATUS.Text >= BaseDllConst.CONST_ORDERSTATUS_320 Then
            '★(予定)日付を非活性にする。
            Me.TxtLoadingDate.Enabled = False
            Me.TxtDepDate.Enabled = False
            Me.TxtArrDate.Enabled = False
    ...
    Protected Sub WW_UpdateOrder(ByVal SQLcon As SqlConnection)
        ...
        Try
            Using SQLcmd As New SqlCommand(SQLStr, SQLcon), SQLcmdJnl As New SqlCommand(SQLJnl, SQLcon)
                ...
                Dim PARA76 As SqlParameter = SQLcmd.Parameters.Add("@P76", SqlDbType.NVarChar)     '貨車連結順序表№
                ...
                Dim JPARA01 As SqlParameter = SQLcmdJnl.Parameters.Add("@P01", SqlDbType.NVarChar) '受注№
    ...
    Protected Sub WW_UpdateOrderDetail(ByVal SQLcon As SqlConnection)
        ...
        Dim SQLStr As String =
            ...
            & "        , UPGRADEFLG      = @P52, ORDERINFO     = @P34, SHIPPERSCODE = @P23, SHIPPERSNAME    = @P24" _
        ...
        Try
            Using SQLTMPcmd As New SqlCommand(SQLTempTblStr, SQLcon),
                ...
                '★削除作成用
                Dim PARATMP01 As SqlParameter = SQLTMPcmd.Parameters.Add("@P01", SqlDbType.NVarChar) '受注№
    ...
    Protected Sub WW_UpdateOrderTankCnt(ByVal SQLcon As SqlConnection)
        ...
        Try
            Using SQLcmd As New SqlCommand(SQLStr, SQLcon), SQLUpcmd As New SqlCommand(SQLUpStr, SQLcon)
                ...
                Dim PARAUP01 As SqlParameter = SQLUpcmd.Parameters.Add("@P01", SqlDbType.NVarChar)     '受注№
    ...
    Protected Sub WW_UpdateTankMaster(ByVal I_TANKNO As String,
        ...
        Catch ex As Exception
            Master.Output(C_MESSAGE_NO.DB_ERROR, C_MESSAGE_TYPE.ABORT, "OIT0001D_TANKMASTER UPDATE")
            CS0011LOGWrite.INFSUBCLASS = "MAIN"                         'SUBクラス名
            CS0011LOGWrite.INFPOSI = "DB:OIT0001D_TANKMASTER UPDATE"
            CS0011LOGWrite.NIWEA = C_MESSAGE_TYPE.ABORT
            CS0011LOGWrite.TEXT = ex.ToString()
            CS0011LOGWrite.MESSAGENO = C_MESSAGE_NO.DB_ERROR
            CS0011LOGWrite.CS0011LOGWrite()                             'ログ出力
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Protected Sub WW_TANKNUMBER_FIND(ByRef OIT0001row As DataRow, Optional ByVal I_CMPCD As String = Nothing)
        Dim WW_TANKNUMBER As String = OIT0001row("TANKNO")
        Dim WW_Now As String = Now.ToString("yyyy/MM/dd")
        Dim WW_GetValue() As String = {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""}
        ...
        ''型式
        'OIT0001row("MODEL") = WW_GetValue(7)

        '####################################################
        '前回油種
        OIT0001row("LASTOILCODE") = WW_GetValue(1)
        OIT0001row("LASTOILNAME") = WW_GetValue(4)
        OIT0001row("PREORDERINGTYPE") = WW_GetValue(5)
        OIT0001row("PREORDERINGOILNAME") = WW_GetValue(6)
        '####################################################
        ...
        If WW_GetValue(2) <> "" Then
            ...
            Select Case WW_JRINSPECTIONFLG
                Case "1"
                    ...
                    OIT0001row("JRINSPECTIONALERTSTR") = C_INSPECTIONALERT.ALERT_RED
                Case "2"
                    OIT0001row("JRINSPECTIONALERT") = CONST_ALERT_STATUS_WARNING.Replace("'", "")
                    OIT0001row("JRINSPECTIONALERTSTR") = C_INSPECTIONALERT.ALERT_YELLOW
                Case "3"
                    OIT0001row("JRINSPECTIONALERT") = CONST_ALERT_STATUS_SAFE.Replace("'", "")
                    OIT0001row("JRINSPECTIONALERTSTR") = C_INSPECTIONALERT.ALERT_GREEN
            End Select
        Else
            OIT0001row("JRINSPECTIONALERT") = ""
            OIT0001row("JRINSPECTIONALERTSTR") = ""
        End If
        ...
        If WW_GetValue(3) <> "" Then
            ...
            Select Case WW_JRALLINSPECTIONFLG
                Case "1"
                    ...
                    OIT0001row("JRALLINSPECTIONALERTSTR") = C_INSPECTIONALERT.ALERT_RED
                Case "2"
                    OIT0001row("JRALLINSPECTIONALERT") = CONST_ALERT_STATUS_WARNING.Replace("'", "")
                    OIT0001row("JRALLINSPECTIONALERTSTR") = C_INSPECTIONALERT.ALERT_YELLOW
                Case "3"
                    OIT0001row("JRALLINSPECTIONALERT") = CONST_ALERT_STATUS_SAFE.Replace("'", "")
                    OIT0001row("JRALLINSPECTIONALERTSTR") = C_INSPECTIONALERT.ALERT_GREEN
            End Select
        Else
            OIT0001row("JRALLINSPECTIONALERT") = ""
            OIT0001row("JRALLINSPECTIONALERTSTR") = ""
        End If

        ''〇 タンク車割当状況チェック
        'WW_TANKQUOTACHK("TANKNO", OIT0001row)

        '### 20200701 START((全体)No96対応) ######################################
        '★指定したタンク車№が所属営業所以外の場合
        If WW_GetValue(13) <> work.WF_SEL_SALESOFFICECODE.Text Then
            '### 20200819 START 管轄支店コード(11001(OT本社))対応 ####################
            If WW_GetValue(14) <> BaseDllConst.CONST_BRANCHCODE_110001 Then
                OIT0001row("ORDERINFO") = BaseDllConst.CONST_ORDERINFO_ALERT_102
                CODENAME_get("ORDERINFO", OIT0001row("ORDERINFO"), OIT0001row("ORDERINFONAME"), WW_DUMMY)
                Exit Sub
            Else
                OIT0001row("ORDERINFO") = ""
        ...
        ElseIf OIT0001row("ORDERINFO") = BaseDllConst.CONST_ORDERINFO_ALERT_102 Then
            OIT0001row("ORDERINFO") = ""
            OIT0001row("ORDERINFONAME") = ""
        End If
