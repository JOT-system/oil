<%@ Page Title="MB0001S" Language="vb" AutoEventWireup="false" CodeBehind="GRMB0001SELECT.aspx.vb" Inherits="OFFICE.GRMB0001SELECT" %>
...
<asp:Content ID="MB0001SH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MB0001S.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MB0001S.js")%>'></script>
</asp:Content>

<asp:Content ID="MB0001S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
