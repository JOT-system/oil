<%@ Page Title="MC0002" Language="vb" AutoEventWireup="false" CodeBehind="GRMC0002TORIHIKISAKI.aspx.vb" Inherits="OFFICE.GRMC0002TORIHIKISAKI" %>
...
<asp:Content ID="MC0002H" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MC0002.css")%>"/>
    <script type="text/javascript">
        var pnlListAreaId = '<%= Me.pnlListArea.ClientId %>';
        var IsPostBack = '<%= if(IsPostBack = True, "1", "0") %>';
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MC0002.js")%>"></script>
</asp:Content> 
        ...
        <div id="detailkeybox">
            ...
            <p id="KEY_LINE_2">
                ...
                <a name="KEY_2" >
                    ...
                    <asp:Label ID="WF_TORICODE_TEXT" runat="server" Width="17em" CssClass="WF_TEXT_LEFT_LABEL"></asp:Label>
                </a>
            </p>
