<%@ Page  Title="MA0002S" Language="vb" AutoEventWireup="false" CodeBehind="GRMA0002SELECT.aspx.vb" Inherits="OFFICE.GRMA0002SELECT" %>
...
<asp:Content ID="MA00020SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MA0002S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MA0002S.js")%>"></script>
</asp:Content>

<asp:Content ID="MA0002S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　searchbox -->
        <div  class="searchbox" id="searchbox" >
            ...
            <a style="position:fixed;top:7.7em;left:18em;" onchange="TextBox_change('WF_CAMPCODE')" ondblclick="Field_DBclick('WF_CAMPCODE' ,  <%= LIST_BOX_CLASSIFICATION.LC_COMPANY%>)">
