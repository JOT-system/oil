...
<!--                    <a ondblclick="Field_DBclick('STATIONCODE', <%=LIST_BOX_CLASSIFICATION.LC_STATIONCODE%>)"> -->
                    <a class="ef" id="WF_STATIONCODE">
                        ...
                        <asp:TextBox ID="TxtStationCode" runat="server" Width="16.3em" CssClass="WF_TEXTBOX_CSS" MaxLength="4"></asp:TextBox>
                    ...
                    <a class="ef" id="WF_BRANCH">
                        ...
                        <asp:TextBox ID="TxtBranch" runat="server" Width="16.3em" CssClass="WF_TEXTBOX_CSS" MaxLength="3"></asp:TextBox>
