        ...
        <div class="detailboxOnly" id="detailbox">
            ...
            <p id="KEY_LINE_8">
                ...
                <a ondblclick="Field_DBclick('WF_CAMPCODE', <%=LIST_BOX_CLASSIFICATION.LC_COMPANY%>)">
                    <asp:Label ID="WF_CAMPCODE_L" runat="server" Text="会社コード" Width="15.0em" CssClass="WF_TEXT_LEFT" Font-Bold="true" Font-Underline="true"></asp:Label>
                ...
                <a ondblclick="Field_DBclick('WF_CAMPCODE', <%=LIST_BOX_CLASSIFICATION.LC_ORG%>)">
                    ...
                    <asp:Label ID="WF_ORG_TEXT" runat="server" Width="15em" CssClass="WF_TEXT"></asp:Label>
                </a>
            </p>
            ...
            <p id="KEY_LINE_10">
                <!-- メニュー表示制御ロール -->
                <a>
                    <asp:Label ID="WF_MENUROLE_L" runat="server" Text="メニュー表示制御ロール" Width="15.0em" CssClass="WF_TEXT_LEFT"></asp:Label>
                ...
                <!-- 画面参照更新制御ロール -->
                <a>
                    <asp:Label ID="WF_MAPROLE_L" runat="server" Text="画面参照更新制御ロール" Width="15.0em" CssClass="WF_TEXT_LEFT"></asp:Label>
            ...
            <p id="KEY_LINE_11">
                <!-- 画面表示項目制御ロール -->
                <a>
                    <asp:Label ID="WF_VIEWPROFID_L" runat="server" Text="画面表示項目制御ロール" Width="15.0em" CssClass="WF_TEXT_LEFT"></asp:Label>
                ...
                <!-- エクセル出力制御ロール -->
                <a>
                    <asp:Label ID="WF_RPRTPROFID_L" runat="server" Text="エクセル出力制御ロール" Width="15.0em" CssClass="WF_TEXT_LEFT"></asp:Label>
