        ...
        For Each OIM0015INProw As DataRow In OIM0015INPtbl.Rows
            ...
            For Each OIM0015row As DataRow In OIM0015tbl.Rows
                If OIM0015row("CONSIGNEECODE") = OIM0015INProw("CONSIGNEECODE") AndAlso
                    ...
                    If OIM0015row("FROMMD") = OIM0015row("FROMMD") AndAlso
                        OIM0015row("TOMD") = OIM0015row("TOMD") AndAlso
                        OIM0015row("TANKCAP") = OIM0015row("TANKCAP") AndAlso
                        OIM0015row("TARGETCAPRATE") = OIM0015row("TARGETCAPRATE") AndAlso
                        OIM0015row("DS") = OIM0015row("DS") AndAlso
