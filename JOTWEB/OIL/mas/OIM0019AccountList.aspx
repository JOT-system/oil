<%@ Page Title="OIM0019L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0019AccountList.aspx.vb" Inherits="JOTWEB.OIM0019AccountList" %>
...
<asp:Content ID="OIM0019LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0019L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0019L.js")%>'></script>
...
<asp:Content ID="OIM0019L" ContentPlaceHolderID="contents1" runat="server">
