<%@ Page Title="MA0006S" Language="vb" AutoEventWireup="false" CodeBehind="GRMA0006SELECT.aspx.vb" Inherits="OFFICE.GRMA0006SELECT" %>
...
<asp:Content ID="MA0006SH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MA0006S.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MA0006S.js")%>'></script>
</asp:Content>

<asp:Content ID="MA0006S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
