<%@ Page Title="OIM0016L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0016RTrainList.aspx.vb" Inherits="JOTWEB.OIM0016RTrainList" %>
...
<asp:Content ID="OIM0016LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0016L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0016L.js")%>'></script>
...
<asp:Content ID="OIM0016L" ContentPlaceHolderID="contents1" runat="server">
