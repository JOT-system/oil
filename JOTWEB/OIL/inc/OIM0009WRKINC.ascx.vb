...
Public Class OIM0009WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "OIM0009S"       'MAPID(条件)
    Public Const MAPIDL As String = "OIM0009L"       'MAPID(実行)
    Public Const MAPIDC As String = "OIM0009C"       'MAPID(更新)
