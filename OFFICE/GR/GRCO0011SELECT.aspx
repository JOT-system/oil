<%@ Page Title="CO0011S" Language="vb" AutoEventWireup="false" CodeBehind="GRCO0011SELECT.aspx.vb" Inherits="OFFICE.GRCO0011SELECT" %>
...
<asp:Content ID="CO0011SH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/CO0011S.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/CO0011S.js")%>'></script>
</asp:Content>

<asp:Content ID="CO0011S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
