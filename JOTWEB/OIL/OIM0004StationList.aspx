<%@ Page Title="OIM0004L" Language="vb" AutoEventWireup="false" CodeBehind="OIM0004StationList.aspx.vb" Inherits="OFFICE.OIM0004STATIONLIST" %>
...
<asp:Content ID="OIM0004LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/OIM0004L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/OIM0004L.js")%>'></script>
