<%@ Page Title="MC0006_R" Language="vb" AutoEventWireup="false" CodeBehind="GRMC0006TODOKESAKI_R.aspx.vb" Inherits="OFFICE.GRMC0006TODOKESAKI_R" %>
    ...
    <div  class="headerbox" id="headerbox">
        <div class="Operation">
            ...
            <a style="position:fixed;top:2.8em;left:58em;">
                <input hidden="hidden" type="button" id="WF_ButtonUPDATE" value="DB更新" />
            </a>
    ...
    <div  class="detailbox" id="detailbox">
        ...
        <div id="detailkeybox">
            ...
            <p id="KEY_LINE_3">
                ...
                <!-- ■　削除フラグ　■ -->
                <a name="KEY_3" >
                    <asp:Label ID="WF_DELFLG_L" runat="server" Text="削除" Width="7em" CssClass="WF_TEXT_LEFT" Font-Bold="True"></asp:Label>
