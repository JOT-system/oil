...
''' </summary>
''' <remarks></remarks>
Public Class GRMC0006TODOKESAKI_JC
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○画面ID設定
        Master.MAPID = GRMC0006WRKINC.MAPID_JC
        '○HELP表示有無設定
    ...
    Protected Sub WF_ButtonExtract_Click()
        ...
        For Each row As DataRow In BASEtbl.Rows
            ...
            '届先名称　分類　絞込判定
            If WF_TODOKENAME.Text = "" AndAlso WF_CLASS.Text = "" Then
                row("HIDDEN") = 0
            End If
        ...
        Try
            ...
            Using SQLcon As SqlConnection = CS0050Session.getConnection
                ...
                Using SQLcmd As New SqlCommand(SQLStr, SQLcon), SQLcmd2 As New SqlCommand(SQLStr2, SQLcon)
                    ...
                    Dim PARA03 As SqlParameter = SQLcmd.Parameters.Add("@P03", SqlDbType.NVarChar)
                    Dim PARA04 As SqlParameter = SQLcmd.Parameters.Add("@P04", SqlDbType.NVarChar)
                    Dim PARA05 As SqlParameter = SQLcmd.Parameters.Add("@P05", SqlDbType.NVarChar)
                    Dim PARA06 As SqlParameter = SQLcmd.Parameters.Add("@P06", SqlDbType.NVarChar)
                    Dim PARA07 As SqlParameter = SQLcmd.Parameters.Add("@P07", SqlDbType.NVarChar)
                    Dim PARA08 As SqlParameter = SQLcmd.Parameters.Add("@P08", SqlDbType.NVarChar)
                    Dim PARA09 As SqlParameter = SQLcmd.Parameters.Add("@P09", SqlDbType.NVarChar)
                    ...
                    Dim PARA20 As SqlParameter = SQLcmd.Parameters.Add("@P20", SqlDbType.NVarChar)
                    Dim PARA21 As SqlParameter = SQLcmd.Parameters.Add("@P21", SqlDbType.NVarChar)
                    ...
                    Dim PARA24 As SqlParameter = SQLcmd.Parameters.Add("@P24", SqlDbType.NVarChar)
                    Dim PARA25 As SqlParameter = SQLcmd.Parameters.Add("@P25", SqlDbType.NVarChar)
                    Dim PARA26 As SqlParameter = SQLcmd.Parameters.Add("@P26", SqlDbType.NVarChar)
                    ...
                    Dim PARA29 As SqlParameter = SQLcmd.Parameters.Add("@P29", SqlDbType.NVarChar)
                    ...
                    Dim PARA32 As SqlParameter = SQLcmd.Parameters.Add("@P32", SqlDbType.NVarChar)
                    Dim PARA33 As SqlParameter = SQLcmd.Parameters.Add("@P33", SqlDbType.NVarChar)
                    Dim PARA34 As SqlParameter = SQLcmd.Parameters.Add("@P34", SqlDbType.DateTime)
                    Dim PARA35 As SqlParameter = SQLcmd.Parameters.Add("@P35", SqlDbType.NVarChar)
                    Dim PARA36 As SqlParameter = SQLcmd.Parameters.Add("@P36", SqlDbType.NVarChar)
                    Dim PARA37 As SqlParameter = SQLcmd.Parameters.Add("@P37", SqlDbType.NVarChar)
                    Dim PARA38 As SqlParameter = SQLcmd.Parameters.Add("@P38", SqlDbType.NVarChar)
                    Dim PARA39 As SqlParameter = SQLcmd.Parameters.Add("@P39", SqlDbType.NVarChar)

                    Dim PARA1 As SqlParameter = SQLcmd2.Parameters.Add("@P01", SqlDbType.NVarChar)
                    Dim PARA2 As SqlParameter = SQLcmd2.Parameters.Add("@P02", SqlDbType.NVarChar)
                    Dim PARA3 As SqlParameter = SQLcmd2.Parameters.Add("@P03", SqlDbType.NVarChar)
            ...
            End Using
        Catch ex As Exception
            Master.Output(C_MESSAGE_NO.DB_ERROR, C_MESSAGE_TYPE.ABORT, "MC006_TODOKESAKI UPDATE")
            CS0011LOGWRITE.INFSUBCLASS = "MAIN"                         'SUBクラス名
            CS0011LOGWRITE.INFPOSI = "DB:MC006_TODOKESAKI UPDATE"
            CS0011LOGWRITE.NIWEA = C_MESSAGE_TYPE.ABORT
                ...
                If WF_LeftMViewChange.Value <> LIST_BOX_CLASSIFICATION.LC_CALENDAR Then
                    ...
                    Select Case WW_FIELD
                        Case "WF_TODOKECODE"                    '届先
                            prmData = work.CreateTODOKEJCParam(work.WF_SEL_CAMPCODE.Text, WF_TORICODE.Text)
                        Case "CITIES"                           '市町村コード
    ...
    Protected Sub DetailBoxToINPtbl(ByRef O_RTN As String)
            ...
            If IsDBNull(INProw.Item(INPcol)) OrElse IsNothing(INProw.Item(INPcol)) Then
                Select Case INPcol.ColumnName
                    ...
                    Case "HIDDEN"
                        INProw.Item(INPcol) = 0
                    Case "DELFLG"
                        INProw.Item(INPcol) = C_DELETE_FLG.ALIVE
                    Case Else
                        INProw.Item(INPcol) = ""
                End Select
            End If
        ...
        If String.IsNullOrEmpty(WF_Sel_LINECNT.Text) AndAlso
            ...
            String.IsNullOrEmpty(WF_ENDYMD.Text) Then
    ...
    Protected Sub MAPDATAget()
        ...
        Try
            ...
            Using SQLcon As SqlConnection = CS0050Session.getConnection
                ...
                If Not String.IsNullOrEmpty(work.WF_SEL_TORIRADIO.Text) Then
                    If work.WF_SEL_TORIRADIO.Text = C_ANOTHER_SYSTEMS_DISTINATION_PREFIX.JX Then

                        SQLStr &= String.Format(" and TODOKECODE LIKE '{0}'", C_ANOTHER_SYSTEMS_DISTINATION_PREFIX.JX & "%")

                    ElseIf work.WF_SEL_TORIRADIO.Text = C_ANOTHER_SYSTEMS_DISTINATION_PREFIX.COSMO Then

                        SQLStr &= String.Format(" and TODOKECODE LIKE '{0}'", C_ANOTHER_SYSTEMS_DISTINATION_PREFIX.COSMO & "%")

                    End If
                Else
                    SQLStr &= String.Format(" and (TODOKECODE LIKE '{0}'", C_ANOTHER_SYSTEMS_DISTINATION_PREFIX.JX & "%")
                    SQLStr &= String.Format("  or  TODOKECODE LIKE '{0}')", C_ANOTHER_SYSTEMS_DISTINATION_PREFIX.COSMO & "%")
                End If
                ...
                For i As Integer = 1 To 5
                    ...
                    Select Case i
                        Case 1
                            '都道府県１
                            If Not String.IsNullOrEmpty(work.WF_SEL_PREFECTURES1.Text) Then
                                leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, work.WF_SEL_PREFECTURES1.Text, oText, oRtn, work.CreateFIXParam(work.WF_SEL_CAMPCODE.Text, "PREFECTURES"))
                            End If
                        Case 2
                            '都道府県２
                            If Not String.IsNullOrEmpty(work.WF_SEL_PREFECTURES2.Text) Then
                                leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, work.WF_SEL_PREFECTURES2.Text, oText, oRtn, work.CreateFIXParam(work.WF_SEL_CAMPCODE.Text, "PREFECTURES"))
                            End If
                        Case 3
                            '都道府県３
                            If Not String.IsNullOrEmpty(work.WF_SEL_PREFECTURES3.Text) Then
                                leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, work.WF_SEL_PREFECTURES3.Text, oText, oRtn, work.CreateFIXParam(work.WF_SEL_CAMPCODE.Text, "PREFECTURES"))
                            End If
                        Case 4
                            '都道府県４
                            If Not String.IsNullOrEmpty(work.WF_SEL_PREFECTURES4.Text) Then
                                leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, work.WF_SEL_PREFECTURES4.Text, oText, oRtn, work.CreateFIXParam(work.WF_SEL_CAMPCODE.Text, "PREFECTURES"))
                            End If
                        Case 5
                            '都道府県５
                            If Not String.IsNullOrEmpty(work.WF_SEL_PREFECTURES5.Text) Then
                                leftview.CodeToName(LIST_BOX_CLASSIFICATION.LC_FIX_VALUE, work.WF_SEL_PREFECTURES5.Text, oText, oRtn, work.CreateFIXParam(work.WF_SEL_CAMPCODE.Text, "PREFECTURES"))
                            End If
                    End Select

                    If isNormal(oRtn) AndAlso oText <> "" AndAlso sqlText = "" Then
                        sqlText = String.Format(" and ADDR1 IN('{0}' ", oText)
                    ElseIf isNormal(oRtn) AndAlso oText <> "" AndAlso sqlText <> "" Then
                        sqlText &= String.Format(",'{0}' ", oText)
                    End If
                Next
    ...
    Protected Sub INPtbl_CHEK(ByRef O_RTNCODE As String)
        ...
        For Each INProw As DataRow In INPtbl.Rows
            ...
            For Each item In dicKeyCheck
                ...
                '届先コード新規時はエラー
                If item.Key = "TODOKECODE" AndAlso WW_TEXT = "" Then
            ...
            If INProw("TODOKECODE") <> "" AndAlso WW_LINEERR_SW <> "ERR" Then
                ...
                For j As Integer = 0 To BASEtbl.Rows.Count - 1
                    If BASEtbl.Rows(j)("CAMPCODE") = INProw("CAMPCODE") AndAlso
                       ...
                       BASEtbl.Rows(j)("TODOKECODE") = INProw("TODOKECODE") AndAlso
                       BASEtbl.Rows(j)("STYMD") = INProw("STYMD") Then
                        Exit For
                    Else
    ...
    Protected Sub TBL_Update_SUB(ByRef INProw As DataRow, ByRef I_EXCEL As String)
        ...
        For Each BASErow As DataRow In BASEtbl.Rows
            ...
            If BASErow("ENDYMD") = INProw("ENDYMD") AndAlso
               ...
               BASErow("CLASS") = INProw("CLASS") Then
            ...
            With leftview
                Select Case I_FIELD
                    ...
                    Case "TODOKECODE"   '届先名称
                        .CodeToName(LIST_BOX_CLASSIFICATION.LC_DISTINATION, I_VALUE, O_TEXT, O_RTN, work.CreateTODOKEJCParam(work.WF_SEL_CAMPCODE.Text, WF_TORICODE.Text))
                    Case "MORG"         '管理部署名
