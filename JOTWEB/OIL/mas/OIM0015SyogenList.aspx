<%@ Page Title="OIM0015L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0015SyogenList.aspx.vb" Inherits="JOTWEB.OIM0015SyogenList" %>
...
<asp:Content ID="OIM0015LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0015L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0015L.js")%>'></script>
...
<asp:Content ID="OIM0015L" ContentPlaceHolderID="contents1" runat="server">
