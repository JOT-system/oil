<%@ Page Title="TA0009" Language="vb" AutoEventWireup="false" CodeBehind="GRTA0009SELECT.aspx.vb" Inherits="OFFICE.GRTA0009SELECT" %>
...
<asp:Content ID="TA0009SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/TA0009S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/TA0009S.js")%>"></script>
</asp:Content>
<asp:Content ID="TA0009S" ContentPlaceHolderID="contents1" runat="server">
        <!-- 全体レイアウト　headerbox -->
        <div  class="searchbox" id="searchbox" style="overflow:hidden">
            <!-- ○ 固定項目 ○ -->
            ...
            <div id="searchkeybox">
                ...
                <p class="LINE_3"> 
                    ...
                    <a style="position:fixed;top:12.1em;left:18em;" ondblclick="Field_DBclick('WF_SORG' ,  <%=LIST_BOX_CLASSIFICATION.LC_ORG  %>)">
                        <asp:TextBox ID="WF_SORG" runat="server" Height="1.4em" Width="10em" ></asp:TextBox>
                    </a>
                    <a style="position:fixed;top:12.1em;left:27em;">
                        <asp:Label ID="WF_SORG_TEXT" runat="server" Text="" Width="17em" Height="1.2em" CssClass="WF_TEXT"></asp:Label>
                    </a>
                </p>
            </div>
            <a hidden="hidden">
