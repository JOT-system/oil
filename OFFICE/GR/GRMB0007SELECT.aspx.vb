...
Public Class GRMB0007SELECT
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRMB0007WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MB0007 Then       '実行画面からの遷移
            '画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = GRMB0007WRKINC.MAPIDS
        rightview.MAPID = GRMB0007WRKINC.MAPID
