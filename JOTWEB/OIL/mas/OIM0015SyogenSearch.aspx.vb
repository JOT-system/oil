...
Public Class OIM0015SyogenSearch
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = OIM0015WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.SUBMENU Then         'メニューからの画面遷移
            ...
            Master.GetFirstValue(work.WF_SEL_SHIPPERSCODE.Text, "SHIPPERSCODE", WF_SHIPPERSCODE.Text)               '荷主コード
            Master.GetFirstValue(work.WF_SEL_OILCODE.Text, "OILCODE", WF_OILCODE.Text)                              '油種コード
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.OIM0015L Then   '実行画面からの遷移
            '画面項目設定処理
            WF_CONSIGNEECODE.Text = work.WF_SEL_CONSIGNEECODE.Text                                                  '荷受人コード
            WF_SHIPPERSCODE.Text = work.WF_SEL_SHIPPERSCODE.Text                                                    '荷主コード
            WF_OILCODE.Text = work.WF_SEL_OILCODE.Text                                                              '油種コード
        End If

        '○ RightBox情報設定
        rightview.MAPIDS = OIM0015WRKINC.MAPIDS
        rightview.MAPID = OIM0015WRKINC.MAPIDL
        ...
        '○ 名称設定処理
        CODENAME_get("CONSIGNEECODE", WF_CONSIGNEECODE.Text, WF_CONSIGNEECODE_TEXT.Text, WW_DUMMY)                  '荷受人コード
        CODENAME_get("SHIPPERSCODE", WF_SHIPPERSCODE.Text, WF_SHIPPERSCODE_TEXT.Text, WW_DUMMY)                     '荷主コード
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        Master.EraseCharToIgnore(WF_SHIPPERSCODE.Text)          '荷主コード
        ...
        work.WF_SEL_SHIPPERSCODE.Text = WF_SHIPPERSCODE.Text        '荷主コード
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        '荷主コード
        Master.CheckField(Master.USERCAMP, "SHIPPERSCODE", WF_SHIPPERSCODE.Text, WW_CS0024FCHECKERR, WW_CS0024FCHECKREPORT)
        If isNormal(WW_CS0024FCHECKERR) Then
            '存在チェック
            If WF_SHIPPERSCODE.Text <> "" Then
                CODENAME_get("SHIPPERSCODE", WF_SHIPPERSCODE.Text, WF_SHIPPERSCODE_TEXT.Text, WW_RTN_SW)
                If Not isNormal(WW_RTN_SW) Then
                    Master.Output(C_MESSAGE_NO.NO_DATA_EXISTS_ERROR, C_MESSAGE_TYPE.ERR, "荷主コード : " & WF_SHIPPERSCODE.Text, needsPopUp:=True)
