<%@ Page Title="T00010" Language="vb" AutoEventWireup="false" CodeBehind="GRT00010APPROVE.aspx.vb" Inherits="OFFICE.GRT00010APPROVE" %>
...
<asp:Content ID="T00010H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00010.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00010.js")%>'></script>
...
<asp:Content ID="T00010" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　headerbox -->
    <div class="headerbox" id="headerbox">
        <div class="Operation" style="margin-left:3em; margin-top:0.5em; height:1.8em;">
            ...
            <!-- 申請者 -->
            <a style="position:fixed;top:2.9em;left:13em;">
                <asp:Label ID="WF_APPLICANTID_L" runat="server" Text="申請者" Height="1.5em" Font-Bold="True" Font-Underline="True"></asp:Label>
            </a>
            <a style="position:fixed;top:2.8em;left:16.5em;" ondblclick="Field_DBclick('WF_APPLICANTID' , <%=LIST_BOX_CLASSIFICATION.LC_EXTRA_LIST%>)" onchange="TextBox_change('WF_APPLICANTID');">
                <asp:TextBox ID="WF_APPLICANTID" text="" runat="server" Height="1.1em" Width="7em" CssClass="WF_TEXTBOX_CSS" BorderStyle="NotSet"></asp:TextBox>
            </a>
            <a style="position:fixed;top:2.8em;left:23em;">
                <asp:Label ID="WF_APPLICANTID_TEXT" runat="server" Height="1.1em" Width="10em" CssClass="WF_TEXT" Text=""></asp:Label>
            </a>
            <!-- ボタン -->
            ...
            <a style="position:fixed; top:2.8em; left:58em;">
                <input type="button" id="WF_ButtonAPPROVAL" value="承認" style="Width:5em" onclick="ButtonClick('WF_ButtonAPPROVAL');" />
            </a>
            <a style="position:fixed; top:2.8em; left:62.5em;">
                <input type="button" id="WF_ButtonREJECT" value="否認" style="Width:5em" onclick="ButtonClick('WF_ButtonREJECT');" />
            </a>
