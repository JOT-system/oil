...
Public Class OIM0024WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "OIM0024S"       'MAPID(条件)
    Public Const MAPIDL As String = "OIM0024L"       'MAPID(実行)
    Public Const MAPIDC As String = "OIM0024C"       'MAPID(更新)
