...
Public Class GRMC0006SELECT
    ...
    Protected Sub Initialize()
        ...
        '画面ID設定
        Master.MAPID = GRMC0006WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper = C_PREV_MAP_LIST.MC0006 Then         '実行画面からの画面遷移
            '○画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPID = GRMC0006WRKINC.MAPID
        rightview.MAPIDS = GRMC0006WRKINC.MAPIDS
