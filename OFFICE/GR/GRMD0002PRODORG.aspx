<%@ Page Title="MD0002" Language="vb" AutoEventWireup="false" CodeBehind="GRMD0002PRODORG.aspx.vb" Inherits="OFFICE.GRMD0002PRODORG" %>
...
<%@ Register Src="~/GR/inc/GRMD0002WRKINC.ascx" TagName="wrklist" TagPrefix="MSINC" %>

<asp:Content ID="MD0002H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MD0002.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MD0002.js")%>'></script>
...
<asp:Content ID="MD0002" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　headerbox -->
