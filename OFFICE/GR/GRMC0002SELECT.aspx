<%@ Page Title="MC0002S" Language="vb" AutoEventWireup="false" CodeBehind="GRMC0002SELECT.aspx.vb" Inherits="OFFICE.GRMC0002SELECT" %>
...
<%@ register src="~/GR/inc/GRMC0002WRKINC.ascx" tagname="work" tagprefix="MSINC" %>

<asp:Content ID="MC0002SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MC0002S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MC0002S.js")%>"></script>
</asp:Content>
<asp:Content ID="MC0002S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
    <div  class="searchbox" id="searchbox" >
        ...
        <!-- 　取引先名称　 -->
        <a style="position:fixed;top:14.3em;left:11.5em;">名称</a>

        <a style="position:fixed;top:14.3em;left:18em;">
            <asp:TextBox ID="WF_TORINAME" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
            
        <!-- 　郵便番号　 -->
        <a style="position:fixed;top:16.5em;left:4em;font-weight:bold;">郵便番号</a>
        ...
        <!-- 　住所　 -->
        <a style="position:fixed;top:18.7em;left:4em;font-weight:bold;">住所</a>
        ...
        <!-- 　電話番号　 -->
        <a style="position:fixed;top:20.9em;left:4em;font-weight:bold;">電話番号</a>
        ...
        <!-- 　FAX番号　 -->
        <a style="position:fixed;top:23.1em;left:4em;font-weight:bold;">FAX番号</a>
