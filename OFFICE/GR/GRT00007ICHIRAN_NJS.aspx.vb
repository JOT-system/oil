...
''' </summary>
''' <remarks></remarks>
Public Class GRT00007ICHIRAN_NJS
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRT00007WRKINC.MAPIDINJS
    ...
    Protected Sub WF_ButtonCALC_Click()
        ...
        Next
        T0007COM.T0007_KintaiCalc_NJS(WW_T0007SELtbl, T0007tbl)
    ...
    Protected Sub WF_ButtonNIPPO_Click()
        ...
        'ヘッダ編集（日報有の分）
        '--------------------------------------------
        HeadEdit(T0007tbl, T0005tbl, WW_STDATE, WW_ENDDATE, WW_MODELtbl)
        ...
        T0007COM.T0007_KintaiCalc_NJS(WW_T0007SELtbl, T0007tbl, "TOKUSA")
    ...
    Protected Sub WF_ButtonUPDATE_Click()
        ...
        Dim WW_T0010tbl As DataTable = New DataTable
        T0007COM.T0010tbl_ColumnsAdd(WW_T0010tbl)

        CS0026TblSort.TABLE = T0007tbl
        CS0026TblSort.FILTER = "OPERATION = '更新' and HDKBN = 'H' and SELECT = '1' and RECODEKBN = '0' "
        CS0026TblSort.SORTING = "CAMPCODE, TAISHOYM, STAFFCODE, WORKDATE, HDKBN DESC"
        WW_T0007UPDtbl = CS0026TblSort.sort()

        Try
            'ﾓﾃﾞﾙ距離DB編集
            T0010_Edit(WW_T0007UPDtbl, WW_DATENOW, WW_T0010tbl, WW_DUMMY)

            T0010Update(WW_T0010tbl, SQLcon)

        Catch ex As Exception
            CS0011LOGWRITE.INFSUBCLASS = "WF_ButtonUPDATE_Click"        'SUBクラス名
            CS0011LOGWRITE.INFPOSI = "DB:INSERT T0010_MODELDISTANCE"           '
            ...
            For Each T0007row As DataRow In WW_T0007SELtbl.Rows
                If T0007row("HDKBN") = "H" And T0007row("OPERATION") = "更新" Then
                    Try
                        ...
                        PARA06.Value = CS0050SESSION.USERID
                        PARA07.Value = CS0050SESSION.APSV_ID
                        PARA08.Value = "1950/01/01"
    ...
    ' ***  勤怠ＤＢ編集                                                          ***
    Private Sub T0010_Edit(ByRef iTbl As DataTable, ByVal iDATENOW As Date, ByRef oTBL As DataTable, ByRef oRtn As String)
        ...
        For i As Integer = 0 To iTbl.Rows.Count - 1
            ...
            WW_row("SAVECNT") = iRow("T10SAVECNT")                              '保存件数
            WW_row("SHARYOKBN1") = iRow("T10SHARYOKBN1")                        '車輌区分（勤怠用）１
            WW_row("OILPAYKBN1") = iRow("T10OILPAYKBN1")                        '油種区分（勤怠用）１
            WW_row("SHUKABASHO1") = iRow("T10SHUKABASHO1")                      '出荷場所１
            WW_row("TODOKECODE1") = iRow("T10TODOKECODE1")                      '届先１
            WW_row("MODELDISTANCE1") = Val(iRow("T10MODELDISTANCE1"))           'モデル距離１
            WW_row("MODIFYKBN1") = iRow("T10MODIFYKBN1")                        '修正区分１
            WW_row("SHARYOKBN2") = iRow("T10SHARYOKBN2")                        '車輌区分（勤怠用）２
            WW_row("OILPAYKBN2") = iRow("T10OILPAYKBN2")                        '油種区分（勤怠用）２
            WW_row("SHUKABASHO2") = iRow("T10SHUKABASHO2")                      '出荷場所２
            WW_row("TODOKECODE2") = iRow("T10TODOKECODE2")                      '届先２
            WW_row("MODELDISTANCE2") = Val(iRow("T10MODELDISTANCE2"))           'モデル距離２
            WW_row("MODIFYKBN2") = iRow("T10MODIFYKBN2")                        '修正区分２
            WW_row("SHARYOKBN3") = iRow("T10SHARYOKBN3")                        '車輌区分（勤怠用）３
            WW_row("OILPAYKBN3") = iRow("T10OILPAYKBN3")                        '油種区分（勤怠用）３
            WW_row("SHUKABASHO3") = iRow("T10SHUKABASHO3")                      '出荷場所３
            WW_row("TODOKECODE3") = iRow("T10TODOKECODE3")                      '届先３
            WW_row("MODELDISTANCE3") = Val(iRow("T10MODELDISTANCE3"))           'モデル距離３
            WW_row("MODIFYKBN3") = iRow("T10MODIFYKBN3")                        '修正区分３
            WW_row("SHARYOKBN4") = iRow("T10SHARYOKBN4")                        '車輌区分（勤怠用）４
            WW_row("OILPAYKBN4") = iRow("T10OILPAYKBN4")                        '油種区分（勤怠用）４
            WW_row("SHUKABASHO4") = iRow("T10SHUKABASHO4")                      '出荷場所４
            WW_row("TODOKECODE4") = iRow("T10TODOKECODE4")                      '届先４
            WW_row("MODELDISTANCE4") = Val(iRow("T10MODELDISTANCE4"))           'モデル距離４
            WW_row("MODIFYKBN4") = iRow("T10MODIFYKBN4")                        '修正区分４
            WW_row("SHARYOKBN5") = iRow("T10SHARYOKBN5")                        '車輌区分（勤怠用）５
            WW_row("OILPAYKBN5") = iRow("T10OILPAYKBN5")                        '油種区分（勤怠用）５
            WW_row("SHUKABASHO5") = iRow("T10SHUKABASHO5")                      '出荷場所５
            WW_row("TODOKECODE5") = iRow("T10TODOKECODE5")                      '届先５
            WW_row("MODELDISTANCE5") = Val(iRow("T10MODELDISTANCE5"))           'モデル距離５
            WW_row("MODIFYKBN5") = iRow("T10MODIFYKBN5")                        '修正区分５
            WW_row("SHARYOKBN6") = iRow("T10SHARYOKBN6")                        '車輌区分（勤怠用）６
            WW_row("OILPAYKBN6") = iRow("T10OILPAYKBN6")                        '油種区分（勤怠用）６
            WW_row("SHUKABASHO6") = iRow("T10SHUKABASHO6")                      '出荷場所６
            WW_row("TODOKECODE6") = iRow("T10TODOKECODE6")                      '届先６
            WW_row("MODELDISTANCE6") = Val(iRow("T10MODELDISTANCE6"))           'モデル距離６
            WW_row("MODIFYKBN6") = iRow("T10MODIFYKBN6")                        '修正区分６
    ...
    ' ***  T0010tbl出力
    Public Sub T0010Update(ByVal iTbl As DataTable, ByRef I_SQLcon As SqlConnection)
        ...
        For i As Integer = 0 To iTbl.Rows.Count - 1
            ...
            & " IF ( @@FETCH_STATUS = 0 )                                       " _
            & "    UPDATE T0010_MODELDISTANCE                                   " _
            & "       SET    SAVECNT        = @SAVECNT ,                        " _
            & "              SHARYOKBN1     = @SHARYOKBN1 ,                     " _
            & "              OILPAYKBN1     = @OILPAYKBN1 ,                     " _
            & "              SHUKABASHO1    = @SHUKABASHO1 ,                    " _
            & "              TODOKECODE1    = @TODOKECODE1 ,                    " _
            & "              MODELDISTANCE1 = @MODELDISTANCE1 ,                 " _
            & "              MODIFYKBN1     = @MODIFYKBN1 ,                     " _
            & "              SHARYOKBN2     = @SHARYOKBN2 ,                     " _
            & "              OILPAYKBN2     = @OILPAYKBN2 ,                     " _
            & "              SHUKABASHO2    = @SHUKABASHO2 ,                    " _
            & "              TODOKECODE2    = @TODOKECODE2 ,                    " _
            & "              MODELDISTANCE2 = @MODELDISTANCE2 ,                 " _
            & "              MODIFYKBN2     = @MODIFYKBN2 ,                     " _
            & "              SHARYOKBN3     = @SHARYOKBN3 ,                     " _
            & "              OILPAYKBN3     = @OILPAYKBN3 ,                     " _
            & "              SHUKABASHO3    = @SHUKABASHO3 ,                    " _
            & "              TODOKECODE3    = @TODOKECODE3 ,                    " _
            & "              MODELDISTANCE3 = @MODELDISTANCE3 ,                 " _
            & "              MODIFYKBN3     = @MODIFYKBN3 ,                     " _
            & "              SHARYOKBN4     = @SHARYOKBN4 ,                     " _
            & "              OILPAYKBN4     = @OILPAYKBN4 ,                     " _
            & "              SHUKABASHO4    = @SHUKABASHO4 ,                    " _
            & "              TODOKECODE4    = @TODOKECODE4 ,                    " _
            & "              MODELDISTANCE4 = @MODELDISTANCE4 ,                 " _
            & "              MODIFYKBN4     = @MODIFYKBN4 ,                     " _
            & "              SHARYOKBN5     = @SHARYOKBN5 ,                     " _
            & "              OILPAYKBN5     = @OILPAYKBN5 ,                     " _
            & "              SHUKABASHO5    = @SHUKABASHO5 ,                    " _
            & "              TODOKECODE5    = @TODOKECODE5 ,                    " _
            & "              MODELDISTANCE5 = @MODELDISTANCE5 ,                 " _
            & "              MODIFYKBN5     = @MODIFYKBN5 ,                     " _
            & "              SHARYOKBN6     = @SHARYOKBN6 ,                     " _
            & "              OILPAYKBN6     = @OILPAYKBN6 ,                     " _
            & "              SHUKABASHO6    = @SHUKABASHO6 ,                    " _
            & "              TODOKECODE6    = @TODOKECODE6 ,                    " _
            & "              MODELDISTANCE6 = @MODELDISTANCE6 ,                 " _
            & "              MODIFYKBN6     = @MODIFYKBN6 ,                     " _
            & "              DELFLG         = @DELFLG ,                         " _
            & "              UPDYMD         = @UPDYMD ,                         " _
            & "              UPDUSER        = @UPDUSER ,                        " _
            ...
            & "       and    WORKDATE       = @WORKDATE ;                       " _
            & " IF ( @@FETCH_STATUS <> 0 )                                      " _
            & "    INSERT INTO T0010_MODELDISTANCE                              " _
            & "             (CAMPCODE ,                                         " _
            & "              TAISHOYM ,                                         " _
            & "              STAFFCODE ,                                        " _
            & "              WORKDATE ,                                         " _
            ...
            Dim P_SAVECNT As SqlParameter = SQLcmd.Parameters.Add("@SAVECNT", System.Data.SqlDbType.Int)
            Dim P_SHARYOKBN1 As SqlParameter = SQLcmd.Parameters.Add("@SHARYOKBN1", System.Data.SqlDbType.NVarChar, 1)
            Dim P_OILPAYKBN1 As SqlParameter = SQLcmd.Parameters.Add("@OILPAYKBN1", System.Data.SqlDbType.NVarChar, 20)
            Dim P_SHUKABASHO1 As SqlParameter = SQLcmd.Parameters.Add("@SHUKABASHO1", System.Data.SqlDbType.NVarChar, 20)
            Dim P_TODOKECODE1 As SqlParameter = SQLcmd.Parameters.Add("@TODOKECODE1", System.Data.SqlDbType.NVarChar, 20)
            Dim P_MODELDISTANCE1 As SqlParameter = SQLcmd.Parameters.Add("@MODELDISTANCE1", System.Data.SqlDbType.Int)
            Dim P_MODIFYKBN1 As SqlParameter = SQLcmd.Parameters.Add("@MODIFYKBN1", System.Data.SqlDbType.NVarChar, 1)
            Dim P_SHARYOKBN2 As SqlParameter = SQLcmd.Parameters.Add("@SHARYOKBN2", System.Data.SqlDbType.NVarChar, 1)
            Dim P_OILPAYKBN2 As SqlParameter = SQLcmd.Parameters.Add("@OILPAYKBN2", System.Data.SqlDbType.NVarChar, 20)
            Dim P_SHUKABASHO2 As SqlParameter = SQLcmd.Parameters.Add("@SHUKABASHO2", System.Data.SqlDbType.NVarChar, 20)
            Dim P_TODOKECODE2 As SqlParameter = SQLcmd.Parameters.Add("@TODOKECODE2", System.Data.SqlDbType.NVarChar, 20)
            Dim P_MODELDISTANCE2 As SqlParameter = SQLcmd.Parameters.Add("@MODELDISTANCE2", System.Data.SqlDbType.Int)
            Dim P_MODIFYKBN2 As SqlParameter = SQLcmd.Parameters.Add("@MODIFYKBN2", System.Data.SqlDbType.NVarChar, 1)
            Dim P_SHARYOKBN3 As SqlParameter = SQLcmd.Parameters.Add("@SHARYOKBN3", System.Data.SqlDbType.NVarChar, 1)
            Dim P_OILPAYKBN3 As SqlParameter = SQLcmd.Parameters.Add("@OILPAYKBN3", System.Data.SqlDbType.NVarChar, 20)
            Dim P_SHUKABASHO3 As SqlParameter = SQLcmd.Parameters.Add("@SHUKABASHO3", System.Data.SqlDbType.NVarChar, 20)
            Dim P_TODOKECODE3 As SqlParameter = SQLcmd.Parameters.Add("@TODOKECODE3", System.Data.SqlDbType.NVarChar, 20)
            Dim P_MODELDISTANCE3 As SqlParameter = SQLcmd.Parameters.Add("@MODELDISTANCE3", System.Data.SqlDbType.Int)
            Dim P_MODIFYKBN3 As SqlParameter = SQLcmd.Parameters.Add("@MODIFYKBN3", System.Data.SqlDbType.NVarChar, 1)
            Dim P_SHARYOKBN4 As SqlParameter = SQLcmd.Parameters.Add("@SHARYOKBN4", System.Data.SqlDbType.NVarChar, 1)
            Dim P_OILPAYKBN4 As SqlParameter = SQLcmd.Parameters.Add("@OILPAYKBN4", System.Data.SqlDbType.NVarChar, 20)
            Dim P_SHUKABASHO4 As SqlParameter = SQLcmd.Parameters.Add("@SHUKABASHO4", System.Data.SqlDbType.NVarChar, 20)
            Dim P_TODOKECODE4 As SqlParameter = SQLcmd.Parameters.Add("@TODOKECODE4", System.Data.SqlDbType.NVarChar, 20)
            Dim P_MODELDISTANCE4 As SqlParameter = SQLcmd.Parameters.Add("@MODELDISTANCE4", System.Data.SqlDbType.Int)
            Dim P_MODIFYKBN4 As SqlParameter = SQLcmd.Parameters.Add("@MODIFYKBN4", System.Data.SqlDbType.NVarChar, 1)
            Dim P_SHARYOKBN5 As SqlParameter = SQLcmd.Parameters.Add("@SHARYOKBN5", System.Data.SqlDbType.NVarChar, 1)
            Dim P_OILPAYKBN5 As SqlParameter = SQLcmd.Parameters.Add("@OILPAYKBN5", System.Data.SqlDbType.NVarChar, 20)
            Dim P_SHUKABASHO5 As SqlParameter = SQLcmd.Parameters.Add("@SHUKABASHO5", System.Data.SqlDbType.NVarChar, 20)
            Dim P_TODOKECODE5 As SqlParameter = SQLcmd.Parameters.Add("@TODOKECODE5", System.Data.SqlDbType.NVarChar, 20)
            Dim P_MODELDISTANCE5 As SqlParameter = SQLcmd.Parameters.Add("@MODELDISTANCE5", System.Data.SqlDbType.Int)
            Dim P_MODIFYKBN5 As SqlParameter = SQLcmd.Parameters.Add("@MODIFYKBN5", System.Data.SqlDbType.NVarChar, 1)
            Dim P_SHARYOKBN6 As SqlParameter = SQLcmd.Parameters.Add("@SHARYOKBN6", System.Data.SqlDbType.NVarChar, 1)
            Dim P_OILPAYKBN6 As SqlParameter = SQLcmd.Parameters.Add("@OILPAYKBN6", System.Data.SqlDbType.NVarChar, 20)
            Dim P_SHUKABASHO6 As SqlParameter = SQLcmd.Parameters.Add("@SHUKABASHO6", System.Data.SqlDbType.NVarChar, 20)
            Dim P_TODOKECODE6 As SqlParameter = SQLcmd.Parameters.Add("@TODOKECODE6", System.Data.SqlDbType.NVarChar, 20)
            Dim P_MODELDISTANCE6 As SqlParameter = SQLcmd.Parameters.Add("@MODELDISTANCE6", System.Data.SqlDbType.Int)
            Dim P_MODIFYKBN6 As SqlParameter = SQLcmd.Parameters.Add("@MODIFYKBN6", System.Data.SqlDbType.NVarChar, 1)
            ...
            P_SAVECNT.Value = iRow("SAVECNT")
            P_SHARYOKBN1.Value = iRow("SHARYOKBN1")
            P_OILPAYKBN1.Value = iRow("OILPAYKBN1")
            P_SHUKABASHO1.Value = iRow("SHUKABASHO1")
            P_TODOKECODE1.Value = iRow("TODOKECODE1")
            P_MODELDISTANCE1.Value = iRow("MODELDISTANCE1")
            P_MODIFYKBN1.Value = iRow("MODIFYKBN1")
            P_SHARYOKBN2.Value = iRow("SHARYOKBN2")
            P_OILPAYKBN2.Value = iRow("OILPAYKBN2")
            P_SHUKABASHO2.Value = iRow("SHUKABASHO2")
            P_TODOKECODE2.Value = iRow("TODOKECODE2")
            P_MODELDISTANCE2.Value = iRow("MODELDISTANCE2")
            P_MODIFYKBN2.Value = iRow("MODIFYKBN2")
            P_SHARYOKBN3.Value = iRow("SHARYOKBN3")
            P_OILPAYKBN3.Value = iRow("OILPAYKBN3")
            P_SHUKABASHO3.Value = iRow("SHUKABASHO3")
            P_TODOKECODE3.Value = iRow("TODOKECODE3")
            P_MODELDISTANCE3.Value = iRow("MODELDISTANCE3")
            P_MODIFYKBN3.Value = iRow("MODIFYKBN3")
            P_SHARYOKBN4.Value = iRow("SHARYOKBN4")
            P_OILPAYKBN4.Value = iRow("OILPAYKBN4")
            P_SHUKABASHO4.Value = iRow("SHUKABASHO4")
            P_TODOKECODE4.Value = iRow("TODOKECODE4")
            P_MODELDISTANCE4.Value = iRow("MODELDISTANCE4")
            P_MODIFYKBN4.Value = iRow("MODIFYKBN4")
            P_SHARYOKBN5.Value = iRow("SHARYOKBN5")
            P_OILPAYKBN5.Value = iRow("OILPAYKBN5")
            P_SHUKABASHO5.Value = iRow("SHUKABASHO5")
            P_TODOKECODE5.Value = iRow("TODOKECODE5")
            P_MODELDISTANCE5.Value = iRow("MODELDISTANCE5")
            P_MODIFYKBN5.Value = iRow("MODIFYKBN5")
            P_SHARYOKBN6.Value = iRow("SHARYOKBN6")
            P_OILPAYKBN6.Value = iRow("OILPAYKBN6")
            P_SHUKABASHO6.Value = iRow("SHUKABASHO6")
            P_TODOKECODE6.Value = iRow("TODOKECODE6")
            P_MODELDISTANCE6.Value = iRow("MODELDISTANCE6")
            P_MODIFYKBN6.Value = iRow("MODIFYKBN6")
    ...
    Protected Sub WF_ButtonEND_Click()
        ...
        ''■■■ 画面戻先URL取得 ■■■
        'CS0017RETURNURLget.MAPID = GRT00007WRKINC.MAPIDINJS
    ...
    '            CS0049UPROFview.MAPID = GRT00007WRKINC.MAPIDINJS
    ...
    Protected Sub T0007_TTLEdit(ByRef ioTbl As DataTable)
        ...
        Try
            ...
            For Each WW_HEADrow As DataRow In wT0007tbl.Rows
                ...
                For Each WW_HEADrow2 As DataRow In WW_T0007HEADtbl.Rows
                    If WW_HEADrow2("RECODEKBN") = "0" Then
                        ...
                        For j As Integer = 0 To WW_WKDTLtbl.Rows.Count - 1
                            ...
                            For k As Integer = 1 To 6
                                ...
                                If WW_WKDTLrow("STAFFCODE") = WW_HEADrow2("STAFFCODE") AndAlso
                                   WW_WKDTLrow("SHARYOKBN") = WW_HEADrow2(WW_T10SHARYOKBN) AndAlso
                                   WW_WKDTLrow("OILPAYKBN") = WW_HEADrow2(WW_T10OILPAYKBN) Then
                                    WW_WKDTLrow("MODELDISTANCE") = Val(WW_WKDTLrow("MODELDISTANCE")) + Val(WW_HEADrow2(WW_T10MODELDISTANCE))
                                    WW_WKDTLrow("MODELDISTANCETTL") = Val(WW_WKDTLrow("MODELDISTANCETTL")) + Val(WW_HEADrow2(WW_T10MODELDISTANCE))
                                End If
                            Next
                        Next
                    End If
    ...
    Private Sub T0007_InsertEdit(ByRef iTbl As DataTable, ByVal iDATENOW As Date, ByRef oTBL As DataTable, ByRef oRtn As String)
        ...
        For i As Integer = 0 To iTbl.Rows.Count - 1
            ...
            WW_row("SHORTDISTANCE2") = "0"                                                            '危険品積込２回数
            WW_row("SHORTDISTANCE2CHO") = "0"                                                         '危険品積込２回数調整
    ...
    Public Sub T0007Insert(ByVal iRow As DataRow, ByRef I_SQLcon As SqlConnection)
        ...
        P_UNLOADADDCNT4.Value = iRow("UNLOADADDCNT4")
        P_UNLOADADDCNT4CHO.Value = iRow("UNLOADADDCNT4CHO")
    ...
    Protected Sub WF_FILEUPLOAD()
        ...
        For Each WW_HEADrow As DataRow In T0007INPtbl.Rows
            ...
            If WW_HEADrow("RECODEKBN") = "0" And WW_HEADrow("HDKBN") = "H" And WW_HEADrow("OPERATION") = "更新" Then
                ...
                If T0005tbl.Rows.Count > 0 Then
                    ...
                    If T0005COM.ShakoCheck(work.WF_T7SEL_CAMPCODE.Text, WW_LATITUDE, WW_LONGITUDE) = "OK" Then
                        '--------------------------------------------------------------------------------
                    ...
                    If T0007row("WORKDATE") = WW_HEADrow("WORKDATE") And
                       ...
                       T0007row("SELECT") = "1" Then
                        ...
                        If T0007row("HDKBN") = "H" Then
                            ...
                            'NJS専用
                            WW_T0007row("NENMATUNISSUCHO") = Val(WW_HEADrow("NENMATUNISSUTTL")) - T0007row("NENMATUNISSU")
                            WW_T0007row("NENMATUNISSUTTL") = Val(T0007row("NENMATUNISSU")) + Val(T0007row("NENMATUNISSUCHO"))
                            WW_T0007row("SHACHUHAKNISSUCHO") = Val(WW_HEADrow("SHACHUHAKNISSUTTL")) - T0007row("SHACHUHAKNISSU")
                            WW_T0007row("SHACHUHAKNISSUTTL") = Val(T0007row("SHACHUHAKNISSU")) + Val(T0007row("SHACHUHAKNISSUCHO"))
                            WW_T0007row("MODELDISTANCECHO") = Val(WW_HEADrow("MODELDISTANCETTL")) - T0007row("MODELDISTANCE")
                            WW_T0007row("MODELDISTANCETTL") = Val(T0007row("MODELDISTANCE")) + Val(T0007row("MODELDISTANCECHO"))
                            WW_T0007row("JIKYUSHATIMECHO") = T0007COM.HHMMtoMinutes(WW_HEADrow("JIKYUSHATIMETTL")) - T0007COM.HHMMtoMinutes(T0007row("JIKYUSHATIME"))
                            WW_T0007row("JIKYUSHATIMETTL") = T0007COM.HHMMtoMinutes(T0007row("JIKYUSHATIME")) + T0007COM.HHMMtoMinutes(T0007row("JIKYUSHATIMECHO"))

                            WW_T0007row("JIKYUSHATIMECHO") = T0007COM.formatHHMM(WW_T0007row("JIKYUSHATIMECHO"))
                            WW_T0007row("JIKYUSHATIMETTL") = T0007COM.formatHHMM(WW_T0007row("JIKYUSHATIMETTL"))

                            '近石専用
                            WW_T0007row("HDAIWORKTIMECHO") = T0007COM.HHMMtoMinutes(WW_HEADrow("HDAIWORKTIMETTL")) - T0007COM.HHMMtoMinutes(T0007row("HDAIWORKTIME"))
                            WW_T0007row("HDAIWORKTIMETTL") = T0007COM.HHMMtoMinutes(T0007row("HDAIWORKTIME")) + T0007COM.HHMMtoMinutes(T0007row("HDAIWORKTIMECHO"))
                            WW_T0007row("HDAINIGHTTIMECHO") = T0007COM.HHMMtoMinutes(WW_HEADrow("HDAINIGHTTIMETTL")) - T0007COM.HHMMtoMinutes(T0007row("HDAINIGHTTIME"))
                            WW_T0007row("HDAINIGHTTIMETTL") = T0007COM.HHMMtoMinutes(T0007row("HDAINIGHTTIME")) + T0007COM.HHMMtoMinutes(T0007row("HDAINIGHTTIMECHO"))
                            WW_T0007row("SDAIWORKTIMECHO") = T0007COM.HHMMtoMinutes(WW_HEADrow("SDAIWORKTIMETTL")) - T0007COM.HHMMtoMinutes(T0007row("SDAIWORKTIME"))
                            WW_T0007row("SDAIWORKTIMETTL") = T0007COM.HHMMtoMinutes(T0007row("SDAIWORKTIME")) + T0007COM.HHMMtoMinutes(T0007row("SDAIWORKTIMECHO"))
                            WW_T0007row("SDAINIGHTTIMECHO") = T0007COM.HHMMtoMinutes(WW_HEADrow("SDAINIGHTTIMETTL")) - T0007COM.HHMMtoMinutes(T0007row("SDAINIGHTTIME"))
                            WW_T0007row("SDAINIGHTTIMETTL") = T0007COM.HHMMtoMinutes(T0007row("SDAINIGHTTIME")) + T0007COM.HHMMtoMinutes(T0007row("SDAINIGHTTIMECHO"))
                            WW_T0007row("WWORKTIMECHO") = T0007COM.HHMMtoMinutes(WW_HEADrow("WWORKTIMETTL")) - T0007COM.HHMMtoMinutes(T0007row("WWORKTIME"))
                            WW_T0007row("WWORKTIMETTL") = T0007COM.HHMMtoMinutes(T0007row("WWORKTIME")) + T0007COM.HHMMtoMinutes(T0007row("WWORKTIMECHO"))
                            WW_T0007row("JYOMUTIMECHO") = T0007COM.HHMMtoMinutes(WW_HEADrow("JYOMUTIMETTL")) - T0007COM.HHMMtoMinutes(T0007row("JYOMUTIME"))
                            WW_T0007row("JYOMUTIMETTL") = T0007COM.HHMMtoMinutes(T0007row("JYOMUTIME")) + T0007COM.HHMMtoMinutes(T0007row("JYOMUTIMECHO"))
                            WW_T0007row("HWORKNISSUCHO") = Val(WW_HEADrow("HWORKNISSUTTL")) - T0007row("HWORKNISSU")
                            WW_T0007row("HWORKNISSUTTL") = Val(T0007row("HWORKNISSU")) + Val(T0007row("HWORKNISSUCHO"))
                            WW_T0007row("KAITENCNTCHO") = Val(WW_HEADrow("KAITENCNTTTL")) - T0007row("KAITENCNT")
                            WW_T0007row("KAITENCNTTTL") = Val(T0007row("KAITENCNT")) + Val(T0007row("KAITENCNTCHO"))

                            WW_T0007row("HDAIWORKTIMECHO") = T0007COM.formatHHMM(WW_T0007row("HDAIWORKTIMECHO"))
                            WW_T0007row("HDAIWORKTIMETTL") = T0007COM.formatHHMM(WW_T0007row("HDAIWORKTIMETTL"))
                            WW_T0007row("HDAINIGHTTIMECHO") = T0007COM.formatHHMM(WW_T0007row("HDAINIGHTTIMECHO"))
                            WW_T0007row("HDAINIGHTTIMETTL") = T0007COM.formatHHMM(WW_T0007row("HDAINIGHTTIMETTL"))
                            WW_T0007row("SDAIWORKTIMECHO") = T0007COM.formatHHMM(WW_T0007row("SDAIWORKTIMECHO"))
                            WW_T0007row("SDAIWORKTIMETTL") = T0007COM.formatHHMM(WW_T0007row("SDAIWORKTIMETTL"))
                            WW_T0007row("SDAINIGHTTIMECHO") = T0007COM.formatHHMM(WW_T0007row("SDAIWORKTIMECHO"))
                            WW_T0007row("SDAINIGHTTIMETTL") = T0007COM.formatHHMM(WW_T0007row("SDAIWORKTIMETTL"))
                            WW_T0007row("WWORKTIMECHO") = T0007COM.formatHHMM(WW_T0007row("WWORKTIMECHO"))
                            WW_T0007row("WWORKTIMETTL") = T0007COM.formatHHMM(WW_T0007row("WWORKTIMETTL"))
                            WW_T0007row("JYOMUTIMECHO") = T0007COM.formatHHMM(WW_T0007row("JYOMUTIMECHO"))
                            WW_T0007row("JYOMUTIMETTL") = T0007COM.formatHHMM(WW_T0007row("JYOMUTIMETTL"))

                            'ＪＫＴ専用
                            WW_T0007row("SENJYOCNTCHO") = Val(WW_HEADrow("SENJYOCNTTTL")) - T0007row("SENJYOCNT")
                            WW_T0007row("SENJYOCNTTTL") = Val(T0007row("SENJYOCNT")) + Val(T0007row("SENJYOCNTCHO"))
                            WW_T0007row("UNLOADADDCNT1CHO") = Val(WW_HEADrow("UNLOADADDCNT1TTL")) - T0007row("UNLOADADDCNT1")
                            WW_T0007row("UNLOADADDCNT1TTL") = Val(T0007row("UNLOADADDCNT1")) + Val(T0007row("UNLOADADDCNT1CHO"))
                            WW_T0007row("UNLOADADDCNT2CHO") = Val(WW_HEADrow("UNLOADADDCNT2TTL")) - T0007row("UNLOADADDCNT2")
                            WW_T0007row("UNLOADADDCNT2TTL") = Val(T0007row("UNLOADADDCNT2")) + Val(T0007row("UNLOADADDCNT2CHO"))
                            WW_T0007row("UNLOADADDCNT3CHO") = Val(WW_HEADrow("UNLOADADDCNT3TTL")) - T0007row("UNLOADADDCNT3")
                            WW_T0007row("UNLOADADDCNT3TTL") = Val(T0007row("UNLOADADDCNT3")) + Val(T0007row("UNLOADADDCNT3CHO"))
                            WW_T0007row("UNLOADADDCNT4CHO") = Val(WW_HEADrow("UNLOADADDCNT4TTL")) - T0007row("UNLOADADDCNT4")
                            WW_T0007row("UNLOADADDCNT4TTL") = Val(T0007row("UNLOADADDCNT4")) + Val(T0007row("UNLOADADDCNT4CHO"))
                            WW_T0007row("SHORTDISTANCE1CHO") = Val(WW_HEADrow("SHORTDISTANCE1TTL")) - T0007row("SHORTDISTANCE1")
                            WW_T0007row("SHORTDISTANCE1TTL") = Val(T0007row("SHORTDISTANCE1")) + Val(T0007row("SHORTDISTANCE1CHO"))
                            WW_T0007row("SHORTDISTANCE2CHO") = Val(WW_HEADrow("SHORTDISTANCE2TTL")) - T0007row("SHORTDISTANCE2")
                            WW_T0007row("SHORTDISTANCE2TTL") = Val(T0007row("SHORTDISTANCE2")) + Val(T0007row("SHORTDISTANCE2CHO"))
        ...
        If wTTLFLG = "日別" Then
            ...
            T0007COM.T0007_KintaiCalc_NJS(T0007INPtbl, WW_T0007AFTtbl)
    ...
    Public Sub HeadEdit(ByRef ioTbl As DataTable, ByRef iT0005tbl As DataTable, ByVal iSTDATE As String, ByVal iENDDATE As String, ByRef iMODELtbl As DataTable)
        ...
        For Each WW_HEADrow As DataRow In WW_T0007HEADtbl.Rows
            ...
            If WW_MATCH = "ON" Then
                ...
                If T0005COM.ShakoCheck(work.WF_T7SEL_CAMPCODE.Text, WW_LATITUDE_F1, WW_LONGITUDE_F1) = "OK" Then
                    If T0005COM.ShakoCheck(work.WF_T7SEL_CAMPCODE.Text, WW_LATITUDE_F3, WW_LONGITUDE_F3) = "OK" Then
                        '出庫、帰庫が車庫の場合、車中泊ではない
                    Else
                        '出庫が車庫で、帰庫が車庫以外の場合、車中泊１泊目
    ...
    Protected Sub T0007INProw_CHEK(ByRef RTN As String)
        ...
        CS0036FCHECK.MAPID = GRT00007WRKINC.MAPIDINJS
        ...
        If T0007INProw("RECODEKBN") = "0" Then
            ...
            '' *** 保安検査(HOANTIME)
            'If T0007INProw("HOANTIME") = Nothing Then
            '    'エラーレポート編集
            '    WW_CheckMES1 = "・更新できないレコード(保安検査無)です。"
            '    WW_CheckMES2 = ""
            '    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            'Else
            '    CS0036FCHECK.FIELD = "HOANTIME"
            '    CS0036FCHECK.VALUE = T0007INProw("HOANTIME")
            '    CS0036FCHECK.CS0036FCHECK()
            '    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
            '        T0007INProw("HOANTIME") = CDate(CS0036FCHECK.VALUEOUT).ToString("HH:mm")
            '        T0007INProw("HOANTIMETTL") = CDate(CS0036FCHECK.VALUEOUT).ToString("HH:mm")
            '    Else
            '        'エラーレポート編集
            ...
            '' *** 高圧検査(KOATUTIME)
            'If T0007INProw("KOATUTIME") = Nothing Then
            '    'エラーレポート編集
            '    WW_CheckMES1 = "・更新できないレコード(高圧作業無)です。"
            '    WW_CheckMES2 = ""
            '    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            'Else
            '    CS0036FCHECK.FIELD = "KOATUTIME"
            '    CS0036FCHECK.VALUE = T0007INProw("KOATUTIME")
            '    CS0036FCHECK.CS0036FCHECK()
            '    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
            '        T0007INProw("KOATUTIME") = CDate(CS0036FCHECK.VALUEOUT).ToString("HH:mm")
            '        T0007INProw("KOATUTIMETTL") = CDate(CS0036FCHECK.VALUEOUT).ToString("HH:mm")
            '    Else
            '        'エラーレポート編集
            ...
            '' *** 特作A(TOKSAAKAISU)
            'If T0007INProw("TOKSAAKAISU") = Nothing Then
            '    'エラーレポート編集
            '    WW_CheckMES1 = "・更新できないレコード(特作Ａ無)です。"
            '    WW_CheckMES2 = ""
            '    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            'Else
            '    CS0036FCHECK.FIELD = "TOKSAAKAISU"
            '    CS0036FCHECK.VALUE = T0007INProw("TOKSAAKAISU")
            '    CS0036FCHECK.CS0036FCHECK()
            '    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
            '        T0007INProw("TOKSAAKAISU") = Val(CS0036FCHECK.VALUEOUT)
            '        T0007INProw("TOKSAAKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
            '    Else
            '        'エラーレポート編集
            ...
            '' *** 特作B(TOKSABKAISU)
            'If T0007INProw("TOKSABKAISU") = Nothing Then
            '    'エラーレポート編集
            '    WW_CheckMES1 = "・更新できないレコード(特作Ｂ無)です。"
            '    WW_CheckMES2 = ""
            '    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            'Else
            '    CS0036FCHECK.FIELD = "TOKSABKAISU"
            '    CS0036FCHECK.VALUE = T0007INProw("TOKSABKAISU")
            '    CS0036FCHECK.CS0036FCHECK()
            '    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
            '        T0007INProw("TOKSABKAISU") = Val(CS0036FCHECK.VALUEOUT)
            '        T0007INProw("TOKSABKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
            '    Else
            '        'エラーレポート編集
            ...
            '' *** 特作C(TOKSACKAISU)
            'If T0007INProw("TOKSACKAISU") = Nothing Then
            '    'エラーレポート編集
            '    WW_CheckMES1 = "・更新できないレコード(特作Ｃ無)です。"
            '    WW_CheckMES2 = ""
            '    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            'Else
            '    CS0036FCHECK.FIELD = "TOKSACKAISU"
            '    CS0036FCHECK.VALUE = T0007INProw("TOKSACKAISU")
            '    CS0036FCHECK.CS0036FCHECK()
            '    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
            '        T0007INProw("TOKSACKAISU") = Val(CS0036FCHECK.VALUEOUT)
            '        T0007INProw("TOKSACKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
            '    Else
            '        'エラーレポート編集
            ...
            '' *** 点呼回数(TENKOKAISU)
            'If T0007INProw("TENKOKAISU") = Nothing Then
            '    'エラーレポート編集
            '    WW_CheckMES1 = "・更新できないレコード(点呼回数無)です。"
            '    WW_CheckMES2 = ""
            '    ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            'Else
            '    CS0036FCHECK.FIELD = "TENKOKAISU"
            '    CS0036FCHECK.VALUE = T0007INProw("TENKOKAISU")
            '    CS0036FCHECK.CS0036FCHECK()
            '    If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
            '        If Val(CS0036FCHECK.VALUEOUT) = 1 Or Val(CS0036FCHECK.VALUEOUT) = 0.5 Or Val(CS0036FCHECK.VALUEOUT) = 0 Then
            '            T0007INProw("TENKOKAISU") = Val(CS0036FCHECK.VALUEOUT)
            '            T0007INProw("TENKOKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
            '        Else
            '            'エラーレポート編集
            '            WW_CheckMES1 = "・更新できないレコード(点呼回数エラー)です。"
            '            WW_CheckMES2 = "０回、０．５回、１回のいずれかです"
            '            ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            '        End If
            '    Else
            '        'エラーレポート編集
        ...
        If T0007INProw("RECODEKBN") = "2" Then
            ...
            ' *** ポンプ合計(PONPNISSUTTL)
            If T0007INProw("PONPNISSUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(ポンプ日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "PONPNISSUTTL"
                CS0036FCHECK.VALUE = T0007INProw("PONPNISSUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("PONPNISSUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
            ...
            ' *** バルク合計(BULKNISSUTTL)
            If T0007INProw("BULKNISSUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(バルク日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "BULKNISSUTTL"
                CS0036FCHECK.VALUE = T0007INProw("BULKNISSUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("BULKNISSUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
            ...
            ' *** トレーラ合計(TRAILERNISSUTTL)
            If T0007INProw("TRAILERNISSUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(トレーラ日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "TRAILERNISSUTTL"
                CS0036FCHECK.VALUE = T0007INProw("TRAILERNISSUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("TRAILERNISSUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
            ...
            ' *** B勤務合計(BKINMUKAISUTTL)
            If T0007INProw("BKINMUKAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(Ｂ勤務日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "BKINMUKAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("BKINMUKAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("BKINMUKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
                    'エラーレポート編集
            ...
            ' *** 特作A合計(TOKSAAKAISUTTL)
            If T0007INProw("TOKSAAKAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(特作Ａ日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "TOKSAAKAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("TOKSAAKAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("TOKSAAKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
            ...
            ' *** 特作B合計(TOKSABKAISUTTL)
            If T0007INProw("TOKSABKAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(特作Ｂ日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "TOKSABKAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("TOKSABKAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("TOKSABKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
            ...
            ' *** 特作C合計(TOKSACKAISUTTL)
            If T0007INProw("TOKSACKAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(特作Ｃ日数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                CS0036FCHECK.FIELD = "TOKSACKAISUTTL"
                CS0036FCHECK.VALUE = T0007INProw("TOKSACKAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    T0007INProw("TOKSACKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                Else
            ...
            ' *** 点呼回数合計(TENKOKAISUTTL)
            If T0007INProw("TENKOKAISUTTL") = Nothing Then
                'エラーレポート編集
                WW_CheckMES1 = "・更新できないレコード(点呼回数無)です。"
                WW_CheckMES2 = ""
                ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
            Else
                ...
                CS0036FCHECK.VALUE = T0007INProw("TENKOKAISUTTL")
                CS0036FCHECK.CS0036FCHECK()
                If CS0036FCHECK.ERR = C_MESSAGE_NO.NORMAL Then
                    If Val(CS0036FCHECK.VALUEOUT) Mod 0.5 = 0 Then
                        T0007INProw("TENKOKAISUTTL") = Val(CS0036FCHECK.VALUEOUT)
                    Else
                        'エラーレポート編集
                        WW_CheckMES1 = "・更新できないレコード(点呼回数エラー)です。"
                        WW_CheckMES2 = "０．５回単位で入力"
                        ERRMSG_write(WW_CheckMES1, WW_CheckMES2, WW_LINEerr, "10023")
                    End If
                Else
                    'エラーレポート編集
    ...
    Protected Sub T0007INPmake(ByRef iTBL As DataTable, ByRef iTTLFLG As String)
        ...
        For i As Integer = 0 To iTBL.Rows.Count - 1
            ...
            If WW_COLUMNS.IndexOf("HOANTIME") < 0 Then
                T0007INProw("HOANTIME") = ""
            Else
                T0007INProw("HOANTIME") = iTBL.Rows(i)("HOANTIME")
            End If

            ' *** 高圧検査(KOATUTIME)
            If WW_COLUMNS.IndexOf("KOATUTIME") < 0 Then
                T0007INProw("KOATUTIME") = ""
            Else
                T0007INProw("KOATUTIME") = iTBL.Rows(i)("KOATUTIME")
            End If

            ' *** 特作A(TOKSAAKAISU)
            If WW_COLUMNS.IndexOf("TOKSAAKAISU") < 0 Then
                T0007INProw("TOKSAAKAISU") = ""
            Else
                T0007INProw("TOKSAAKAISU") = iTBL.Rows(i)("TOKSAAKAISU")
            End If

            ' *** 特作B(TOKSABKAISU)
            If WW_COLUMNS.IndexOf("TOKSABKAISU") < 0 Then
                T0007INProw("TOKSABKAISU") = ""
            Else
                T0007INProw("TOKSABKAISU") = iTBL.Rows(i)("TOKSABKAISU")
            End If

            ' *** 特作C(TOKSACKAISU)
            If WW_COLUMNS.IndexOf("TOKSACKAISU") < 0 Then
                T0007INProw("TOKSACKAISU") = ""
            Else
                T0007INProw("TOKSACKAISU") = iTBL.Rows(i)("TOKSACKAISU")
            End If

            ' *** 点呼回数(TENKOKAISU)
            If WW_COLUMNS.IndexOf("TENKOKAISU") < 0 Then
                T0007INProw("TENKOKAISU") = ""
            Else
                T0007INProw("TENKOKAISU") = iTBL.Rows(i)("TENKOKAISU")
            End If
            ...
            If WW_COLUMNS.IndexOf("PONPNISSUTTL") < 0 Then
                T0007INProw("PONPNISSUTTL") = ""
            Else
                T0007INProw("PONPNISSUTTL") = iTBL.Rows(i)("PONPNISSUTTL")
            End If

            ' *** バルク合計(BULKNISSUTTL)
            If WW_COLUMNS.IndexOf("BULKNISSUTTL") < 0 Then
                T0007INProw("BULKNISSUTTL") = ""
            Else
                T0007INProw("BULKNISSUTTL") = iTBL.Rows(i)("BULKNISSUTTL")
            End If

            ' *** トレーラ合計(TRAILERNISSUTTL)
            If WW_COLUMNS.IndexOf("TRAILERNISSUTTL") < 0 Then
                T0007INProw("TRAILERNISSUTTL") = ""
            Else
                T0007INProw("TRAILERNISSUTTL") = iTBL.Rows(i)("TRAILERNISSUTTL")
            End If

            ' *** B勤務合計(BKINMUKAISUTTL)
            If WW_COLUMNS.IndexOf("BKINMUKAISUTTL") < 0 Then
                T0007INProw("BKINMUKAISUTTL") = ""
            Else
                T0007INProw("BKINMUKAISUTTL") = iTBL.Rows(i)("BKINMUKAISUTTL")
            End If

            ' *** 特作A合計(TOKSAAKAISUTTL)
            If WW_COLUMNS.IndexOf("TOKSAAKAISUTTL") < 0 Then
                T0007INProw("TOKSAAKAISUTTL") = ""
            Else
                T0007INProw("TOKSAAKAISUTTL") = iTBL.Rows(i)("TOKSAAKAISUTTL")
            End If

            ' *** 特作B合計(TOKSABKAISUTTL)
            If WW_COLUMNS.IndexOf("TOKSABKAISUTTL") < 0 Then
                T0007INProw("TOKSABKAISUTTL") = ""
            Else
                T0007INProw("TOKSABKAISUTTL") = iTBL.Rows(i)("TOKSABKAISUTTL")
            End If

            ' *** 特作C合計(TOKSACKAISUTTL)
            If WW_COLUMNS.IndexOf("TOKSACKAISUTTL") < 0 Then
                T0007INProw("TOKSACKAISUTTL") = ""
            Else
                T0007INProw("TOKSACKAISUTTL") = iTBL.Rows(i)("TOKSACKAISUTTL")
            End If

            ' *** 点呼回数合計(TENKOKAISUTTL)
            If WW_COLUMNS.IndexOf("TENKOKAISUTTL") < 0 Then
                T0007INProw("TENKOKAISUTTL") = ""
            Else
                T0007INProw("TENKOKAISUTTL") = iTBL.Rows(i)("TENKOKAISUTTL")
            End If
            ...
            If WW_COLUMNS.IndexOf("HOANTIMETTL") < 0 Then
                T0007INProw("HOANTIMETTL") = ""
            Else
                T0007INProw("HOANTIMETTL") = iTBL.Rows(i)("HOANTIMETTL")
            End If

            ' *** 高圧検査合計(KOATUTIMETTL)
            If WW_COLUMNS.IndexOf("KOATUTIMETTL") < 0 Then
                T0007INProw("KOATUTIMETTL") = ""
            Else
                T0007INProw("KOATUTIMETTL") = iTBL.Rows(i)("KOATUTIMETTL")
            End If
            ...
            'NJS専用
            ' *** 配送時間（分）(HAISOTIME)
            If WW_COLUMNS.IndexOf("HAISOTIME") < 0 Then
                T0007INProw("HAISOTIME") = ""
            Else
                T0007INProw("HAISOTIME") = iTBL.Rows(i)("HAISOTIME")
            End If

            ' *** 年末日数(NENMATUNISSU)
            If WW_COLUMNS.IndexOf("NENMATUNISSU") < 0 Then
                T0007INProw("NENMATUNISSU") = ""
            Else
                T0007INProw("NENMATUNISSU") = iTBL.Rows(i)("NENMATUNISSU")
            End If

            ' *** 車中泊区分(SHACHUHAKKBN)
            If WW_COLUMNS.IndexOf("SHACHUHAKKBN") < 0 Then
                T0007INProw("SHACHUHAKKBN") = ""
            Else
                T0007INProw("SHACHUHAKKBN") = iTBL.Rows(i)("SHACHUHAKKBN")
            End If

            ' *** 車中泊日数(SHACHUHAKNISSU)
            If WW_COLUMNS.IndexOf("SHACHUHAKNISSU") < 0 Then
                T0007INProw("SHACHUHAKNISSU") = ""
            Else
                T0007INProw("SHACHUHAKNISSU") = iTBL.Rows(i)("SHACHUHAKNISSU")
            End If

            ' *** モデル距離(MODELDISTANCE)
            If WW_COLUMNS.IndexOf("MODELDISTANCE") < 0 Then
                T0007INProw("MODELDISTANCE") = ""
            Else
                T0007INProw("MODELDISTANCE") = iTBL.Rows(i)("MODELDISTANCE")
            End If

            ' *** 時給者作業時間(JIKYUSHATIME)
            ...
            ' *** 年末日数合計(NENMATUNISSUTTL)
            If WW_COLUMNS.IndexOf("NENMATUNISSUTTL") < 0 Then
                T0007INProw("NENMATUNISSUTTL") = ""
            Else
                T0007INProw("NENMATUNISSUTTL") = iTBL.Rows(i)("NENMATUNISSUTTL")
            End If
            ...
            ' *** モデル距離合計(MODELDISTANCETTL)
            If WW_COLUMNS.IndexOf("MODELDISTANCETTL") < 0 Then
                T0007INProw("MODELDISTANCETTL") = ""
            Else
                T0007INProw("MODELDISTANCETTL") = iTBL.Rows(i)("MODELDISTANCETTL")
            End If

            ' *** 時給者作業時間合計(JIKYUSHATIMETTL)
            ...
            '近石専用
            ' *** 代休出勤（分）(HDAIWORKTIME)
            If WW_COLUMNS.IndexOf("HDAIWORKTIME") < 0 Then
                T0007INProw("HDAIWORKTIME") = ""
            Else
                T0007INProw("HDAIWORKTIME") = iTBL.Rows(i)("HDAIWORKTIME")
            End If

            ' *** 代休深夜（分）(HDAINIGHTTIME)
            If WW_COLUMNS.IndexOf("HDAINIGHTTIME") < 0 Then
                T0007INProw("HDAINIGHTTIME") = ""
            Else
                T0007INProw("HDAINIGHTTIME") = iTBL.Rows(i)("HDAINIGHTTIME")
            End If

            ' *** 代休出勤（分）(SDAIWORKTIME)
            If WW_COLUMNS.IndexOf("SDAIWORKTIME") < 0 Then
                T0007INProw("SDAIWORKTIME") = ""
            Else
                T0007INProw("SDAIWORKTIME") = iTBL.Rows(i)("SDAIWORKTIME")
            End If

            ' *** 代休深夜（分）(SDAINIGHTTIME)
            If WW_COLUMNS.IndexOf("SDAINIGHTTIME") < 0 Then
                T0007INProw("SDAINIGHTTIME") = ""
            Else
                T0007INProw("SDAINIGHTTIME") = iTBL.Rows(i)("SDAINIGHTTIME")
            End If

            ' *** 所定内時間（分）(WWORKTIME)
            If WW_COLUMNS.IndexOf("WWORKTIME") < 0 Then
                T0007INProw("WWORKTIME") = ""
            Else
                T0007INProw("WWORKTIME") = iTBL.Rows(i)("WWORKTIME")
            End If

            ' *** 乗務時間（分）(JYOMUTIME)
            If WW_COLUMNS.IndexOf("JYOMUTIME") < 0 Then
                T0007INProw("JYOMUTIME") = ""
            Else
                T0007INProw("JYOMUTIME") = iTBL.Rows(i)("JYOMUTIME")
            End If

            ' *** 休日出勤日数(HWORKNISSU)
            If WW_COLUMNS.IndexOf("HWORKNISSU") < 0 Then
                T0007INProw("HWORKNISSU") = ""
            Else
                T0007INProw("HWORKNISSU") = iTBL.Rows(i)("HWORKNISSU")
            End If

            ' *** 回転数(KAITENCNT)
            If WW_COLUMNS.IndexOf("KAITENCNT") < 0 Then
                T0007INProw("KAITENCNT") = ""
            Else
                T0007INProw("KAITENCNT") = iTBL.Rows(i)("KAITENCNT")
            End If

            ' *** 代休出勤合計（分）(HDAIWORKTIMETTL)
            If WW_COLUMNS.IndexOf("HDAIWORKTIMETTL") < 0 Then
                T0007INProw("HDAIWORKTIMETTL") = ""
            Else
                T0007INProw("HDAIWORKTIMETTL") = iTBL.Rows(i)("HDAIWORKTIMETTL")
            End If

            ' *** 代休深夜合計（分）(HDAINIGHTTIMETTL)
            If WW_COLUMNS.IndexOf("HDAINIGHTTIMETTL") < 0 Then
                T0007INProw("HDAINIGHTTIMETTL") = ""
            Else
                T0007INProw("HDAINIGHTTIMETTL") = iTBL.Rows(i)("HDAINIGHTTIMETTL")
            End If

            ' *** 代休出勤合計（分）(SDAIWORKTIMETTL)
            If WW_COLUMNS.IndexOf("SDAIWORKTIMETTL") < 0 Then
                T0007INProw("SDAIWORKTIMETTL") = ""
            Else
                T0007INProw("SDAIWORKTIMETTL") = iTBL.Rows(i)("SDAIWORKTIMETTL")
            End If

            ' *** 代休深夜合計（分）(SDAINIGHTTIMETTL)
            If WW_COLUMNS.IndexOf("SDAINIGHTTIMETTL") < 0 Then
                T0007INProw("SDAINIGHTTIMETTL") = ""
            Else
                T0007INProw("SDAINIGHTTIMETTL") = iTBL.Rows(i)("SDAINIGHTTIMETTL")
            End If

            ' *** 所定内時間合計（分）(WWORKTIMETTL)
            If WW_COLUMNS.IndexOf("WWORKTIMETTL") < 0 Then
                T0007INProw("WWORKTIMETTL") = ""
            Else
                T0007INProw("WWORKTIMETTL") = iTBL.Rows(i)("WWORKTIMETTL")
            End If

            ' *** 乗務時間合計（分）(JYOMUTIMETTL)
            If WW_COLUMNS.IndexOf("JYOMUTIMETTL") < 0 Then
                T0007INProw("JYOMUTIMETTL") = ""
            Else
                T0007INProw("JYOMUTIMETTL") = iTBL.Rows(i)("JYOMUTIMETTL")
            End If

            ' *** 休日出勤日数合計(HWORKNISSUTTL)
            If WW_COLUMNS.IndexOf("HWORKNISSUTTL") < 0 Then
                T0007INProw("HWORKNISSUTTL") = ""
            Else
                T0007INProw("HWORKNISSUTTL") = iTBL.Rows(i)("HWORKNISSUTTL")
            End If

            ' *** 回転数合計(KAITENCNTTTL)
            If WW_COLUMNS.IndexOf("KAITENCNTTTL") < 0 Then
                T0007INProw("KAITENCNTTTL") = ""
            Else
                T0007INProw("KAITENCNTTTL") = iTBL.Rows(i)("KAITENCNTTTL")
            End If
    ...
    Protected Sub MAPrefelence(ByRef O_MSG As String, ByRef O_RTN As String)
        ...
        '■■■ 選択画面の入力初期値設定 ■■■
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.T00007NJS Then
