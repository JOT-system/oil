...
Public Class GRCO0010SELECT
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRCO0010WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        If Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MENU Then             'メニューからの画面遷移
            ...
            Select Case WW_FUNCSEL
                Case GRCO0010WRKINC.C_LIST_FUNSEL_DEFAULT.VISIBLE    'あり
                    WF_right_SW1.Checked = True
                    WF_right_SW2.Checked = False
                Case GRCO0010WRKINC.C_LIST_FUNSEL_DEFAULT.INVISIBLE  'なし
                    WF_right_SW1.Checked = False
                    WF_right_SW2.Checked = True
            End Select
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.CO0010 Then       '実行画面からの遷移
            '画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = GRCO0010WRKINC.MAPIDS
        rightview.MAPID = GRCO0010WRKINC.MAPID
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        If WF_right_SW1.Checked = True Then     'DEFAULTあり
            work.WF_SEL_FUNCSEL.Text = GRCO0010WRKINC.C_LIST_FUNSEL_DEFAULT.VISIBLE
        ElseIf WF_right_SW2.Checked = True Then 'DEFAULTなし
            work.WF_SEL_FUNCSEL.Text = GRCO0010WRKINC.C_LIST_FUNSEL_DEFAULT.INVISIBLE
        End If
        '○ 画面レイアウト設定
