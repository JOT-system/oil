...
Public Class GRMC0012SELECT
    ...
    Protected Sub Initialize()
        ...
        Master.MAPID = GRMC0012WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MC0012 Then   '実行画面からの遷移
            '画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = GRMC0012WRKINC.MAPIDS
        rightview.MAPID = GRMC0012WRKINC.MAPID
    ...
    Protected Sub WF_ButtonDO_Click()
        ...
        Master.eraseCharToIgnore(WF_UORG.Text)              '管理部署
