...
Public Class OIT0008CostDetail
    ...
    Protected Sub MAPDataGet(ByVal SQLcon As SqlConnection)
        ...
        SQLStrBldr.AppendLine("                        AND OIT0013.BREAKDOWNCODE = '1'")
        SQLStrBldr.AppendLine("                        THEN FORMAT(MAX(ROUND(OIT0013.CHARGE/OIT0013.LOAD, 0)), '##.00')")
        '----------------------------------------------取扱料の単価
        SQLStrBldr.AppendLine("                        WHEN")
        SQLStrBldr.AppendLine("                            OIT0013.ACCOUNTCODE   = '41010101'")
        ...
        '-----------------------------------------------上記以外の単価
        SQLStrBldr.AppendLine("                         ELSE FORMAT(MAX(ROUND(OIT0013.APPLYCHARGE, 0)), '##.00')")
        SQLStrBldr.AppendLine("                    END)")
        ...
        SQLStrBldr.AppendLine("                AND OIT0013.BREAKDOWNCODE = '1'")
        SQLStrBldr.AppendLine("                AND OIT0013.CALCKBN = '1'")
        SQLStrBldr.AppendLine("                THEN SUM(ROUND(OIT0013.CHARGE * OIT0013.CARSNUMBER * OIT0013.CONSUMPTIONTAX, 0))")
        '--------------------------------------鉄道運賃(往路)は
        ...
        SQLStrBldr.AppendLine("                THEN SUM(ROUND(OIT0013.CHARGE * OIT0013.CARSNUMBER * OIT0013.CONSUMPTIONTAX, 0))")
        '--------------------------------------上記以外は税額を集計
        SQLStrBldr.AppendLine("                ELSE SUM(ROUND(OIT0013.TAX, 0))")
        ...
        SQLStrBldr.AppendLine("         (")
        '--------------------------------- 五井＆OT高崎以外
        SQLStrBldr.AppendLine("             (NOT (OIT0013.OFFICECODE = 011201 AND OIT0013.CONSIGNEECODE = 54))")
        SQLStrBldr.AppendLine("             OR")
        '--------------------------------- 五井＆OT高崎
        SQLStrBldr.AppendLine("             (OIT0013.OFFICECODE = 011201 AND")
        SQLStrBldr.AppendLine("              OIT0013.CONSIGNEECODE = 54  AND")
        SQLStrBldr.AppendLine("              ((OIT0013.TRKBN = 'O' AND OIT0013.OTTRANSPORTFLG = '1') OR (OIT0013.TRKBN = 'C' AND OIT0013.OTTRANSPORTFLG = '2')))")
        SQLStrBldr.AppendLine("         )")
        ...
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.DISCOUNT1 * OIT0013.CARSNUMBER, 0)) AS AMOUNT")
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.DISCOUNT1 * OIT0013.CARSNUMBER * OIT0013.CONSUMPTIONTAX, 0)) AS TAX")
        SQLStrBldr.AppendLine("     FROM")
        SQLStrBldr.AppendLine("         [oil].OIT0013_ORDERDETAILBILLING OIT0013")
        SQLStrBldr.AppendLine("         INNER JOIN (")
        SQLStrBldr.AppendLine("             SELECT")
        ...
        SQLStrBldr.AppendLine("         , 0 AS QUANTITY")
        SQLStrBldr.AppendLine("         , 0 AS LOAD")
        SQLStrBldr.AppendLine("         , FORMAT(MAX(ABS(ROUND(OIT0013.DISCOUNT1/OIT0013.LOAD, 0))), '##.00') AS UNIT_PRICE")
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.DISCOUNT1 * OIT0013.CARSNUMBER, 0)) AS AMOUNT")
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.DISCOUNT1 * OIT0013.CARSNUMBER * OIT0013.CONSUMPTIONTAX, 0)) AS TAX")
        SQLStrBldr.AppendLine("     FROM")
        SQLStrBldr.AppendLine("         [oil].OIT0013_ORDERDETAILBILLING OIT0013")
        ...
        SQLStrBldr.AppendLine("         , 0 AS LOAD")
        SQLStrBldr.AppendLine("         , '' AS UNIT_PRICE")
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.DISCOUNT2 * OIT0013.CARSNUMBER, 0)) AS AMOUNT")
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.DISCOUNT2 * OIT0013.CARSNUMBER * OIT0013.CONSUMPTIONTAX, 0)) AS TAX")
        SQLStrBldr.AppendLine("     FROM")
        SQLStrBldr.AppendLine("         [oil].OIT0013_ORDERDETAILBILLING OIT0013")
        SQLStrBldr.AppendLine("         INNER JOIN (")
        SQLStrBldr.AppendLine("             SELECT")
        ...
        SQLStrBldr.AppendLine("         , SUM(OIT0013.CARSNUMBER * OIT0013.LOAD) AS LOAD")
        SQLStrBldr.AppendLine("         , '' AS UNIT_PRICE")
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.AMOUNT, 0)) AS AMOUNT")
        SQLStrBldr.AppendLine("         , SUM(ROUND(OIT0013.TAX, 0)) AS TAX")
        SQLStrBldr.AppendLine("     FROM")
        SQLStrBldr.AppendLine("         [oil].OIT0013_ORDERDETAILBILLING OIT0013")
        SQLStrBldr.AppendLine("         INNER JOIN (")
        SQLStrBldr.AppendLine("             SELECT")
