<%@ Page Title="OIM0013L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0013LoadList.aspx.vb" Inherits="JOTWEB.OIM0013LoadList" %>
...
<asp:Content ID="OIM0013LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0013L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0013L.js")%>'></script>
...
<asp:Content ID="OIM0013L" ContentPlaceHolderID="contents1" runat="server">
