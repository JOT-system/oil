...
Public Class GL0006GoodsList
    ...
    Public Sub getGoodsCodeOrgList(ByVal SQLcon As SqlConnection)
        ...
        Try
            ...
            SQLStr =
                    ...
                    & "       and  A.DELFLG        <> '1'                "
            If Not String.IsNullOrEmpty(OILTYPE) Then
                SQLStr &= "       and  A.OILTYPE         = @P9     "
            End If
            If Not String.IsNullOrEmpty(PRODUCT1) Then
                SQLStr &= "       and  A.PRODUCT1        = @P10    "
            End If
    ...
    Public Sub getOilTypeOrgList(ByVal SQLcon As SqlConnection)
        ...
        Try
            ...
            SQLStr = _
                    ...
                    & "       and  N.ENDYMD     >= @P2           " _
                    & "       and  N.DELFLG     <> '1'           " _
                    & " GROUP BY   N.KEYCODE , N.VALUE1 ,B.SEQ   "

            '〇ソート条件追加
            Select Case DEFAULT_SORT
                Case C_DEFAULT_SORT.CODE
                    SQLStr = SQLStr & " ORDER BY N.KEYCODE , N.VALUE1 , B.SEQ "
                Case C_DEFAULT_SORT.NAMES
                    SQLStr = SQLStr & " ORDER BY N.VALUE1 , N.KEYCODE , B.SEQ "
                Case C_DEFAULT_SORT.SEQ, String.Empty
                    SQLStr = SQLStr & " ORDER BY B.SEQ , N.KEYCODE , N.VALUE1 "
                Case Else
            End Select
    ...
    Public Sub getGoods1OrgList(ByVal SQLcon As SqlConnection)
        ...
        Try
            ...
            Select Case DEFAULT_SORT
                Case C_DEFAULT_SORT.CODE
                    SQLStr = SQLStr & " ORDER BY A.OILTYPE , A.PRODUCT1 , A.VALUE1 , B.SEQ "
                Case C_DEFAULT_SORT.NAMES
                    SQLStr = SQLStr & " ORDER BY A.OILTYPE , A.VALUE1 , A.PRODUCT1 , B.SEQ "
                Case C_DEFAULT_SORT.SEQ, String.Empty
                    SQLStr = SQLStr & " ORDER BY A.OILTYPE , B.SEQ , A.PRODUCT1 , A.VALUE1 "
                Case Else
            End Select
