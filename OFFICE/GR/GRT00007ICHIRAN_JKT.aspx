<%@ Page Title="T00007I" Language="vb" AutoEventWireup="false" CodeBehind="GRT00007ICHIRAN_JKT.aspx.vb" Inherits="OFFICE.GRT00007ICHIRAN_JKT" %>
...
<asp:Content ID="T00007H" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/T00007I_JKT.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/T00007I_JKT.js")%>'></script>
