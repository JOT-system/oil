<%@ Page Title="OIM0017L" Language="vb" AutoEventWireup="false" MasterPageFile="~/OIL/OILMasterPage.Master" CodeBehind="OIM0017TrainOperationList.aspx.vb" Inherits="JOTWEB.OIM0017TrainOperationList" %>
...
<asp:Content ID="OIM0017LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/OIL/css/OIM0017L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/OIL/script/OIM0017L.js")%>'></script>
...
<asp:Content ID="OIM0017L" ContentPlaceHolderID="contents1" runat="server">
