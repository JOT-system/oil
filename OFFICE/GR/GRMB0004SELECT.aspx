<%@ Page Title="MB0004S" Language="vb" AutoEventWireup="false" CodeBehind="GRMB0004SELECT.aspx.vb" Inherits="OFFICE.GRMB0004SELECT" %>
...
<asp:Content ID="MB0004SH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/MB0004S.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/MB0004S.js")%>'></script>
</asp:Content>

<asp:Content ID="MB0004S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
