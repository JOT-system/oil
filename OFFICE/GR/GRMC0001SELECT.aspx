<%@ Page Title="MC0001S" Language="vb" AutoEventWireup="false" CodeBehind="GRMC0001SELECT.aspx.vb" Inherits="OFFICE.GRMC0001SELECT" %>
...
<asp:Content ID="MC0001SH" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="<%=ResolveUrl("~/GR/css/MC0001S.css")%>"/>
    <script type="text/javascript" src="<%=ResolveUrl("~/GR/script/MC0001S.js")%>"></script>
</asp:Content>
<asp:Content ID="MC0001S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
    <div  class="searchbox" id="searchbox" >
        ...
        <!-- 　分類範囲(From-To)　 -->
        <a style="position:fixed;top:12.1em;left:4em;font-weight:bold;text-decoration:underline">分類</a>
        <a style="position:fixed;top:12.1em;left:11.5em;">範囲指定</a>
        <a style="position:fixed;top:12.1em;left:42.5em;" >～</a>

        <a style="position:fixed;top:12.1em;left:18em;" ondblclick="Field_DBclick('WF_BUNRUIF', <%=LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_BUNRUIF')">
            <asp:TextBox ID="WF_BUNRUIF" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
        <a style="position:fixed;top:12.1em;left:27em;" >
            <asp:Label ID="WF_BUNRUIF_Text" runat="server" Text="" Width="17em" CssClass="WF_TEXT"></asp:Label>
        </a>
        <a style="position:fixed;top:12.1em;left:44em;" ondblclick="Field_DBclick('WF_BUNRUIT', <%=LIST_BOX_CLASSIFICATION.LC_FIX_VALUE%>)" onchange="TextBox_change('WF_BUNRUIT')">
            <asp:TextBox ID="WF_BUNRUIT" runat="server" Height="1.4em" Width="10em" onblur="MsgClear()"></asp:TextBox>
        </a>
        <a style="position:fixed;top:12.1em;left:53em;" >
            <asp:Label ID="WF_BUNRUIT_Text" runat="server" Text="" Width="17em" CssClass="WF_TEXT"></asp:Label>
        </a>
