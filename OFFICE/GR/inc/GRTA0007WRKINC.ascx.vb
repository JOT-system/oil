...
Public Class GRTA0007WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "TA0007S"                        'MAPID(選択)
    Public Const MAPID As String = "TA0007"                          'MAPID(実行)
    ...
    ''' </summary>
    ''' <param name="COMPCODE">会社コード</param>
    ''' <param name="O_SPLIT_MINUITE">まるめ時刻</param>
