...
Public Class GRMB0004SELECT
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = GRMB0004WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.MB0004 Then       '実行画面からの遷移
            '画面項目設定処理
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = GRMB0004WRKINC.MAPIDS
        rightview.MAPID = GRMB0004WRKINC.MAPID
