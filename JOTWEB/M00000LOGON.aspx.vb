        ...
        Using SQLcon As SqlConnection = CS0050Session.getConnection
            ...
            Try
                ...
                Dim SQL_Str As String =
                   ...
                   & " INNER JOIN com.S0014_USERPASS   B ON " _
                   & "       B.USERID      = A.USERID   " _
                   & "   and B.DELFLG     <> @P4        " _
                   & " Where A.USERID      = @P1        " _
                   & "   and A.STYMD      <= @P2        " _
    ...
    Private Sub GetSHARYOC(ByRef O_RTN As String, ByVal I_ClientIP3 As String)
        ...
        Try
            ...
            Dim SQLStr As String =
                   ...
                   & "      ,  ''                                           as SORTYMD                                       " _
                   & "      ,  ''                                           as MSG                                           " _
                   & " FROM       oil.MA002_SHARYOA                             A                                                " _
                   & " INNER JOIN oil.M0006_STRUCT                              S                                         ON     " _
                   & "         S.STRUCT            = @P01                                                                    " _
                   ...
                   & "   and   S.ENDYMD           >= @P02                                                                    " _
                   & "   and   S.DELFLG           <> @P03                                                                    " _
                   & " INNER JOIN oil.MA003_SHARYOB                             B                                         ON     " _
