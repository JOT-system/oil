<%@ Page Title="OIM0004C" Language="vb" AutoEventWireup="false" CodeBehind="OIM0004StationCreate.aspx.vb" Inherits="OFFICE.OIM0004STATIONCREATE" %>
...
<asp:Content ID="OIM0004CH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/GR/css/OIM0004C.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/GR/script/OIM0004C.js")%>'></script>
