...
Public Class OIM0012WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "OIM0012S"       'MAPID(条件)
    Public Const MAPIDL As String = "OIM0012L"       'MAPID(実行)
    Public Const MAPIDC As String = "OIM0012C"       'MAPID(更新)
